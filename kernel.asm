...
801002b9:	75 47                	jne    80100302 <consoleread+0x8a>
      if(myproc()->killed){
801002bb:	e8 26 30 00 00       	call   801032e6 <myproc>
...
801002d3:	e8 d6 34 00 00       	call   801037ae <sleep>
...
8010038b:	e8 99 02 00 00       	call   80100629 <cprintf>
  cprintf("\n");
80100390:	c7 04 24 56 71 10 80 	movl   $0x80107156,(%esp)
...
801004cc:	e8 54 39 00 00       	call   80103e25 <memmove>
    pos -= 80;
...
801004eb:	e8 b5 38 00 00       	call   80103da5 <memset>
...
80100518:	e8 19 50 00 00       	call   80105536 <uartputc>
...
80100531:	e8 00 50 00 00       	call   80105536 <uartputc>
80100536:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010053d:	e8 f4 4f 00 00       	call   80105536 <uartputc>
80100542:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100549:	e8 e8 4f 00 00       	call   80105536 <uartputc>
...
80100586:	0f b6 92 f0 69 10 80 	movzbl -0x7fef9610(%edx),%edx
...
801005e8:	e8 04 37 00 00       	call   80103cf1 <acquire>
  for(i = 0; i < n; i++)
...
8010060f:	e8 46 37 00 00       	call   80103d5a <release>
  ilock(ip);
...
8010065a:	e8 92 36 00 00       	call   80103cf1 <acquire>
...
8010074f:	e8 06 36 00 00       	call   80103d5a <release>
...
8010076e:	e8 7e 35 00 00       	call   80103cf1 <acquire>
  while((c = getc()) >= 0){
...
8010081c:	e8 05 31 00 00       	call   80103926 <wakeup>
...
80100899:	e8 bc 34 00 00       	call   80103d5a <release>
  if(doprocdump) {
...
801008ad:	e8 1b 31 00 00       	call   801039cd <procdump>
}
...
801008be:	68 e8 69 10 80       	push   $0x801069e8
801008c3:	68 20 a5 10 80       	push   $0x8010a520
801008c8:	e8 d4 32 00 00       	call   80103ba1 <initlock>
...
8010090c:	e8 d5 29 00 00       	call   801032e6 <myproc>
...
8010098c:	68 01 6a 10 80       	push   $0x80106a01
...
8010099e:	eb dc                	jmp    8010097c <exec+0x80>
  if((pgdir = setupkvm()) == 0)
801009a0:	e8 79 5d 00 00       	call   8010671e <setupkvm>
...
80100a38:	e8 7f 5b 00 00       	call   801065bc <allocuvm>
...
80100a6e:	e8 14 5a 00 00       	call   80106487 <loaduvm>
...
80100ab0:	e8 07 5b 00 00       	call   801065bc <allocuvm>
...
80100adb:	e8 ca 5b 00 00       	call   801066aa <freevm>
...
80100af3:	e8 b3 5c 00 00       	call   801067ab <clearpteu>
...
80100b19:	e8 48 34 00 00       	call   80103f66 <strlen>
...
80100ba3:	e8 4d 5d 00 00       	call   801068f5 <copyout>
...
80100c0e:	e8 ec 56 00 00       	call   801062ff <switchuvm>
  freevm(oldpgdir);
80100c13:	89 1c 24             	mov    %ebx,(%esp)
80100c16:	e8 8f 5a 00 00       	call   801066aa <freevm>
  return 0;
...
80100c50:	68 0d 6a 10 80       	push   $0x80106a0d
80100c55:	68 c0 ff 10 80       	push   $0x8010ffc0
80100c5a:	e8 42 2f 00 00       	call   80103ba1 <initlock>
}
...
80100c74:	e8 78 30 00 00       	call   80103cf1 <acquire>
...
80100ca3:	e8 b2 30 00 00       	call   80103d5a <release>
      return f;
...
80100cba:	e8 9b 30 00 00       	call   80103d5a <release>
  return 0;
...
80100cdc:	e8 10 30 00 00       	call   80103cf1 <acquire>
  if(f->ref < 1)
...
80100cf9:	e8 5c 30 00 00       	call   80103d5a <release>
  return f;
}
...
80100d08:	68 14 6a 10 80       	push   $0x80106a14
...
80100d25:	e8 c7 2f 00 00       	call   80103cf1 <acquire>
  if(f->ref < 1)
...
80100d6a:	e8 eb 2f 00 00       	call   80103d5a <release>
...
80100e93:	68 26 6a 10 80       	push   $0x80106a26
...
80100f5c:	68 2f 6a 10 80       	push   $0x80106a2f
...
80100f80:	68 35 6a 10 80       	push   $0x80106a35
...
80100fd6:	e8 4a 2e 00 00       	call   80103e25 <memmove>
...
80100fe6:	e8 3a 2e 00 00       	call   80103e25 <memmove>
    name[len] = 0;
...
8010102b:	e8 75 2d 00 00       	call   80103da5 <memset>
  log_write(bp);
...
801010ef:	68 3f 6a 10 80       	push   $0x80106a3f
...
801011c9:	68 55 6a 10 80       	push   $0x80106a55
...
801011e6:	e8 06 2b 00 00       	call   80103cf1 <acquire>
...
8010122d:	e8 28 2b 00 00       	call   80103d5a <release>
      return ip;
...
80101263:	e8 f2 2a 00 00       	call   80103d5a <release>
  return ip;
...
80101278:	68 68 6a 10 80       	push   $0x80106a68
...
801012a5:	e8 7b 2b 00 00       	call   80103e25 <memmove>
  brelse(bp);
...
80101336:	68 78 6a 10 80       	push   $0x80106a78
...
8010134b:	68 8b 6a 10 80       	push   $0x80106a8b
80101350:	68 e0 09 11 80       	push   $0x801109e0
80101355:	e8 47 28 00 00       	call   80103ba1 <initlock>
  for(i = 0; i < NINODE; i++) {
...
8010136a:	68 92 6a 10 80       	push   $0x80106a92
...
8010137d:	e8 04 27 00 00       	call   80103a86 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801013c4:	68 f8 6a 10 80       	push   $0x80106af8
...
80101440:	e8 60 29 00 00       	call   80103da5 <memset>
      dip->type = type;
...
80101472:	68 98 6a 10 80       	push   $0x80106a98
...
801014e0:	e8 40 29 00 00       	call   80103e25 <memmove>
  log_write(bp);
...
801015c4:	e8 28 27 00 00       	call   80103cf1 <acquire>
  ip->ref++;
...
801015d9:	e8 7c 27 00 00       	call   80103d5a <release>
}
...
80101602:	e8 b6 24 00 00       	call   80103abd <acquiresleep>
  if(ip->valid == 0){
...
8010161a:	68 aa 6a 10 80       	push   $0x80106aaa
...
8010167c:	e8 a4 27 00 00       	call   80103e25 <memmove>
    brelse(bp);
...
801016a1:	68 b0 6a 10 80       	push   $0x80106ab0
...
801016c2:	e8 88 24 00 00       	call   80103b4f <holdingsleep>
...
801016d8:	e8 33 24 00 00       	call   80103b10 <releasesleep>
}
...
801016ea:	68 bf 6a 10 80       	push   $0x80106abf
...
80101708:	e8 b0 23 00 00       	call   80103abd <acquiresleep>
...
80101721:	e8 ea 23 00 00       	call   80103b10 <releasesleep>
  acquire(&icache.lock);
80101726:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010172d:	e8 bf 25 00 00       	call   80103cf1 <acquire>
  ip->ref--;
...
80101742:	e8 13 26 00 00       	call   80103d5a <release>
}
...
8010175a:	e8 92 25 00 00       	call   80103cf1 <acquire>
    int r = ip->ref;
8010175f:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
80101762:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101769:	e8 ec 25 00 00       	call   80103d5a <release>
    if(r == 1){
...
801018a6:	e8 7a 25 00 00       	call   80103e25 <memmove>
    brelse(bp);
...
8010197e:	e8 a2 24 00 00       	call   80103e25 <memmove>
    log_write(bp);
...
80101a2d:	e8 65 24 00 00       	call   80103e97 <strncmp>
}
80101a32:	c9                   	leave  
80101a33:	c3                   	ret    
...
80101a58:	68 c7 6a 10 80       	push   $0x80106ac7
80101a5d:	e8 fa e8 ff ff       	call   8010035c <panic>
      panic("dirlookup read");
80101a62:	83 ec 0c             	sub    $0xc,%esp
80101a65:	68 d9 6a 10 80       	push   $0x80106ad9
...
80101ae0:	74 17                	je     80101af9 <namex+0x2d>
    ...
    ip = idup(myproc()->cwd);
80101ae2:	e8 ff 17 00 00       	call   801032e6 <myproc>
...
80101bf5:	68 e8 6a 10 80       	push   $0x80106ae8
...
80101c32:	e8 a1 22 00 00       	call   80103ed8 <strncpy>
  de.inum = inum;
...
80101c60:	68 d8 70 10 80       	push   $0x801070d8
...
80101d6c:	68 4b 6b 10 80       	push   $0x80106b4b
80101d71:	e8 e6 e5 ff ff       	call   8010035c <panic>
    panic("incorrect blockno");
80101d76:	83 ec 0c             	sub    $0xc,%esp
80101d79:	68 54 6b 10 80       	push   $0x80106b54
...
80101d9a:	68 66 6b 10 80       	push   $0x80106b66
80101d9f:	68 80 a5 10 80       	push   $0x8010a580
80101da4:	e8 f8 1d 00 00       	call   80103ba1 <initlock>
...
80101e18:	e8 d4 1e 00 00       	call   80103cf1 <acquire>
...
80101e45:	e8 dc 1a 00 00       	call   80103926 <wakeup>
...
80101e63:	e8 f2 1e 00 00       	call   80103d5a <release>
...
80101e7a:	e8 db 1e 00 00       	call   80103d5a <release>
    return;
...
80101eb6:	e8 94 1c 00 00       	call   80103b4f <holdingsleep>
...
80101ee3:	e8 09 1e 00 00       	call   80103cf1 <acquire>
...
80101f45:	e8 64 18 00 00       	call   801037ae <sleep>
...
80101f5f:	e8 f6 1d 00 00       	call   80103d5a <release>
}
...
80101fff:	68 b4 6b 10 80       	push   $0x80106bb4
...
8010205c:	81 fb a8 56 11 80    	cmp    $0x801156a8,%ebx
...
8010207c:	e8 24 1d 00 00       	call   80103da5 <memset>
...
801020cf:	e8 86 1c 00 00       	call   80103d5a <release>
...
8010211d:	68 ec 6b 10 80       	push   $0x80106bec
80102122:	68 40 26 11 80       	push   $0x80112640
80102127:	e8 75 1a 00 00       	call   80103ba1 <initlock>
  kmem.use_lock = 0;
...
80102203:	0f b6 8a 20 6d 10 80 	movzbl -0x7fef92e0(%edx),%ecx
8010220a:	0b 0d b4 a5 10 80    	or     0x8010a5b4,%ecx
  shift ^= togglecode[data];
80102210:	0f b6 82 20 6c 10 80 	movzbl -0x7fef93e0(%edx),%eax
...
80102224:	8b 04 85 00 6c 10 80 	mov    -0x7fef9400(,%eax,4),%eax
...
8010225a:	83 e2 7f             	and    $0x7f,%edx
    shift &= ~(shiftcode[data] | E0ESC);
8010225d:	0f b6 82 20 6d 10 80 	movzbl -0x7fef92e0(%edx),%eax
...
80102560:	e8 87 18 00 00       	call   80103dec <memcmp>
...
801026c1:	e8 5f 17 00 00       	call   80103e25 <memmove>
...
801027c0:	e8 60 16 00 00       	call   80103e25 <memmove>
...
8010282b:	68 20 6e 10 80       	push   $0x80106e20
80102830:	68 80 26 11 80       	push   $0x80112680
80102835:	e8 67 13 00 00       	call   80103ba1 <initlock>
  readsb(dev, &sb);
...
80102879:	e8 73 14 00 00       	call   80103cf1 <acquire>
...
80102890:	e8 19 0f 00 00       	call   801037ae <sleep>
...
801028c7:	e8 e2 0e 00 00       	call   801037ae <sleep>
...
801028de:	e8 77 14 00 00       	call   80103d5a <release>
}
...
801028f8:	e8 f4 13 00 00       	call   80103cf1 <acquire>
  log.outstanding -= 1;
...
80102932:	e8 23 14 00 00       	call   80103d5a <release>
  if(do_commit){
...
801029d1:	e8 1b 13 00 00       	call   80103cf1 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801029fc:	68 33 6e 10 80       	push   $0x80106e33
80102a01:	e8 56 d9 ff ff       	call   8010035c <panic>
    panic("log_write outside of trans");
80102a06:	83 ec 0c             	sub    $0xc,%esp
80102a09:	68 49 6e 10 80       	push   $0x80106e49
...
80102a2c:	e8 29 13 00 00       	call   80103d5a <release>
}
...
80102a5a:	e8 c6 13 00 00       	call   80103e25 <memmove>
...
80102ac3:	e8 9f 07 00 00       	call   80103267 <mycpu>
...
80102ada:	e8 e8 07 00 00       	call   801032c7 <cpuid>
80102adf:	89 c3                	mov    %eax,%ebx
80102ae1:	e8 e1 07 00 00       	call   801032c7 <cpuid>
80102ae6:	83 ec 04             	sub    $0x4,%esp
80102ae9:	53                   	push   %ebx
80102aea:	50                   	push   %eax
80102aeb:	68 64 6e 10 80       	push   $0x80106e64
80102af0:	e8 34 db ff ff       	call   80100629 <cprintf>
  idtinit();       // load idt register
80102af5:	e8 c4 25 00 00       	call   801050be <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80102afa:	e8 68 07 00 00       	call   80103267 <mycpu>
...
80102b0d:	e8 61 0a 00 00       	call   80103573 <scheduler>
...
80102b19:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102b1c:	e8 cc 37 00 00       	call   801062ed <switchkvm>
  seginit();
80102b21:	e8 fb 35 00 00       	call   80106121 <seginit>
  lapicinit();
...
80102b77:	e8 03 2a 00 00       	call   8010557f <uartinit>
  pinit();         // process table
80102b7c:	e8 c8 06 00 00       	call   80103249 <pinit>
  tvinit();        // trap vectors
80102b81:	e8 83 24 00 00       	call   80105009 <tvinit>
  binit();         // buffer cache
...
80102bac:	e8 5d 07 00 00       	call   8010330e <userinit>
...
80102bf7:	68 78 6e 10 80       	push   $0x80106e78
80102bfc:	53                   	push   %ebx
80102bfd:	e8 ea 11 00 00       	call   80103dec <memcmp>
...
80102cba:	68 7d 6e 10 80       	push   $0x80106e7d
80102cbf:	57                   	push   %edi
80102cc0:	e8 27 11 00 00       	call   80103dec <memcmp>
...
80102d54:	68 82 6e 10 80       	push   $0x80106e82
...
80102def:	68 9c 6e 10 80       	push   $0x80106e9c
...
80102e7e:	68 bb 6e 10 80       	push   $0x80106ebb
80102e83:	50                   	push   %eax
80102e84:	e8 18 0d 00 00       	call   80103ba1 <initlock>
  (*f0)->type = FD_PIPE;
...
80102f0c:	e8 e0 0d 00 00       	call   80103cf1 <acquire>
  if(writable){
...
80102f2e:	e8 f3 09 00 00       	call   80103926 <wakeup>
...
80102f4c:	e8 09 0e 00 00       	call   80103d5a <release>
...
80102f6d:	e8 b4 09 00 00       	call   80103926 <wakeup>
...
80102f7b:	e8 da 0d 00 00       	call   80103d5a <release>
    kfree((char*)p);
...
80102fa0:	e8 4c 0d 00 00       	call   80103cf1 <acquire>
  for(i = 0; i < n; i++){
...
80102fbc:	e8 65 09 00 00       	call   80103926 <wakeup>
  release(&p->lock);
80102fc1:	89 1c 24             	mov    %ebx,(%esp)
80102fc4:	e8 91 0d 00 00       	call   80103d5a <release>
  return n;
...
80103011:	e8 d0 02 00 00       	call   801032e6 <myproc>
...
80103020:	e8 35 0d 00 00       	call   80103d5a <release>
        return -1;
...
8010306a:	e8 82 0c 00 00       	call   80103cf1 <acquire>
...
8010307f:	e8 2a 07 00 00       	call   801037ae <sleep>
...
8010309d:	74 23                	je     801030c2 <piperead+0x6b>
    if(myproc()->killed){
8010309f:	e8 42 02 00 00       	call   801032e6 <myproc>
...
801030ae:	e8 a7 0c 00 00       	call   80103d5a <release>
      return -1;
...
801030fd:	e8 24 08 00 00       	call   80103926 <wakeup>
  release(&p->lock);
80103102:	89 1c 24             	mov    %ebx,(%esp)
80103105:	e8 50 0c 00 00       	call   80103d5a <release>
  return i;
...
8010311c:	eb 0d                	jmp    8010312b <wakeup1+0x14>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
8010311e:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103125:	81 c2 84 00 00 00    	add    $0x84,%edx
8010312b:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103131:	73 0d                	jae    80103140 <wakeup1+0x29>
    if(p->state == SLEEPING && p->chan == chan)
80103133:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103137:	75 ec                	jne    80103125 <wakeup1+0xe>
80103139:	39 42 24             	cmp    %eax,0x24(%edx)
8010313c:	75 e7                	jne    80103125 <wakeup1+0xe>
8010313e:	eb de                	jmp    8010311e <wakeup1+0x7>
}
80103140:	c3                   	ret    
...
80103145:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
80103148:	68 20 2d 11 80       	push   $0x80112d20
8010314d:	e8 9f 0b 00 00       	call   80103cf1 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103152:	83 c4 10             	add    $0x10,%esp
80103155:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
8010315a:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103160:	73 7e                	jae    801031e0 <allocproc+0x9f>
    if(p->state == UNUSED)
80103162:	83 7b 0c 00          	cmpl   $0x0,0xc(%ebx)
80103166:	74 08                	je     80103170 <allocproc+0x2f>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103168:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010316e:	eb ea                	jmp    8010315a <allocproc+0x19>
  p->state = EMBRYO;
80103170:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
80103177:	a1 04 a0 10 80       	mov    0x8010a004,%eax
8010317c:	8d 50 01             	lea    0x1(%eax),%edx
8010317f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
80103185:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103188:	83 ec 0c             	sub    $0xc,%esp
8010318b:	68 20 2d 11 80       	push   $0x80112d20
80103190:	e8 c5 0b 00 00       	call   80103d5a <release>
  if((p->kstack = kalloc()) == 0){
80103195:	e8 d3 ef ff ff       	call   8010216d <kalloc>
8010319a:	89 43 08             	mov    %eax,0x8(%ebx)
8010319d:	83 c4 10             	add    $0x10,%esp
801031a0:	85 c0                	test   %eax,%eax
801031a2:	74 53                	je     801031f7 <allocproc+0xb6>
  sp -= sizeof *p->tf;
801031a4:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  p->tf = (struct trapframe*)sp;
801031aa:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801031ad:	c7 80 b0 0f 00 00 fe 	movl   $0x80104ffe,0xfb0(%eax)
801031b4:	4f 10 80 
  sp -= sizeof *p->context;
...
801031c7:	e8 d9 0b 00 00       	call   80103da5 <memset>
  p->context->eip = (uint)forkret;
801031cc:	8b 43 1c             	mov    0x1c(%ebx),%eax
801031cf:	c7 40 10 02 32 10 80 	movl   $0x80103202,0x10(%eax)
  return p;
...
801031e3:	68 20 2d 11 80       	push   $0x80112d20
801031e8:	e8 6d 0b 00 00       	call   80103d5a <release>
  return 0;
801031ed:	83 c4 10             	add    $0x10,%esp
801031f0:	bb 00 00 00 00       	mov    $0x0,%ebx
801031f5:	eb e2                	jmp    801031d9 <allocproc+0x98>
    p->state = UNUSED;
801031f7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return 0;
801031fe:	89 c3                	mov    %eax,%ebx
80103200:	eb d7                	jmp    801031d9 <allocproc+0x98>
...
80103209:	83 ec 14             	sub    $0x14,%esp
  release(&ptable.lock);
8010320c:	68 20 2d 11 80       	push   $0x80112d20
80103211:	e8 44 0b 00 00       	call   80103d5a <release>
  if (first) {
80103216:	83 c4 10             	add    $0x10,%esp
80103219:	83 3d 00 a0 10 80 00 	cmpl   $0x0,0x8010a000
80103220:	75 02                	jne    80103224 <forkret+0x22>
}
80103222:	c9                   	leave  
80103223:	c3                   	ret    
    first = 0;
80103224:	c7 05 00 a0 10 80 00 	movl   $0x0,0x8010a000
8010322b:	00 00 00 
    iinit(ROOTDEV);
8010322e:	83 ec 0c             	sub    $0xc,%esp
80103231:	6a 01                	push   $0x1
80103233:	e8 08 e1 ff ff       	call   80101340 <iinit>
    initlog(ROOTDEV);
80103238:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010323f:	e8 d9 f5 ff ff       	call   8010281d <initlog>
80103244:	83 c4 10             	add    $0x10,%esp
}
80103247:	eb d9                	jmp    80103222 <forkret+0x20>

80103249 <pinit>:
{
80103249:	f3 0f 1e fb          	endbr32 
8010324d:	55                   	push   %ebp
8010324e:	89 e5                	mov    %esp,%ebp
80103250:	83 ec 10             	sub    $0x10,%esp
  initlock(&ptable.lock, "ptable");
80103253:	68 c0 6e 10 80       	push   $0x80106ec0
80103258:	68 20 2d 11 80       	push   $0x80112d20
8010325d:	e8 3f 09 00 00       	call   80103ba1 <initlock>
}
...
80103272:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103273:	f6 c4 02             	test   $0x2,%ah
80103276:	75 28                	jne    801032a0 <mycpu+0x39>
  apicid = lapicid();
80103278:	e8 b7 f1 ff ff       	call   80102434 <lapicid>
  for (i = 0; i < ncpu; ++i) {
8010327d:	ba 00 00 00 00       	mov    $0x0,%edx
80103282:	39 15 00 2d 11 80    	cmp    %edx,0x80112d00
80103288:	7e 30                	jle    801032ba <mycpu+0x53>
    if (cpus[i].apicid == apicid)
8010328a:	69 ca b0 00 00 00    	imul   $0xb0,%edx,%ecx
80103290:	0f b6 89 80 27 11 80 	movzbl -0x7feed880(%ecx),%ecx
80103297:	39 c1                	cmp    %eax,%ecx
80103299:	74 12                	je     801032ad <mycpu+0x46>
  for (i = 0; i < ncpu; ++i) {
8010329b:	83 c2 01             	add    $0x1,%edx
8010329e:	eb e2                	jmp    80103282 <mycpu+0x1b>
    panic("mycpu called with interrupts enabled\n");
801032a0:	83 ec 0c             	sub    $0xc,%esp
801032a3:	68 a4 6f 10 80       	push   $0x80106fa4
801032a8:	e8 af d0 ff ff       	call   8010035c <panic>
      return &cpus[i];
801032ad:	69 c2 b0 00 00 00    	imul   $0xb0,%edx,%eax
801032b3:	05 80 27 11 80       	add    $0x80112780,%eax
}
801032b8:	c9                   	leave  
801032b9:	c3                   	ret    
  panic("unknown apicid\n");
801032ba:	83 ec 0c             	sub    $0xc,%esp
801032bd:	68 c7 6e 10 80       	push   $0x80106ec7
801032c2:	e8 95 d0 ff ff       	call   8010035c <panic>

801032c7 <cpuid>:
cpuid() {
801032c7:	f3 0f 1e fb          	endbr32 
801032cb:	55                   	push   %ebp
801032cc:	89 e5                	mov    %esp,%ebp
801032ce:	83 ec 08             	sub    $0x8,%esp
  return mycpu()-cpus;
801032d1:	e8 91 ff ff ff       	call   80103267 <mycpu>
801032d6:	2d 80 27 11 80       	sub    $0x80112780,%eax
801032db:	c1 f8 04             	sar    $0x4,%eax
801032de:	69 c0 a3 8b 2e ba    	imul   $0xba2e8ba3,%eax,%eax
}
801032e4:	c9                   	leave  
801032e5:	c3                   	ret    
...
801032e6 <myproc>:
myproc(void) {
801032e6:	f3 0f 1e fb          	endbr32 
801032ea:	55                   	push   %ebp
801032eb:	89 e5                	mov    %esp,%ebp
801032ed:	53                   	push   %ebx
801032ee:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801032f1:	e8 12 09 00 00       	call   80103c08 <pushcli>
  c = mycpu();
801032f6:	e8 6c ff ff ff       	call   80103267 <mycpu>
  p = c->proc;
801032fb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103301:	e8 43 09 00 00       	call   80103c49 <popcli>
}
80103306:	89 d8                	mov    %ebx,%eax
...
80103316:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103319:	e8 23 fe ff ff       	call   80103141 <allocproc>
8010331e:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103320:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
  if((p->pgdir = setupkvm()) == 0)
80103325:	e8 f4 33 00 00       	call   8010671e <setupkvm>
8010332a:	89 43 04             	mov    %eax,0x4(%ebx)
8010332d:	85 c0                	test   %eax,%eax
8010332f:	0f 84 b8 00 00 00    	je     801033ed <userinit+0xdf>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80103335:	83 ec 04             	sub    $0x4,%esp
80103338:	68 2c 00 00 00       	push   $0x2c
8010333d:	68 60 a4 10 80       	push   $0x8010a460
80103342:	50                   	push   %eax
80103343:	e8 d3 30 00 00       	call   8010641b <inituvm>
  p->sz = PGSIZE;
80103348:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
8010334e:	8b 43 18             	mov    0x18(%ebx),%eax
80103351:	83 c4 0c             	add    $0xc,%esp
80103354:	6a 4c                	push   $0x4c
80103356:	6a 00                	push   $0x0
80103358:	50                   	push   %eax
80103359:	e8 47 0a 00 00       	call   80103da5 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010335e:	8b 43 18             	mov    0x18(%ebx),%eax
80103361:	66 c7 40 3c 1b 00    	movw   $0x1b,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103367:	8b 43 18             	mov    0x18(%ebx),%eax
8010336a:	66 c7 40 2c 23 00    	movw   $0x23,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103370:	8b 43 18             	mov    0x18(%ebx),%eax
80103373:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103377:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
8010337b:	8b 43 18             	mov    0x18(%ebx),%eax
8010337e:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103382:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103386:	8b 43 18             	mov    0x18(%ebx),%eax
80103389:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103390:	8b 43 18             	mov    0x18(%ebx),%eax
80103393:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010339a:	8b 43 18             	mov    0x18(%ebx),%eax
8010339d:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
801033a4:	8d 43 74             	lea    0x74(%ebx),%eax
801033a7:	83 c4 0c             	add    $0xc,%esp
801033aa:	6a 10                	push   $0x10
801033ac:	68 f0 6e 10 80       	push   $0x80106ef0
801033b1:	50                   	push   %eax
801033b2:	e8 6e 0b 00 00       	call   80103f25 <safestrcpy>
  p->cwd = namei("/");
801033b7:	c7 04 24 f9 6e 10 80 	movl   $0x80106ef9,(%esp)
801033be:	e8 a7 e8 ff ff       	call   80101c6a <namei>
801033c3:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
801033c6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801033cd:	e8 1f 09 00 00       	call   80103cf1 <acquire>
  p->state = RUNNABLE;
801033d2:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801033d9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801033e0:	e8 75 09 00 00       	call   80103d5a <release>
}
801033e5:	83 c4 10             	add    $0x10,%esp
801033e8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801033eb:	c9                   	leave  
801033ec:	c3                   	ret    
    panic("userinit: out of memory?");
801033ed:	83 ec 0c             	sub    $0xc,%esp
801033f0:	68 d7 6e 10 80       	push   $0x80106ed7
...
80103403:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *curproc = myproc();
80103406:	e8 db fe ff ff       	call   801032e6 <myproc>
8010340b:	89 c3                	mov    %eax,%ebx
  sz = curproc->sz;
8010340d:	8b 00                	mov    (%eax),%eax
  if(n > 0){    // si el tamano a crecer es positivo
8010340f:	85 f6                	test   %esi,%esi
80103411:	7f 1b                	jg     8010342e <growproc+0x34>
  } else if(n < 0) { // si es negativo
80103413:	78 36                	js     8010344b <growproc+0x51>
  curproc->sz = sz;
...
80103417:	8b 43 04             	mov    0x4(%ebx),%eax
8010341a:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
8010341f:	0f 22 d8             	mov    %eax,%cr3
  return 0;
80103422:	b8 00 00 00 00       	mov    $0x0,%eax
}
80103427:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010342a:	5b                   	pop    %ebx
8010342b:	5e                   	pop    %esi
8010342c:	5d                   	pop    %ebp
8010342d:	c3                   	ret    
...
80103431:	01 c6                	add    %eax,%esi
80103433:	56                   	push   %esi
80103434:	50                   	push   %eax
80103435:	ff 73 04             	pushl  0x4(%ebx)
80103438:	e8 7f 31 00 00       	call   801065bc <allocuvm>
8010343d:	83 c4 10             	add    $0x10,%esp
80103440:	85 c0                	test   %eax,%eax
80103442:	75 d1                	jne    80103415 <growproc+0x1b>
      return -1;
80103444:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103449:	eb dc                	jmp    80103427 <growproc+0x2d>
    if((sz = deallocuvm(curproc->pgdir, sz, sz + n)) == 0)  // quitamos memoria del proceso
8010344b:	83 ec 04             	sub    $0x4,%esp
8010344e:	01 c6                	add    %eax,%esi
80103450:	56                   	push   %esi
80103451:	50                   	push   %eax
80103452:	ff 73 04             	pushl  0x4(%ebx)
80103455:	e8 cc 30 00 00       	call   80106526 <deallocuvm>
8010345a:	83 c4 10             	add    $0x10,%esp
8010345d:	85 c0                	test   %eax,%eax
8010345f:	75 b4                	jne    80103415 <growproc+0x1b>
      return -1;
80103461:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103466:	eb bf                	jmp    80103427 <growproc+0x2d>

80103468 <fork>:
{
80103468:	f3 0f 1e fb          	endbr32 
8010346c:	55                   	push   %ebp
8010346d:	89 e5                	mov    %esp,%ebp
8010346f:	57                   	push   %edi
80103470:	56                   	push   %esi
80103471:	53                   	push   %ebx
80103472:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *curproc = myproc();
80103475:	e8 6c fe ff ff       	call   801032e6 <myproc>
8010347a:	89 c3                	mov    %eax,%ebx
  if((np = allocproc()) == 0){
8010347c:	e8 c0 fc ff ff       	call   80103141 <allocproc>
80103481:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103484:	85 c0                	test   %eax,%eax
80103486:	0f 84 e0 00 00 00    	je     8010356c <fork+0x104>
8010348c:	89 c7                	mov    %eax,%edi
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
8010348e:	83 ec 08             	sub    $0x8,%esp
80103491:	ff 33                	pushl  (%ebx)
80103493:	ff 73 04             	pushl  0x4(%ebx)
80103496:	e8 40 33 00 00       	call   801067db <copyuvm>
8010349b:	89 47 04             	mov    %eax,0x4(%edi)
8010349e:	83 c4 10             	add    $0x10,%esp
801034a1:	85 c0                	test   %eax,%eax
801034a3:	74 2a                	je     801034cf <fork+0x67>
  np->sz = curproc->sz;
801034a5:	8b 03                	mov    (%ebx),%eax
801034a7:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801034aa:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
801034ac:	89 c8                	mov    %ecx,%eax
801034ae:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
801034b1:	8b 73 18             	mov    0x18(%ebx),%esi
801034b4:	8b 79 18             	mov    0x18(%ecx),%edi
801034b7:	b9 13 00 00 00       	mov    $0x13,%ecx
801034bc:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->eax = 0;
801034be:	8b 40 18             	mov    0x18(%eax),%eax
801034c1:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
801034c8:	be 00 00 00 00       	mov    $0x0,%esi
801034cd:	eb 3c                	jmp    8010350b <fork+0xa3>
    kfree(np->kstack);
801034cf:	83 ec 0c             	sub    $0xc,%esp
801034d2:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801034d5:	ff 73 08             	pushl  0x8(%ebx)
801034d8:	e8 69 eb ff ff       	call   80102046 <kfree>
    np->kstack = 0;
801034dd:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
801034e4:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
801034eb:	83 c4 10             	add    $0x10,%esp
801034ee:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801034f3:	eb 6d                	jmp    80103562 <fork+0xfa>
      np->ofile[i] = filedup(curproc->ofile[i]);
801034f5:	83 ec 0c             	sub    $0xc,%esp
801034f8:	50                   	push   %eax
801034f9:	e8 cb d7 ff ff       	call   80100cc9 <filedup>
801034fe:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103501:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
80103505:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NOFILE; i++)
80103508:	83 c6 01             	add    $0x1,%esi
8010350b:	83 fe 0f             	cmp    $0xf,%esi
8010350e:	7f 0a                	jg     8010351a <fork+0xb2>
    if(curproc->ofile[i])
80103510:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
80103514:	85 c0                	test   %eax,%eax
80103516:	75 dd                	jne    801034f5 <fork+0x8d>
80103518:	eb ee                	jmp    80103508 <fork+0xa0>
  np->cwd = idup(curproc->cwd);
8010351a:	83 ec 0c             	sub    $0xc,%esp
8010351d:	ff 73 6c             	pushl  0x6c(%ebx)
80103520:	e8 8c e0 ff ff       	call   801015b1 <idup>
80103525:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103528:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
8010352b:	83 c3 74             	add    $0x74,%ebx
8010352e:	8d 47 74             	lea    0x74(%edi),%eax
80103531:	83 c4 0c             	add    $0xc,%esp
80103534:	6a 10                	push   $0x10
80103536:	53                   	push   %ebx
80103537:	50                   	push   %eax
80103538:	e8 e8 09 00 00       	call   80103f25 <safestrcpy>
  pid = np->pid;
8010353d:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103540:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103547:	e8 a5 07 00 00       	call   80103cf1 <acquire>
  np->state = RUNNABLE;
8010354c:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103553:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010355a:	e8 fb 07 00 00       	call   80103d5a <release>
  return pid;
8010355f:	83 c4 10             	add    $0x10,%esp
}
80103562:	89 d8                	mov    %ebx,%eax
...
8010356b:	c3                   	ret    
    return -1;
8010356c:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103571:	eb ef                	jmp    80103562 <fork+0xfa>

80103573 <scheduler>:
{
80103573:	f3 0f 1e fb          	endbr32 
80103577:	55                   	push   %ebp
80103578:	89 e5                	mov    %esp,%ebp
8010357a:	56                   	push   %esi
8010357b:	53                   	push   %ebx
  struct cpu *c = mycpu();
8010357c:	e8 e6 fc ff ff       	call   80103267 <mycpu>
80103581:	89 c6                	mov    %eax,%esi
  c->proc = 0;
80103583:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
8010358a:	00 00 00 
8010358d:	eb 5d                	jmp    801035ec <scheduler+0x79>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010358f:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103595:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
8010359b:	73 3f                	jae    801035dc <scheduler+0x69>
      if(p->state != RUNNABLE)
8010359d:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
801035a1:	75 ec                	jne    8010358f <scheduler+0x1c>
      c->proc = p;
801035a3:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
801035a9:	83 ec 0c             	sub    $0xc,%esp
801035ac:	53                   	push   %ebx
801035ad:	e8 4d 2d 00 00       	call   801062ff <switchuvm>
      p->state = RUNNING;
801035b2:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
801035b9:	83 c4 08             	add    $0x8,%esp
801035bc:	ff 73 1c             	pushl  0x1c(%ebx)
801035bf:	8d 46 04             	lea    0x4(%esi),%eax
801035c2:	50                   	push   %eax
801035c3:	e8 ba 09 00 00       	call   80103f82 <swtch>
      switchkvm();
801035c8:	e8 20 2d 00 00       	call   801062ed <switchkvm>
      c->proc = 0;
801035cd:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
801035d4:	00 00 00 
801035d7:	83 c4 10             	add    $0x10,%esp
801035da:	eb b3                	jmp    8010358f <scheduler+0x1c>
    release(&ptable.lock);
801035dc:	83 ec 0c             	sub    $0xc,%esp
801035df:	68 20 2d 11 80       	push   $0x80112d20
801035e4:	e8 71 07 00 00       	call   80103d5a <release>
    sti();
...
801035f0:	68 20 2d 11 80       	push   $0x80112d20
801035f5:	e8 f7 06 00 00       	call   80103cf1 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801035fa:	83 c4 10             	add    $0x10,%esp
801035fd:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103602:	eb 91                	jmp    80103595 <scheduler+0x22>

80103604 <sched>:
{
80103604:	f3 0f 1e fb          	endbr32 
80103608:	55                   	push   %ebp
80103609:	89 e5                	mov    %esp,%ebp
8010360b:	56                   	push   %esi
8010360c:	53                   	push   %ebx
  struct proc *p = myproc();
8010360d:	e8 d4 fc ff ff       	call   801032e6 <myproc>
80103612:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103614:	83 ec 0c             	sub    $0xc,%esp
80103617:	68 20 2d 11 80       	push   $0x80112d20
8010361c:	e8 8c 06 00 00       	call   80103cad <holding>
80103621:	83 c4 10             	add    $0x10,%esp
80103624:	85 c0                	test   %eax,%eax
80103626:	74 4f                	je     80103677 <sched+0x73>
  if(mycpu()->ncli != 1)
80103628:	e8 3a fc ff ff       	call   80103267 <mycpu>
8010362d:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103634:	75 4e                	jne    80103684 <sched+0x80>
  if(p->state == RUNNING)
80103636:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
8010363a:	74 55                	je     80103691 <sched+0x8d>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
8010363c:	9c                   	pushf  
8010363d:	58                   	pop    %eax
  if(readeflags()&FL_IF)
8010363e:	f6 c4 02             	test   $0x2,%ah
80103641:	75 5b                	jne    8010369e <sched+0x9a>
  intena = mycpu()->intena;
80103643:	e8 1f fc ff ff       	call   80103267 <mycpu>
80103648:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
8010364e:	e8 14 fc ff ff       	call   80103267 <mycpu>
80103653:	83 ec 08             	sub    $0x8,%esp
80103656:	ff 70 04             	pushl  0x4(%eax)
80103659:	83 c3 1c             	add    $0x1c,%ebx
8010365c:	53                   	push   %ebx
8010365d:	e8 20 09 00 00       	call   80103f82 <swtch>
  mycpu()->intena = intena;
80103662:	e8 00 fc ff ff       	call   80103267 <mycpu>
...
8010367a:	68 fb 6e 10 80       	push   $0x80106efb
8010367f:	e8 d8 cc ff ff       	call   8010035c <panic>
    panic("sched locks");
80103684:	83 ec 0c             	sub    $0xc,%esp
80103687:	68 0d 6f 10 80       	push   $0x80106f0d
8010368c:	e8 cb cc ff ff       	call   8010035c <panic>
    panic("sched running");
80103691:	83 ec 0c             	sub    $0xc,%esp
80103694:	68 19 6f 10 80       	push   $0x80106f19
80103699:	e8 be cc ff ff       	call   8010035c <panic>
    panic("sched interruptible");
8010369e:	83 ec 0c             	sub    $0xc,%esp
801036a1:	68 27 6f 10 80       	push   $0x80106f27
801036a6:	e8 b1 cc ff ff       	call   8010035c <panic>

801036ab <exit>:
{
801036ab:	f3 0f 1e fb          	endbr32 
801036af:	55                   	push   %ebp
801036b0:	89 e5                	mov    %esp,%ebp
801036b2:	56                   	push   %esi
801036b3:	53                   	push   %ebx
  struct proc *curproc = myproc();
801036b4:	e8 2d fc ff ff       	call   801032e6 <myproc>
  if(curproc == initproc)   // si se quiere liberar el proceso inicial del sistema
801036b9:	39 05 b8 a5 10 80    	cmp    %eax,0x8010a5b8
801036bf:	74 09                	je     801036ca <exit+0x1f>
801036c1:	89 c6                	mov    %eax,%esi
  for(fd = 0; fd < NOFILE; fd++){
801036c3:	bb 00 00 00 00       	mov    $0x0,%ebx
801036c8:	eb 24                	jmp    801036ee <exit+0x43>
    panic("init exiting");
801036ca:	83 ec 0c             	sub    $0xc,%esp
801036cd:	68 3b 6f 10 80       	push   $0x80106f3b
801036d2:	e8 85 cc ff ff       	call   8010035c <panic>
      fileclose(curproc->ofile[fd]);
801036d7:	83 ec 0c             	sub    $0xc,%esp
801036da:	50                   	push   %eax
801036db:	e8 32 d6 ff ff       	call   80100d12 <fileclose>
      curproc->ofile[fd] = 0;
801036e0:	c7 44 9e 2c 00 00 00 	movl   $0x0,0x2c(%esi,%ebx,4)
801036e7:	00 
801036e8:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
801036eb:	83 c3 01             	add    $0x1,%ebx
801036ee:	83 fb 0f             	cmp    $0xf,%ebx
801036f1:	7f 0a                	jg     801036fd <exit+0x52>
    if(curproc->ofile[fd]){
801036f3:	8b 44 9e 2c          	mov    0x2c(%esi,%ebx,4),%eax
801036f7:	85 c0                	test   %eax,%eax
801036f9:	75 dc                	jne    801036d7 <exit+0x2c>
801036fb:	eb ee                	jmp    801036eb <exit+0x40>
  begin_op();
801036fd:	e8 68 f1 ff ff       	call   8010286a <begin_op>
  iput(curproc->cwd);
80103702:	83 ec 0c             	sub    $0xc,%esp
80103705:	ff 76 6c             	pushl  0x6c(%esi)
80103708:	e8 e7 df ff ff       	call   801016f4 <iput>
  end_op();
8010370d:	e8 d6 f1 ff ff       	call   801028e8 <end_op>
  curproc->cwd = 0;
80103712:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);    // nos apropiamos de la ptable
80103719:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103720:	e8 cc 05 00 00       	call   80103cf1 <acquire>
  wakeup1(curproc->parent);
80103725:	8b 46 14             	mov    0x14(%esi),%eax
80103728:	e8 ea f9 ff ff       	call   80103117 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010372d:	83 c4 10             	add    $0x10,%esp
80103730:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103735:	eb 06                	jmp    8010373d <exit+0x92>
80103737:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010373d:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103743:	73 1a                	jae    8010375f <exit+0xb4>
    if(p->parent == curproc){   // si el proceso analizado es un proceso hijo
80103745:	39 73 14             	cmp    %esi,0x14(%ebx)
80103748:	75 ed                	jne    80103737 <exit+0x8c>
      p->parent = initproc; // asignamos el hijo a init
8010374a:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
8010374f:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)    // si el proceso hijo se encuentra en estado zombie
80103752:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103756:	75 df                	jne    80103737 <exit+0x8c>
        wakeup1(initproc); // despertamos a init para que libere el proceso
80103758:	e8 ba f9 ff ff       	call   80103117 <wakeup1>
8010375d:	eb d8                	jmp    80103737 <exit+0x8c>
...
80103766:	e8 99 fe ff ff       	call   80103604 <sched>
  panic("zombie exit");
8010376b:	83 ec 0c             	sub    $0xc,%esp
8010376e:	68 48 6f 10 80       	push   $0x80106f48
80103773:	e8 e4 cb ff ff       	call   8010035c <panic>

80103778 <yield>:
{
80103778:	f3 0f 1e fb          	endbr32 
8010377c:	55                   	push   %ebp
8010377d:	89 e5                	mov    %esp,%ebp
8010377f:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);  //DOC: yieldlock
80103782:	68 20 2d 11 80       	push   $0x80112d20
80103787:	e8 65 05 00 00       	call   80103cf1 <acquire>
  myproc()->state = RUNNABLE;
8010378c:	e8 55 fb ff ff       	call   801032e6 <myproc>
80103791:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80103798:	e8 67 fe ff ff       	call   80103604 <sched>
  release(&ptable.lock);
8010379d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037a4:	e8 b1 05 00 00       	call   80103d5a <release>
}
...
801037b7:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
801037ba:	e8 27 fb ff ff       	call   801032e6 <myproc>
  if(p == 0)
801037bf:	85 c0                	test   %eax,%eax
801037c1:	74 66                	je     80103829 <sleep+0x7b>
801037c3:	89 c3                	mov    %eax,%ebx
  if(lk == 0)
801037c5:	85 f6                	test   %esi,%esi
801037c7:	74 6d                	je     80103836 <sleep+0x88>
  if(lk != &ptable.lock){  //DOC: sleeplock0
801037c9:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
801037cf:	74 18                	je     801037e9 <sleep+0x3b>
    acquire(&ptable.lock);  //DOC: sleeplock1
801037d1:	83 ec 0c             	sub    $0xc,%esp
801037d4:	68 20 2d 11 80       	push   $0x80112d20
801037d9:	e8 13 05 00 00       	call   80103cf1 <acquire>
    release(lk);
801037de:	89 34 24             	mov    %esi,(%esp)
801037e1:	e8 74 05 00 00       	call   80103d5a <release>
801037e6:	83 c4 10             	add    $0x10,%esp
  p->chan = chan;
801037e9:	8b 45 08             	mov    0x8(%ebp),%eax
801037ec:	89 43 24             	mov    %eax,0x24(%ebx)
  p->state = SLEEPING;
801037ef:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801037f6:	e8 09 fe ff ff       	call   80103604 <sched>
  p->chan = 0;
801037fb:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
  if(lk != &ptable.lock){  //DOC: sleeplock2
80103802:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
80103808:	74 18                	je     80103822 <sleep+0x74>
    release(&ptable.lock);
8010380a:	83 ec 0c             	sub    $0xc,%esp
8010380d:	68 20 2d 11 80       	push   $0x80112d20
80103812:	e8 43 05 00 00       	call   80103d5a <release>
    acquire(lk);
80103817:	89 34 24             	mov    %esi,(%esp)
8010381a:	e8 d2 04 00 00       	call   80103cf1 <acquire>
...
8010382c:	68 54 6f 10 80       	push   $0x80106f54
80103831:	e8 26 cb ff ff       	call   8010035c <panic>
    panic("sleep without lk");
80103836:	83 ec 0c             	sub    $0xc,%esp
80103839:	68 5a 6f 10 80       	push   $0x80106f5a
8010383e:	e8 19 cb ff ff       	call   8010035c <panic>
...
8010384b:	53                   	push   %ebx
  struct proc *curproc = myproc();
8010384c:	e8 95 fa ff ff       	call   801032e6 <myproc>
80103851:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);    // nos apropiamos de la ptable
80103853:	83 ec 0c             	sub    $0xc,%esp
80103856:	68 20 2d 11 80       	push   $0x80112d20
8010385b:	e8 91 04 00 00       	call   80103cf1 <acquire>
80103860:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103863:	b8 00 00 00 00       	mov    $0x0,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103868:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
8010386d:	eb 66                	jmp    801038d5 <wait+0x92>
        pid = p->pid; // para el return
8010386f:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack); // liberamos su pila del kernel
80103872:	83 ec 0c             	sub    $0xc,%esp
80103875:	ff 73 08             	pushl  0x8(%ebx)
80103878:	e8 c9 e7 ff ff       	call   80102046 <kfree>
        p->kstack = 0;
8010387d:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);   // liberamos su memoria virtual
80103884:	83 c4 04             	add    $0x4,%esp
80103887:	ff 73 04             	pushl  0x4(%ebx)
8010388a:	e8 1b 2e 00 00       	call   801066aa <freevm>
        p->pid = 0;
8010388f:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
	*status = p->status;
80103896:	8b 53 20             	mov    0x20(%ebx),%edx
80103899:	8b 45 08             	mov    0x8(%ebp),%eax
8010389c:	89 10                	mov    %edx,(%eax)
        p->parent = 0;
8010389e:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801038a5:	c6 43 74 00          	movb   $0x0,0x74(%ebx)
        p->killed = 0;
801038a9:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
...
801038be:	e8 97 04 00 00       	call   80103d5a <release>
        return pid;
...
801038d5:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
801038db:	73 12                	jae    801038ef <wait+0xac>
      if(p->parent != curproc)  // si el proceso analizado no es mi hijo
801038dd:	39 73 14             	cmp    %esi,0x14(%ebx)
801038e0:	75 ed                	jne    801038cf <wait+0x8c>
...
801038e6:	74 87                	je     8010386f <wait+0x2c>
      havekids = 1; // el proceso tiene al menos un hijo
801038e8:	b8 01 00 00 00       	mov    $0x1,%eax
801038ed:	eb e0                	jmp    801038cf <wait+0x8c>
    if(!havekids || curproc->killed){
801038ef:	85 c0                	test   %eax,%eax
801038f1:	74 06                	je     801038f9 <wait+0xb6>
801038f3:	83 7e 28 00          	cmpl   $0x0,0x28(%esi)
801038f7:	74 17                	je     80103910 <wait+0xcd>
      release(&ptable.lock);
801038f9:	83 ec 0c             	sub    $0xc,%esp
801038fc:	68 20 2d 11 80       	push   $0x80112d20
80103901:	e8 54 04 00 00       	call   80103d5a <release>
      return -1;
80103906:	83 c4 10             	add    $0x10,%esp
80103909:	be ff ff ff ff       	mov    $0xffffffff,%esi
8010390e:	eb b6                	jmp    801038c6 <wait+0x83>
    sleep(curproc, &ptable.lock);
80103910:	83 ec 08             	sub    $0x8,%esp
80103913:	68 20 2d 11 80       	push   $0x80112d20
80103918:	56                   	push   %esi
80103919:	e8 90 fe ff ff       	call   801037ae <sleep>
    havekids = 0;
8010391e:	83 c4 10             	add    $0x10,%esp
80103921:	e9 3d ff ff ff       	jmp    80103863 <wait+0x20>
...
80103935:	e8 b7 03 00 00       	call   80103cf1 <acquire>
  wakeup1(chan);
8010393a:	8b 45 08             	mov    0x8(%ebp),%eax
8010393d:	e8 d5 f7 ff ff       	call   80103117 <wakeup1>
  release(&ptable.lock);
80103942:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103949:	e8 0c 04 00 00       	call   80103d5a <release>
}
...
80103973:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103978:	73 3c                	jae    801039b6 <kill+0x63>
    if(p->pid == pid){  // el proceso se quiere mata a si mismo
8010397a:	39 58 10             	cmp    %ebx,0x10(%eax)
8010397d:	74 07                	je     80103986 <kill+0x33>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){   // la recorremos
8010397f:	05 84 00 00 00       	add    $0x84,%eax
80103984:	eb ed                	jmp    80103973 <kill+0x20>
      p->killed = 1;    // el proceso lo marcamos como matado
80103986:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)  // si el proceso esta durmiendo
8010398d:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103991:	74 1a                	je     801039ad <kill+0x5a>
...
8010399b:	e8 ba 03 00 00       	call   80103d5a <release>
      return 0;
801039a0:	83 c4 10             	add    $0x10,%esp
801039a3:	b8 00 00 00 00       	mov    $0x0,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
801039ac:	c3                   	ret    
        p->state = RUNNABLE;    // lo despertamos para que se liberen sus recursos cuanto antes
801039ad:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
801039b4:	eb dd                	jmp    80103993 <kill+0x40>
  release(&ptable.lock);
801039b6:	83 ec 0c             	sub    $0xc,%esp
801039b9:	68 20 2d 11 80       	push   $0x80112d20
801039be:	e8 97 03 00 00       	call   80103d5a <release>
  return -1;
801039c3:	83 c4 10             	add    $0x10,%esp
801039c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801039cb:	eb db                	jmp    801039a8 <kill+0x55>
...
801039d6:	83 ec 30             	sub    $0x30,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039d9:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
801039de:	eb 36                	jmp    80103a16 <procdump+0x49>
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
801039e0:	b8 6b 6f 10 80       	mov    $0x80106f6b,%eax
    cprintf("%d %s %s", p->pid, state, p->name);
801039e5:	8d 53 74             	lea    0x74(%ebx),%edx
801039e8:	52                   	push   %edx
801039e9:	50                   	push   %eax
801039ea:	ff 73 10             	pushl  0x10(%ebx)
801039ed:	68 6f 6f 10 80       	push   $0x80106f6f
801039f2:	e8 32 cc ff ff       	call   80100629 <cprintf>
    if(p->state == SLEEPING){
801039f7:	83 c4 10             	add    $0x10,%esp
801039fa:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
801039fe:	74 3c                	je     80103a3c <procdump+0x6f>
...
80103a03:	68 56 71 10 80       	push   $0x80107156
80103a08:	e8 1c cc ff ff       	call   80100629 <cprintf>
80103a0d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a10:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103a16:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103a1c:	73 61                	jae    80103a7f <procdump+0xb2>
    if(p->state == UNUSED)
80103a1e:	8b 43 0c             	mov    0xc(%ebx),%eax
80103a21:	85 c0                	test   %eax,%eax
80103a23:	74 eb                	je     80103a10 <procdump+0x43>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103a25:	83 f8 05             	cmp    $0x5,%eax
80103a28:	77 b6                	ja     801039e0 <procdump+0x13>
80103a2a:	8b 04 85 cc 6f 10 80 	mov    -0x7fef9034(,%eax,4),%eax
80103a31:	85 c0                	test   %eax,%eax
80103a33:	75 b0                	jne    801039e5 <procdump+0x18>
      state = "???";
80103a35:	b8 6b 6f 10 80       	mov    $0x80106f6b,%eax
80103a3a:	eb a9                	jmp    801039e5 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
...
80103a5a:	eb 14                	jmp    80103a70 <procdump+0xa3>
        cprintf(" %p", pc[i]);
80103a5c:	83 ec 08             	sub    $0x8,%esp
80103a5f:	50                   	push   %eax
80103a60:	68 c1 69 10 80       	push   $0x801069c1
80103a65:	e8 bf cb ff ff       	call   80100629 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80103a6a:	83 c6 01             	add    $0x1,%esi
80103a6d:	83 c4 10             	add    $0x10,%esp
80103a70:	83 fe 09             	cmp    $0x9,%esi
80103a73:	7f 8b                	jg     80103a00 <procdump+0x33>
80103a75:	8b 44 b5 d0          	mov    -0x30(%ebp,%esi,4),%eax
80103a79:	85 c0                	test   %eax,%eax
80103a7b:	75 df                	jne    80103a5c <procdump+0x8f>
80103a7d:	eb 81                	jmp    80103a00 <procdump+0x33>
  }
}
...
80103a94:	68 e4 6f 10 80       	push   $0x80106fe4
...
80103adb:	74 0f                	je     80103aec <acquiresleep+0x2f>
    sleep(lk, &lk->lk);
80103add:	83 ec 08             	sub    $0x8,%esp
80103ae0:	56                   	push   %esi
80103ae1:	53                   	push   %ebx
80103ae2:	e8 c7 fc ff ff       	call   801037ae <sleep>
80103ae7:	83 c4 10             	add    $0x10,%esp
80103aea:	eb ec                	jmp    80103ad8 <acquiresleep+0x1b>
  }
  lk->locked = 1;
80103aec:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103af2:	e8 ef f7 ff ff       	call   801032e6 <myproc>
...
80103b38:	e8 e9 fd ff ff       	call   80103926 <wakeup>
  release(&lk->lk);
...
80103b89:	e8 58 f7 ff ff       	call   801032e6 <myproc>
...
80103c15:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103c16:	e8 4c f6 ff ff       	call   80103267 <mycpu>
80103c1b:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103c22:	74 12                	je     80103c36 <pushcli+0x2e>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103c24:	e8 3e f6 ff ff       	call   80103267 <mycpu>
80103c29:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80103c35:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103c36:	e8 2c f6 ff ff       	call   80103267 <mycpu>
80103c3b:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103c41:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103c47:	eb db                	jmp    80103c24 <pushcli+0x1c>
...
80103c58:	75 28                	jne    80103c82 <popcli+0x39>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80103c5a:	e8 08 f6 ff ff       	call   80103267 <mycpu>
...
80103c70:	78 1d                	js     80103c8f <popcli+0x46>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103c72:	e8 f0 f5 ff ff       	call   80103267 <mycpu>
80103c77:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103c7e:	74 1c                	je     80103c9c <popcli+0x53>
    sti();
}
80103c80:	c9                   	leave  
80103c81:	c3                   	ret    
...
80103c85:	68 ef 6f 10 80       	push   $0x80106fef
80103c8a:	e8 cd c6 ff ff       	call   8010035c <panic>
    panic("popcli");
80103c8f:	83 ec 0c             	sub    $0xc,%esp
80103c92:	68 06 70 10 80       	push   $0x80107006
80103c97:	e8 c0 c6 ff ff       	call   8010035c <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103c9c:	e8 c6 f5 ff ff       	call   80103267 <mycpu>
80103ca1:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
80103ca8:	74 d6                	je     80103c80 <popcli+0x37>
  asm volatile("sti");
80103caa:	fb                   	sti    
}
80103cab:	eb d3                	jmp    80103c80 <popcli+0x37>
...
80103cb8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103cbb:	e8 48 ff ff ff       	call   80103c08 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103cc0:	83 3b 00             	cmpl   $0x0,(%ebx)
80103cc3:	75 12                	jne    80103cd7 <holding+0x2a>
80103cc5:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103cca:	e8 7a ff ff ff       	call   80103c49 <popcli>
}
...
80103cda:	e8 88 f5 ff ff       	call   80103267 <mycpu>
80103cdf:	39 c3                	cmp    %eax,%ebx
80103ce1:	74 07                	je     80103cea <holding+0x3d>
80103ce3:	bb 00 00 00 00       	mov    $0x0,%ebx
80103ce8:	eb e0                	jmp    80103cca <holding+0x1d>
80103cea:	bb 01 00 00 00       	mov    $0x1,%ebx
80103cef:	eb d9                	jmp    80103cca <holding+0x1d>
...
80103cfc:	e8 07 ff ff ff       	call   80103c08 <pushcli>
  if(holding(lk))
80103d01:	83 ec 0c             	sub    $0xc,%esp
80103d04:	ff 75 08             	pushl  0x8(%ebp)
80103d07:	e8 a1 ff ff ff       	call   80103cad <holding>
...
80103d2a:	e8 38 f5 ff ff       	call   80103267 <mycpu>
...
80103d69:	e8 3f ff ff ff       	call   80103cad <holding>
...
80103d88:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103d8e:	e8 b6 fe ff ff       	call   80103c49 <popcli>
}
...
80103d9b:	68 15 70 10 80       	push   $0x80107015
...
80103dfb:	8b 45 10             	mov    0x10(%ebp),%eax
  ...
  s2 = v2;
  while(n-- > 0){
80103dfe:	8d 70 ff             	lea    -0x1(%eax),%esi
80103e01:	85 c0                	test   %eax,%eax
80103e03:	74 1c                	je     80103e21 <memcmp+0x35>
    if(*s1 != *s2)
80103e05:	0f b6 01             	movzbl (%ecx),%eax
80103e08:	0f b6 1a             	movzbl (%edx),%ebx
80103e0b:	38 d8                	cmp    %bl,%al
80103e0d:	75 0a                	jne    80103e19 <memcmp+0x2d>
      return *s1 - *s2;
    s1++, s2++;
80103e0f:	83 c1 01             	add    $0x1,%ecx
80103e12:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103e15:	89 f0                	mov    %esi,%eax
80103e17:	eb e5                	jmp    80103dfe <memcmp+0x12>
      return *s1 - *s2;
...
80103e39:	73 3a                	jae    80103e75 <memmove+0x50>
80103e3b:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80103e3e:	39 f1                	cmp    %esi,%ecx
80103e40:	76 37                	jbe    80103e79 <memmove+0x54>
    s += n;
    d += n;
80103e42:	8d 14 06             	lea    (%esi,%eax,1),%edx
    while(n-- > 0)
80103e45:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103e48:	85 c0                	test   %eax,%eax
80103e4a:	74 23                	je     80103e6f <memmove+0x4a>
      *--d = *--s;
80103e4c:	83 e9 01             	sub    $0x1,%ecx
80103e4f:	83 ea 01             	sub    $0x1,%edx
80103e52:	0f b6 01             	movzbl (%ecx),%eax
80103e55:	88 02                	mov    %al,(%edx)
    while(n-- > 0)
80103e57:	89 d8                	mov    %ebx,%eax
80103e59:	eb ea                	jmp    80103e45 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103e5b:	0f b6 02             	movzbl (%edx),%eax
80103e5e:	88 01                	mov    %al,(%ecx)
80103e60:	8d 49 01             	lea    0x1(%ecx),%ecx
80103e63:	8d 52 01             	lea    0x1(%edx),%edx
    while(n-- > 0)
80103e66:	89 d8                	mov    %ebx,%eax
80103e68:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103e6b:	85 c0                	test   %eax,%eax
80103e6d:	75 ec                	jne    80103e5b <memmove+0x36>

  return dst;
}
80103e6f:	89 f0                	mov    %esi,%eax
80103e71:	5b                   	pop    %ebx
80103e72:	5e                   	pop    %esi
80103e73:	5d                   	pop    %ebp
80103e74:	c3                   	ret    
80103e75:	89 f1                	mov    %esi,%ecx
80103e77:	eb ef                	jmp    80103e68 <memmove+0x43>
80103e79:	89 f1                	mov    %esi,%ecx
80103e7b:	eb eb                	jmp    80103e68 <memmove+0x43>
...
80103e87:	ff 75 10             	pushl  0x10(%ebp)
80103e8a:	ff 75 0c             	pushl  0xc(%ebp)
80103e8d:	ff 75 08             	pushl  0x8(%ebp)
80103e90:	e8 90 ff ff ff       	call   80103e25 <memmove>
}
80103e95:	c9                   	leave  
80103e96:	c3                   	ret    
...
80103ea5:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80103ea8:	eb 09                	jmp    80103eb3 <strncmp+0x1c>
    n--, p++, q++;
80103eaa:	83 e8 01             	sub    $0x1,%eax
80103ead:	83 c2 01             	add    $0x1,%edx
80103eb0:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80103eb3:	85 c0                	test   %eax,%eax
80103eb5:	74 0b                	je     80103ec2 <strncmp+0x2b>
80103eb7:	0f b6 1a             	movzbl (%edx),%ebx
80103eba:	84 db                	test   %bl,%bl
80103ebc:	74 04                	je     80103ec2 <strncmp+0x2b>
80103ebe:	3a 19                	cmp    (%ecx),%bl
80103ec0:	74 e8                	je     80103eaa <strncmp+0x13>
  if(n == 0)
80103ec2:	85 c0                	test   %eax,%eax
80103ec4:	74 0b                	je     80103ed1 <strncmp+0x3a>
    return 0;
  return (uchar)*p - (uchar)*q;
80103ec6:	0f b6 02             	movzbl (%edx),%eax
80103ec9:	0f b6 11             	movzbl (%ecx),%edx
80103ecc:	29 d0                	sub    %edx,%eax
}
80103ece:	5b                   	pop    %ebx
80103ecf:	5d                   	pop    %ebp
80103ed0:	c3                   	ret    
...
80103ed6:	eb f6                	jmp    80103ece <strncmp+0x37>
...
80103ee5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80103eed:	eb 04                	jmp    80103ef3 <strncpy+0x1b>
80103eef:	89 f1                	mov    %esi,%ecx
80103ef1:	89 da                	mov    %ebx,%edx
80103ef3:	89 c3                	mov    %eax,%ebx
80103ef5:	83 e8 01             	sub    $0x1,%eax
80103ef8:	85 db                	test   %ebx,%ebx
80103efa:	7e 1b                	jle    80103f17 <strncpy+0x3f>
80103efc:	8d 71 01             	lea    0x1(%ecx),%esi
80103eff:	8d 5a 01             	lea    0x1(%edx),%ebx
80103f02:	0f b6 09             	movzbl (%ecx),%ecx
80103f05:	88 0a                	mov    %cl,(%edx)
80103f07:	84 c9                	test   %cl,%cl
80103f09:	75 e4                	jne    80103eef <strncpy+0x17>
80103f0b:	89 da                	mov    %ebx,%edx
80103f0d:	eb 08                	jmp    80103f17 <strncpy+0x3f>
    ;
  while(n-- > 0)
    *s++ = 0;
...
80103f14:	8d 52 01             	lea    0x1(%edx),%edx
  while(n-- > 0)
80103f17:	8d 48 ff             	lea    -0x1(%eax),%ecx
80103f1a:	85 c0                	test   %eax,%eax
80103f1c:	7f f1                	jg     80103f0f <strncpy+0x37>
  return os;
}
...
80103f2c:	57                   	push   %edi
80103f2d:	56                   	push   %esi
80103f2e:	53                   	push   %ebx
80103f2f:	8b 7d 08             	mov    0x8(%ebp),%edi
80103f32:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103f35:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  if(n <= 0)
80103f38:	85 c0                	test   %eax,%eax
80103f3a:	7e 23                	jle    80103f5f <safestrcpy+0x3a>
80103f3c:	89 fa                	mov    %edi,%edx
80103f3e:	eb 04                	jmp    80103f44 <safestrcpy+0x1f>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80103f40:	89 f1                	mov    %esi,%ecx
80103f42:	89 da                	mov    %ebx,%edx
80103f44:	83 e8 01             	sub    $0x1,%eax
80103f47:	85 c0                	test   %eax,%eax
80103f49:	7e 11                	jle    80103f5c <safestrcpy+0x37>
80103f4b:	8d 71 01             	lea    0x1(%ecx),%esi
80103f4e:	8d 5a 01             	lea    0x1(%edx),%ebx
80103f51:	0f b6 09             	movzbl (%ecx),%ecx
80103f54:	88 0a                	mov    %cl,(%edx)
80103f56:	84 c9                	test   %cl,%cl
80103f58:	75 e6                	jne    80103f40 <safestrcpy+0x1b>
80103f5a:	89 da                	mov    %ebx,%edx
    ;
  *s = 0;
...
80103f79:	74 05                	je     80103f80 <strlen+0x1a>
80103f7b:	83 c0 01             	add    $0x1,%eax
80103f7e:	eb f5                	jmp    80103f75 <strlen+0xf>
    ;
  return n;
}
80103f80:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80103f82:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80103f86:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80103f8d:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80103f8e:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80103f90:	89 d4                	mov    %edx,%esp
...
80103fa2:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80103fa5:	e8 3c f3 ff ff       	call   801032e6 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80103faa:	8b 00                	mov    (%eax),%eax
80103fac:	39 d8                	cmp    %ebx,%eax
80103fae:	76 19                	jbe    80103fc9 <fetchint+0x32>
80103fb0:	8d 53 04             	lea    0x4(%ebx),%edx
80103fb3:	39 d0                	cmp    %edx,%eax
80103fb5:	72 19                	jb     80103fd0 <fetchint+0x39>
    return -1;
  *ip = *(int*)(addr);
...
80103fce:	eb f3                	jmp    80103fc3 <fetchint+0x2c>
80103fd0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fd5:	eb ec                	jmp    80103fc3 <fetchint+0x2c>
...
80103fe2:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80103fe5:	e8 fc f2 ff ff       	call   801032e6 <myproc>

  if(addr >= curproc->sz)
80103fea:	39 18                	cmp    %ebx,(%eax)
80103fec:	76 26                	jbe    80104014 <fetchstr+0x3d>
    return -1;
  *pp = (char*)addr;
80103fee:	8b 55 0c             	mov    0xc(%ebp),%edx
80103ff1:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80103ff3:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80103ff5:	89 d8                	mov    %ebx,%eax
80103ff7:	39 d0                	cmp    %edx,%eax
80103ff9:	73 0e                	jae    80104009 <fetchstr+0x32>
    if(*s == 0)
80103ffb:	80 38 00             	cmpb   $0x0,(%eax)
80103ffe:	74 05                	je     80104005 <fetchstr+0x2e>
  for(s = *pp; s < ep; s++){
80104000:	83 c0 01             	add    $0x1,%eax
80104003:	eb f2                	jmp    80103ff7 <fetchstr+0x20>
      return s - *pp;
80104005:	29 d8                	sub    %ebx,%eax
80104007:	eb 05                	jmp    8010400e <fetchstr+0x37>
  }
  return -1;
80104009:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
8010400e:	83 c4 04             	add    $0x4,%esp
80104011:	5b                   	pop    %ebx
80104012:	5d                   	pop    %ebp
80104013:	c3                   	ret    
    return -1;
80104014:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104019:	eb f3                	jmp    8010400e <fetchstr+0x37>
...
argint(int n, int *ip)
{
8010401b:	f3 0f 1e fb          	endbr32 
8010401f:	55                   	push   %ebp
80104020:	89 e5                	mov    %esp,%ebp
80104022:	83 ec 08             	sub    $0x8,%esp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104025:	e8 bc f2 ff ff       	call   801032e6 <myproc>
8010402a:	8b 50 18             	mov    0x18(%eax),%edx
8010402d:	8b 45 08             	mov    0x8(%ebp),%eax
80104030:	c1 e0 02             	shl    $0x2,%eax
80104033:	03 42 44             	add    0x44(%edx),%eax
80104036:	83 ec 08             	sub    $0x8,%esp
80104039:	ff 75 0c             	pushl  0xc(%ebp)
8010403c:	83 c0 04             	add    $0x4,%eax
8010403f:	50                   	push   %eax
80104040:	e8 52 ff ff ff       	call   80103f97 <fetchint>
}
80104045:	c9                   	leave  
80104046:	c3                   	ret    
...
{
80104047:	f3 0f 1e fb          	endbr32 
8010404b:	55                   	push   %ebp
8010404c:	89 e5                	mov    %esp,%ebp
8010404e:	56                   	push   %esi
8010404f:	53                   	push   %ebx
80104050:	83 ec 10             	sub    $0x10,%esp
80104053:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104056:	e8 8b f2 ff ff       	call   801032e6 <myproc>
8010405b:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
8010405d:	83 ec 08             	sub    $0x8,%esp
80104060:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104063:	50                   	push   %eax
80104064:	ff 75 08             	pushl  0x8(%ebp)
80104067:	e8 af ff ff ff       	call   8010401b <argint>
8010406c:	83 c4 10             	add    $0x10,%esp
8010406f:	85 c0                	test   %eax,%eax
80104071:	78 24                	js     80104097 <argptr+0x50>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104073:	85 db                	test   %ebx,%ebx
80104075:	78 27                	js     8010409e <argptr+0x57>
80104077:	8b 16                	mov    (%esi),%edx
80104079:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010407c:	39 c2                	cmp    %eax,%edx
8010407e:	76 25                	jbe    801040a5 <argptr+0x5e>
80104080:	01 c3                	add    %eax,%ebx
80104082:	39 da                	cmp    %ebx,%edx
80104084:	72 26                	jb     801040ac <argptr+0x65>
    return -1;
  *pp = (void*)i;
80104086:	8b 55 0c             	mov    0xc(%ebp),%edx
80104089:	89 02                	mov    %eax,(%edx)
  return 0;
8010408b:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104090:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104093:	5b                   	pop    %ebx
80104094:	5e                   	pop    %esi
80104095:	5d                   	pop    %ebp
80104096:	c3                   	ret    
...
8010409c:	eb f2                	jmp    80104090 <argptr+0x49>
    return -1;
8010409e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801040a3:	eb eb                	jmp    80104090 <argptr+0x49>
801040a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801040aa:	eb e4                	jmp    80104090 <argptr+0x49>
801040ac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801040b1:	eb dd                	jmp    80104090 <argptr+0x49>
...
801040c1:	ff 75 08             	pushl  0x8(%ebp)
801040c4:	e8 52 ff ff ff       	call   8010401b <argint>
801040c9:	83 c4 10             	add    $0x10,%esp
801040cc:	85 c0                	test   %eax,%eax
801040ce:	78 13                	js     801040e3 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
801040d0:	83 ec 08             	sub    $0x8,%esp
801040d3:	ff 75 0c             	pushl  0xc(%ebp)
801040d6:	ff 75 f4             	pushl  -0xc(%ebp)
801040d9:	e8 f9 fe ff ff       	call   80103fd7 <fetchstr>
...
801040e8:	eb f7                	jmp    801040e1 <argstr+0x2e>
...
801040f2:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801040f5:	e8 ec f1 ff ff       	call   801032e6 <myproc>
...
80104108:	77 17                	ja     80104121 <syscall+0x37>
8010410a:	8b 14 85 40 70 10 80 	mov    -0x7fef8fc0(,%eax,4),%edx
80104111:	85 d2                	test   %edx,%edx
80104113:	74 0c                	je     80104121 <syscall+0x37>
...
8010411f:	eb 1f                	jmp    80104140 <syscall+0x56>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80104121:	8d 53 74             	lea    0x74(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
80104124:	50                   	push   %eax
80104125:	52                   	push   %edx
80104126:	ff 73 10             	pushl  0x10(%ebx)
80104129:	68 1d 70 10 80       	push   $0x8010701d
8010412e:	e8 f6 c4 ff ff       	call   80100629 <cprintf>
    curproc->tf->eax = -1;
...
80104156:	e8 c0 fe ff ff       	call   8010401b <argint>
...
80104168:	e8 79 f1 ff ff       	call   801032e6 <myproc>
8010416d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104170:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
801041ac:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
801041ae:	e8 33 f1 ff ff       	call   801032e6 <myproc>
...
801041e1:	83 ec 10             	sub    $0x10,%esp
801041e4:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801041e6:	b8 20 00 00 00       	mov    $0x20,%eax
801041eb:	89 c6                	mov    %eax,%esi
801041ed:	39 43 58             	cmp    %eax,0x58(%ebx)
801041f0:	76 2e                	jbe    80104220 <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801041f2:	6a 10                	push   $0x10
801041f4:	50                   	push   %eax
801041f5:	8d 45 e8             	lea    -0x18(%ebp),%eax
801041f8:	50                   	push   %eax
801041f9:	53                   	push   %ebx
801041fa:	e8 ec d5 ff ff       	call   801017eb <readi>
801041ff:	83 c4 10             	add    $0x10,%esp
80104202:	83 f8 10             	cmp    $0x10,%eax
80104205:	75 0c                	jne    80104213 <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
80104207:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
8010420c:	75 1e                	jne    8010422c <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010420e:	8d 46 10             	lea    0x10(%esi),%eax
80104211:	eb d8                	jmp    801041eb <isdirempty+0xf>
      panic("isdirempty: readi");
80104213:	83 ec 0c             	sub    $0xc,%esp
80104216:	68 a0 70 10 80       	push   $0x801070a0
8010421b:	e8 3c c1 ff ff       	call   8010035c <panic>
      return 0;
  }
  return 1;
80104220:	b8 01 00 00 00       	mov    $0x1,%eax
}
...
80104231:	eb f2                	jmp    80104225 <isdirempty+0x49>
...
80104236:	57                   	push   %edi
80104237:	56                   	push   %esi
80104238:	53                   	push   %ebx
80104239:	83 ec 44             	sub    $0x44,%esp
8010423c:	89 55 c4             	mov    %edx,-0x3c(%ebp)
8010423f:	89 4d c0             	mov    %ecx,-0x40(%ebp)
80104242:	8b 7d 08             	mov    0x8(%ebp),%edi
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80104245:	8d 55 d6             	lea    -0x2a(%ebp),%edx
80104248:	52                   	push   %edx
80104249:	50                   	push   %eax
8010424a:	e8 37 da ff ff       	call   80101c86 <nameiparent>
8010424f:	89 c6                	mov    %eax,%esi
80104251:	83 c4 10             	add    $0x10,%esp
80104254:	85 c0                	test   %eax,%eax
80104256:	0f 84 35 01 00 00    	je     80104391 <create+0x15e>
    return 0;
  ilock(dp);
8010425c:	83 ec 0c             	sub    $0xc,%esp
8010425f:	50                   	push   %eax
80104260:	e8 80 d3 ff ff       	call   801015e5 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80104265:	83 c4 0c             	add    $0xc,%esp
80104268:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010426b:	50                   	push   %eax
8010426c:	8d 45 d6             	lea    -0x2a(%ebp),%eax
8010426f:	50                   	push   %eax
80104270:	56                   	push   %esi
80104271:	e8 be d7 ff ff       	call   80101a34 <dirlookup>
80104276:	89 c3                	mov    %eax,%ebx
80104278:	83 c4 10             	add    $0x10,%esp
8010427b:	85 c0                	test   %eax,%eax
8010427d:	74 3d                	je     801042bc <create+0x89>
    iunlockput(dp);
8010427f:	83 ec 0c             	sub    $0xc,%esp
80104282:	56                   	push   %esi
80104283:	e8 10 d5 ff ff       	call   80101798 <iunlockput>
    ilock(ip);
80104288:	89 1c 24             	mov    %ebx,(%esp)
8010428b:	e8 55 d3 ff ff       	call   801015e5 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104290:	83 c4 10             	add    $0x10,%esp
80104293:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104298:	75 07                	jne    801042a1 <create+0x6e>
8010429a:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
8010429f:	74 11                	je     801042b2 <create+0x7f>
      return ip;
    iunlockput(ip);
801042a1:	83 ec 0c             	sub    $0xc,%esp
801042a4:	53                   	push   %ebx
801042a5:	e8 ee d4 ff ff       	call   80101798 <iunlockput>
    return 0;
...
801042bf:	0f bf 45 c4          	movswl -0x3c(%ebp),%eax
801042c3:	50                   	push   %eax
801042c4:	ff 36                	pushl  (%esi)
801042c6:	e8 0b d1 ff ff       	call   801013d6 <ialloc>
801042cb:	89 c3                	mov    %eax,%ebx
801042cd:	83 c4 10             	add    $0x10,%esp
801042d0:	85 c0                	test   %eax,%eax
801042d2:	74 52                	je     80104326 <create+0xf3>
  ilock(ip);
801042d4:	83 ec 0c             	sub    $0xc,%esp
801042d7:	50                   	push   %eax
801042d8:	e8 08 d3 ff ff       	call   801015e5 <ilock>
  ip->major = major;
801042dd:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
801042e1:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
801042e5:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
801042e9:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
801042ef:	89 1c 24             	mov    %ebx,(%esp)
801042f2:	e8 85 d1 ff ff       	call   8010147c <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801042f7:	83 c4 10             	add    $0x10,%esp
801042fa:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
801042ff:	74 32                	je     80104333 <create+0x100>
  if(dirlink(dp, name, ip->inum) < 0)
80104301:	83 ec 04             	sub    $0x4,%esp
80104304:	ff 73 04             	pushl  0x4(%ebx)
80104307:	8d 45 d6             	lea    -0x2a(%ebp),%eax
8010430a:	50                   	push   %eax
8010430b:	56                   	push   %esi
8010430c:	e8 a4 d8 ff ff       	call   80101bb5 <dirlink>
80104311:	83 c4 10             	add    $0x10,%esp
80104314:	85 c0                	test   %eax,%eax
80104316:	78 6c                	js     80104384 <create+0x151>
  iunlockput(dp);
80104318:	83 ec 0c             	sub    $0xc,%esp
8010431b:	56                   	push   %esi
8010431c:	e8 77 d4 ff ff       	call   80101798 <iunlockput>
  return ip;
80104321:	83 c4 10             	add    $0x10,%esp
80104324:	eb 8c                	jmp    801042b2 <create+0x7f>
    panic("create: ialloc");
80104326:	83 ec 0c             	sub    $0xc,%esp
80104329:	68 b2 70 10 80       	push   $0x801070b2
8010432e:	e8 29 c0 ff ff       	call   8010035c <panic>
    dp->nlink++;  // for ".."
80104333:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104337:	83 c0 01             	add    $0x1,%eax
8010433a:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
8010433e:	83 ec 0c             	sub    $0xc,%esp
80104341:	56                   	push   %esi
80104342:	e8 35 d1 ff ff       	call   8010147c <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104347:	83 c4 0c             	add    $0xc,%esp
8010434a:	ff 73 04             	pushl  0x4(%ebx)
8010434d:	68 c2 70 10 80       	push   $0x801070c2
80104352:	53                   	push   %ebx
80104353:	e8 5d d8 ff ff       	call   80101bb5 <dirlink>
80104358:	83 c4 10             	add    $0x10,%esp
8010435b:	85 c0                	test   %eax,%eax
8010435d:	78 18                	js     80104377 <create+0x144>
8010435f:	83 ec 04             	sub    $0x4,%esp
80104362:	ff 76 04             	pushl  0x4(%esi)
80104365:	68 c1 70 10 80       	push   $0x801070c1
8010436a:	53                   	push   %ebx
8010436b:	e8 45 d8 ff ff       	call   80101bb5 <dirlink>
80104370:	83 c4 10             	add    $0x10,%esp
80104373:	85 c0                	test   %eax,%eax
80104375:	79 8a                	jns    80104301 <create+0xce>
      panic("create dots");
80104377:	83 ec 0c             	sub    $0xc,%esp
8010437a:	68 c4 70 10 80       	push   $0x801070c4
8010437f:	e8 d8 bf ff ff       	call   8010035c <panic>
    panic("create: dirlink");
80104384:	83 ec 0c             	sub    $0xc,%esp
80104387:	68 d0 70 10 80       	push   $0x801070d0
8010438c:	e8 cb bf ff ff       	call   8010035c <panic>
    return 0;
80104391:	89 c3                	mov    %eax,%ebx
80104393:	e9 1a ff ff ff       	jmp    801042b2 <create+0x7f>

80104398 <sys_dup>:
{
80104398:	f3 0f 1e fb          	endbr32 
8010439c:	55                   	push   %ebp
8010439d:	89 e5                	mov    %esp,%ebp
8010439f:	53                   	push   %ebx
801043a0:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
801043a3:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801043a6:	ba 00 00 00 00       	mov    $0x0,%edx
801043ab:	b8 00 00 00 00       	mov    $0x0,%eax
801043b0:	e8 90 fd ff ff       	call   80104145 <argfd>
801043b5:	85 c0                	test   %eax,%eax
801043b7:	78 23                	js     801043dc <sys_dup+0x44>
  if((fd=fdalloc(f)) < 0)
801043b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043bc:	e8 e4 fd ff ff       	call   801041a5 <fdalloc>
801043c1:	89 c3                	mov    %eax,%ebx
801043c3:	85 c0                	test   %eax,%eax
801043c5:	78 1c                	js     801043e3 <sys_dup+0x4b>
  filedup(f);
801043c7:	83 ec 0c             	sub    $0xc,%esp
801043ca:	ff 75 f4             	pushl  -0xc(%ebp)
801043cd:	e8 f7 c8 ff ff       	call   80100cc9 <filedup>
  return fd;
...
801043e1:	eb f2                	jmp    801043d5 <sys_dup+0x3d>
    return -1;
801043e3:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801043e8:	eb eb                	jmp    801043d5 <sys_dup+0x3d>

801043ea <sys_dup2>:
{
801043ea:	f3 0f 1e fb          	endbr32 
...
801043f5:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801043f8:	8d 55 ec             	lea    -0x14(%ebp),%edx
801043fb:	b8 00 00 00 00       	mov    $0x0,%eax
80104400:	e8 40 fd ff ff       	call   80104145 <argfd>
80104405:	85 c0                	test   %eax,%eax
80104407:	0f 88 86 00 00 00    	js     80104493 <sys_dup2+0xa9>
8010440d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80104411:	0f 88 83 00 00 00    	js     8010449a <sys_dup2+0xb0>
...
80104420:	e8 f6 fb ff ff       	call   8010401b <argint>
80104425:	83 c4 10             	add    $0x10,%esp
80104428:	85 c0                	test   %eax,%eax
8010442a:	78 75                	js     801044a1 <sys_dup2+0xb7>
8010442c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010442f:	85 c0                	test   %eax,%eax
80104431:	78 75                	js     801044a8 <sys_dup2+0xbe>
 if(fd_new == fd_old)
80104433:	3b 45 ec             	cmp    -0x14(%ebp),%eax
80104436:	74 56                	je     8010448e <sys_dup2+0xa4>
 if(myproc()->ofile[fd_new] != 0)
80104438:	e8 a9 ee ff ff       	call   801032e6 <myproc>
8010443d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104440:	83 7c 90 2c 00       	cmpl   $0x0,0x2c(%eax,%edx,4)
80104445:	74 28                	je     8010446f <sys_dup2+0x85>
  f_new = myproc()->ofile[fd_new];
80104447:	e8 9a ee ff ff       	call   801032e6 <myproc>
8010444c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010444f:	8b 5c 90 2c          	mov    0x2c(%eax,%edx,4),%ebx
  myproc()->ofile[fd_new] = 0;
80104453:	e8 8e ee ff ff       	call   801032e6 <myproc>
80104458:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010445b:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104462:	00 
  fileclose(f_new);
80104463:	83 ec 0c             	sub    $0xc,%esp
80104466:	53                   	push   %ebx
80104467:	e8 a6 c8 ff ff       	call   80100d12 <fileclose>
8010446c:	83 c4 10             	add    $0x10,%esp
 filedup(f_old);
8010446f:	83 ec 0c             	sub    $0xc,%esp
80104472:	ff 75 f4             	pushl  -0xc(%ebp)
80104475:	e8 4f c8 ff ff       	call   80100cc9 <filedup>
 myproc()->ofile[fd_new] = f_old;
8010447a:	e8 67 ee ff ff       	call   801032e6 <myproc>
8010447f:	89 c2                	mov    %eax,%edx
80104481:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104484:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80104487:	89 4c 82 2c          	mov    %ecx,0x2c(%edx,%eax,4)
 return fd_new;
...
80104498:	eb f4                	jmp    8010448e <sys_dup2+0xa4>
8010449a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010449f:	eb ed                	jmp    8010448e <sys_dup2+0xa4>
 	return -1;
801044a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801044a6:	eb e6                	jmp    8010448e <sys_dup2+0xa4>
801044a8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801044ad:	eb df                	jmp    8010448e <sys_dup2+0xa4>
...
801044f0:	e8 52 fb ff ff       	call   80104047 <argptr>
801044f5:	83 c4 10             	add    $0x10,%esp
801044f8:	85 c0                	test   %eax,%eax
801044fa:	78 16                	js     80104512 <sys_read+0x63>
...
80104508:	e8 0e c9 ff ff       	call   80100e1b <fileread>
...
80104517:	eb f7                	jmp    80104510 <sys_read+0x61>
...
80104520:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, (void**)&p, n) < 0)
80104523:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104526:	ba 00 00 00 00       	mov    $0x0,%edx
8010452b:	b8 00 00 00 00       	mov    $0x0,%eax
80104530:	e8 10 fc ff ff       	call   80104145 <argfd>
80104535:	85 c0                	test   %eax,%eax
80104537:	78 43                	js     8010457c <sys_write+0x63>
80104539:	83 ec 08             	sub    $0x8,%esp
8010453c:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010453f:	50                   	push   %eax
80104540:	6a 02                	push   $0x2
80104542:	e8 d4 fa ff ff       	call   8010401b <argint>
80104547:	83 c4 10             	add    $0x10,%esp
8010454a:	85 c0                	test   %eax,%eax
8010454c:	78 2e                	js     8010457c <sys_write+0x63>
8010454e:	83 ec 04             	sub    $0x4,%esp
80104551:	ff 75 f0             	pushl  -0x10(%ebp)
80104554:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104557:	50                   	push   %eax
80104558:	6a 01                	push   $0x1
8010455a:	e8 e8 fa ff ff       	call   80104047 <argptr>
8010455f:	83 c4 10             	add    $0x10,%esp
80104562:	85 c0                	test   %eax,%eax
80104564:	78 16                	js     8010457c <sys_write+0x63>
  return filewrite(f, p, n);
80104566:	83 ec 04             	sub    $0x4,%esp
80104569:	ff 75 f0             	pushl  -0x10(%ebp)
8010456c:	ff 75 ec             	pushl  -0x14(%ebp)
8010456f:	ff 75 f4             	pushl  -0xc(%ebp)
80104572:	e8 2d c9 ff ff       	call   80100ea4 <filewrite>
...
80104581:	eb f7                	jmp    8010457a <sys_write+0x61>
...
8010458a:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
8010458d:	8d 4d f0             	lea    -0x10(%ebp),%ecx
80104590:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104593:	b8 00 00 00 00       	mov    $0x0,%eax
80104598:	e8 a8 fb ff ff       	call   80104145 <argfd>
8010459d:	85 c0                	test   %eax,%eax
8010459f:	78 25                	js     801045c6 <sys_close+0x43>
  myproc()->ofile[fd] = 0;
801045a1:	e8 40 ed ff ff       	call   801032e6 <myproc>
801045a6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045a9:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
801045b0:	00 
  fileclose(f);
801045b1:	83 ec 0c             	sub    $0xc,%esp
801045b4:	ff 75 f0             	pushl  -0x10(%ebp)
801045b7:	e8 56 c7 ff ff       	call   80100d12 <fileclose>
  return 0;
...
801045cb:	eb f7                	jmp    801045c4 <sys_close+0x41>
...
801045d4:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
801045d7:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801045da:	ba 00 00 00 00       	mov    $0x0,%edx
801045df:	b8 00 00 00 00       	mov    $0x0,%eax
801045e4:	e8 5c fb ff ff       	call   80104145 <argfd>
801045e9:	85 c0                	test   %eax,%eax
801045eb:	78 2a                	js     80104617 <sys_fstat+0x4a>
801045ed:	83 ec 04             	sub    $0x4,%esp
801045f0:	6a 14                	push   $0x14
801045f2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801045f5:	50                   	push   %eax
801045f6:	6a 01                	push   $0x1
801045f8:	e8 4a fa ff ff       	call   80104047 <argptr>
801045fd:	83 c4 10             	add    $0x10,%esp
80104600:	85 c0                	test   %eax,%eax
80104602:	78 13                	js     80104617 <sys_fstat+0x4a>
  return filestat(f, st);
80104604:	83 ec 08             	sub    $0x8,%esp
80104607:	ff 75 f0             	pushl  -0x10(%ebp)
8010460a:	ff 75 f4             	pushl  -0xc(%ebp)
8010460d:	e8 be c7 ff ff       	call   80100dd0 <filestat>
...
8010461c:	eb f7                	jmp    80104615 <sys_fstat+0x48>

8010461e <sys_link>:
{
8010461e:	f3 0f 1e fb          	endbr32 
80104622:	55                   	push   %ebp
80104623:	89 e5                	mov    %esp,%ebp
80104625:	56                   	push   %esi
80104626:	53                   	push   %ebx
80104627:	83 ec 28             	sub    $0x28,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
8010462a:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010462d:	50                   	push   %eax
8010462e:	6a 00                	push   $0x0
80104630:	e8 7e fa ff ff       	call   801040b3 <argstr>
80104635:	83 c4 10             	add    $0x10,%esp
80104638:	85 c0                	test   %eax,%eax
8010463a:	0f 88 d3 00 00 00    	js     80104713 <sys_link+0xf5>
80104640:	83 ec 08             	sub    $0x8,%esp
80104643:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104646:	50                   	push   %eax
80104647:	6a 01                	push   $0x1
80104649:	e8 65 fa ff ff       	call   801040b3 <argstr>
8010464e:	83 c4 10             	add    $0x10,%esp
80104651:	85 c0                	test   %eax,%eax
80104653:	0f 88 ba 00 00 00    	js     80104713 <sys_link+0xf5>
  begin_op();
80104659:	e8 0c e2 ff ff       	call   8010286a <begin_op>
  if((ip = namei(old)) == 0){
8010465e:	83 ec 0c             	sub    $0xc,%esp
80104661:	ff 75 e0             	pushl  -0x20(%ebp)
80104664:	e8 01 d6 ff ff       	call   80101c6a <namei>
80104669:	89 c3                	mov    %eax,%ebx
8010466b:	83 c4 10             	add    $0x10,%esp
8010466e:	85 c0                	test   %eax,%eax
80104670:	0f 84 a4 00 00 00    	je     8010471a <sys_link+0xfc>
  ilock(ip);
80104676:	83 ec 0c             	sub    $0xc,%esp
80104679:	50                   	push   %eax
8010467a:	e8 66 cf ff ff       	call   801015e5 <ilock>
  if(ip->type == T_DIR){
8010467f:	83 c4 10             	add    $0x10,%esp
80104682:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104687:	0f 84 99 00 00 00    	je     80104726 <sys_link+0x108>
  ip->nlink++;
8010468d:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104691:	83 c0 01             	add    $0x1,%eax
80104694:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104698:	83 ec 0c             	sub    $0xc,%esp
8010469b:	53                   	push   %ebx
8010469c:	e8 db cd ff ff       	call   8010147c <iupdate>
  iunlock(ip);
801046a1:	89 1c 24             	mov    %ebx,(%esp)
801046a4:	e8 02 d0 ff ff       	call   801016ab <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801046a9:	83 c4 08             	add    $0x8,%esp
801046ac:	8d 45 ea             	lea    -0x16(%ebp),%eax
801046af:	50                   	push   %eax
801046b0:	ff 75 e4             	pushl  -0x1c(%ebp)
801046b3:	e8 ce d5 ff ff       	call   80101c86 <nameiparent>
801046b8:	89 c6                	mov    %eax,%esi
801046ba:	83 c4 10             	add    $0x10,%esp
801046bd:	85 c0                	test   %eax,%eax
801046bf:	0f 84 85 00 00 00    	je     8010474a <sys_link+0x12c>
  ilock(dp);
801046c5:	83 ec 0c             	sub    $0xc,%esp
801046c8:	50                   	push   %eax
801046c9:	e8 17 cf ff ff       	call   801015e5 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801046ce:	83 c4 10             	add    $0x10,%esp
801046d1:	8b 03                	mov    (%ebx),%eax
801046d3:	39 06                	cmp    %eax,(%esi)
801046d5:	75 67                	jne    8010473e <sys_link+0x120>
801046d7:	83 ec 04             	sub    $0x4,%esp
801046da:	ff 73 04             	pushl  0x4(%ebx)
801046dd:	8d 45 ea             	lea    -0x16(%ebp),%eax
801046e0:	50                   	push   %eax
801046e1:	56                   	push   %esi
801046e2:	e8 ce d4 ff ff       	call   80101bb5 <dirlink>
801046e7:	83 c4 10             	add    $0x10,%esp
801046ea:	85 c0                	test   %eax,%eax
801046ec:	78 50                	js     8010473e <sys_link+0x120>
  iunlockput(dp);
801046ee:	83 ec 0c             	sub    $0xc,%esp
801046f1:	56                   	push   %esi
801046f2:	e8 a1 d0 ff ff       	call   80101798 <iunlockput>
  iput(ip);
801046f7:	89 1c 24             	mov    %ebx,(%esp)
801046fa:	e8 f5 cf ff ff       	call   801016f4 <iput>
  end_op();
801046ff:	e8 e4 e1 ff ff       	call   801028e8 <end_op>
  return 0;
80104704:	83 c4 10             	add    $0x10,%esp
80104707:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010470c:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010470f:	5b                   	pop    %ebx
80104710:	5e                   	pop    %esi
80104711:	5d                   	pop    %ebp
80104712:	c3                   	ret    
...
80104718:	eb f2                	jmp    8010470c <sys_link+0xee>
    end_op();
8010471a:	e8 c9 e1 ff ff       	call   801028e8 <end_op>
    return -1;
8010471f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104724:	eb e6                	jmp    8010470c <sys_link+0xee>
    iunlockput(ip);
80104726:	83 ec 0c             	sub    $0xc,%esp
80104729:	53                   	push   %ebx
8010472a:	e8 69 d0 ff ff       	call   80101798 <iunlockput>
    end_op();
8010472f:	e8 b4 e1 ff ff       	call   801028e8 <end_op>
    return -1;
80104734:	83 c4 10             	add    $0x10,%esp
80104737:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010473c:	eb ce                	jmp    8010470c <sys_link+0xee>
    iunlockput(dp);
8010473e:	83 ec 0c             	sub    $0xc,%esp
80104741:	56                   	push   %esi
80104742:	e8 51 d0 ff ff       	call   80101798 <iunlockput>
    goto bad;
80104747:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
8010474a:	83 ec 0c             	sub    $0xc,%esp
8010474d:	53                   	push   %ebx
8010474e:	e8 92 ce ff ff       	call   801015e5 <ilock>
  ip->nlink--;
80104753:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104757:	83 e8 01             	sub    $0x1,%eax
8010475a:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
8010475e:	89 1c 24             	mov    %ebx,(%esp)
80104761:	e8 16 cd ff ff       	call   8010147c <iupdate>
  iunlockput(ip);
80104766:	89 1c 24             	mov    %ebx,(%esp)
80104769:	e8 2a d0 ff ff       	call   80101798 <iunlockput>
  end_op();
8010476e:	e8 75 e1 ff ff       	call   801028e8 <end_op>
  return -1;
80104773:	83 c4 10             	add    $0x10,%esp
80104776:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010477b:	eb 8f                	jmp    8010470c <sys_link+0xee>

8010477d <sys_unlink>:
{
8010477d:	f3 0f 1e fb          	endbr32 
80104781:	55                   	push   %ebp
80104782:	89 e5                	mov    %esp,%ebp
80104784:	57                   	push   %edi
80104785:	56                   	push   %esi
80104786:	53                   	push   %ebx
80104787:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
8010478a:	8d 45 c4             	lea    -0x3c(%ebp),%eax
8010478d:	50                   	push   %eax
8010478e:	6a 00                	push   $0x0
80104790:	e8 1e f9 ff ff       	call   801040b3 <argstr>
80104795:	83 c4 10             	add    $0x10,%esp
80104798:	85 c0                	test   %eax,%eax
8010479a:	0f 88 83 01 00 00    	js     80104923 <sys_unlink+0x1a6>
  begin_op();
801047a0:	e8 c5 e0 ff ff       	call   8010286a <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801047a5:	83 ec 08             	sub    $0x8,%esp
801047a8:	8d 45 ca             	lea    -0x36(%ebp),%eax
801047ab:	50                   	push   %eax
801047ac:	ff 75 c4             	pushl  -0x3c(%ebp)
801047af:	e8 d2 d4 ff ff       	call   80101c86 <nameiparent>
801047b4:	89 c6                	mov    %eax,%esi
801047b6:	83 c4 10             	add    $0x10,%esp
801047b9:	85 c0                	test   %eax,%eax
801047bb:	0f 84 ed 00 00 00    	je     801048ae <sys_unlink+0x131>
  ilock(dp);
801047c1:	83 ec 0c             	sub    $0xc,%esp
801047c4:	50                   	push   %eax
801047c5:	e8 1b ce ff ff       	call   801015e5 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801047ca:	83 c4 08             	add    $0x8,%esp
801047cd:	68 c2 70 10 80       	push   $0x801070c2
...
801047e0:	0f 84 fc 00 00 00    	je     801048e2 <sys_unlink+0x165>
801047e6:	83 ec 08             	sub    $0x8,%esp
801047e9:	68 c1 70 10 80       	push   $0x801070c1
801047ee:	8d 45 ca             	lea    -0x36(%ebp),%eax
801047f1:	50                   	push   %eax
801047f2:	e8 24 d2 ff ff       	call   80101a1b <namecmp>
801047f7:	83 c4 10             	add    $0x10,%esp
801047fa:	85 c0                	test   %eax,%eax
801047fc:	0f 84 e0 00 00 00    	je     801048e2 <sys_unlink+0x165>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104802:	83 ec 04             	sub    $0x4,%esp
80104805:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104808:	50                   	push   %eax
80104809:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010480c:	50                   	push   %eax
8010480d:	56                   	push   %esi
8010480e:	e8 21 d2 ff ff       	call   80101a34 <dirlookup>
80104813:	89 c3                	mov    %eax,%ebx
80104815:	83 c4 10             	add    $0x10,%esp
80104818:	85 c0                	test   %eax,%eax
8010481a:	0f 84 c2 00 00 00    	je     801048e2 <sys_unlink+0x165>
  ilock(ip);
80104820:	83 ec 0c             	sub    $0xc,%esp
80104823:	50                   	push   %eax
80104824:	e8 bc cd ff ff       	call   801015e5 <ilock>
  if(ip->nlink < 1)
80104829:	83 c4 10             	add    $0x10,%esp
8010482c:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104831:	0f 8e 83 00 00 00    	jle    801048ba <sys_unlink+0x13d>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104837:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010483c:	0f 84 85 00 00 00    	je     801048c7 <sys_unlink+0x14a>
  memset(&de, 0, sizeof(de));
80104842:	83 ec 04             	sub    $0x4,%esp
80104845:	6a 10                	push   $0x10
80104847:	6a 00                	push   $0x0
80104849:	8d 7d d8             	lea    -0x28(%ebp),%edi
8010484c:	57                   	push   %edi
8010484d:	e8 53 f5 ff ff       	call   80103da5 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104852:	6a 10                	push   $0x10
80104854:	ff 75 c0             	pushl  -0x40(%ebp)
80104857:	57                   	push   %edi
80104858:	56                   	push   %esi
80104859:	e8 8e d0 ff ff       	call   801018ec <writei>
8010485e:	83 c4 20             	add    $0x20,%esp
80104861:	83 f8 10             	cmp    $0x10,%eax
80104864:	0f 85 90 00 00 00    	jne    801048fa <sys_unlink+0x17d>
  if(ip->type == T_DIR){
8010486a:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010486f:	0f 84 92 00 00 00    	je     80104907 <sys_unlink+0x18a>
  iunlockput(dp);
80104875:	83 ec 0c             	sub    $0xc,%esp
80104878:	56                   	push   %esi
80104879:	e8 1a cf ff ff       	call   80101798 <iunlockput>
  ip->nlink--;
8010487e:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104882:	83 e8 01             	sub    $0x1,%eax
80104885:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104889:	89 1c 24             	mov    %ebx,(%esp)
8010488c:	e8 eb cb ff ff       	call   8010147c <iupdate>
  iunlockput(ip);
80104891:	89 1c 24             	mov    %ebx,(%esp)
80104894:	e8 ff ce ff ff       	call   80101798 <iunlockput>
  end_op();
80104899:	e8 4a e0 ff ff       	call   801028e8 <end_op>
  return 0;
8010489e:	83 c4 10             	add    $0x10,%esp
801048a1:	b8 00 00 00 00       	mov    $0x0,%eax
}
801048a6:	8d 65 f4             	lea    -0xc(%ebp),%esp
801048a9:	5b                   	pop    %ebx
801048aa:	5e                   	pop    %esi
801048ab:	5f                   	pop    %edi
801048ac:	5d                   	pop    %ebp
801048ad:	c3                   	ret    
    end_op();
801048ae:	e8 35 e0 ff ff       	call   801028e8 <end_op>
    return -1;
801048b3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801048b8:	eb ec                	jmp    801048a6 <sys_unlink+0x129>
    panic("unlink: nlink < 1");
801048ba:	83 ec 0c             	sub    $0xc,%esp
801048bd:	68 e0 70 10 80       	push   $0x801070e0
801048c2:	e8 95 ba ff ff       	call   8010035c <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801048c7:	89 d8                	mov    %ebx,%eax
801048c9:	e8 0e f9 ff ff       	call   801041dc <isdirempty>
801048ce:	85 c0                	test   %eax,%eax
801048d0:	0f 85 6c ff ff ff    	jne    80104842 <sys_unlink+0xc5>
    iunlockput(ip);
801048d6:	83 ec 0c             	sub    $0xc,%esp
801048d9:	53                   	push   %ebx
801048da:	e8 b9 ce ff ff       	call   80101798 <iunlockput>
    goto bad;
801048df:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
801048e2:	83 ec 0c             	sub    $0xc,%esp
801048e5:	56                   	push   %esi
801048e6:	e8 ad ce ff ff       	call   80101798 <iunlockput>
  end_op();
801048eb:	e8 f8 df ff ff       	call   801028e8 <end_op>
  return -1;
801048f0:	83 c4 10             	add    $0x10,%esp
801048f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801048f8:	eb ac                	jmp    801048a6 <sys_unlink+0x129>
    panic("unlink: writei");
801048fa:	83 ec 0c             	sub    $0xc,%esp
801048fd:	68 f2 70 10 80       	push   $0x801070f2
80104902:	e8 55 ba ff ff       	call   8010035c <panic>
    dp->nlink--;
80104907:	0f b7 46 56          	movzwl 0x56(%esi),%eax
8010490b:	83 e8 01             	sub    $0x1,%eax
8010490e:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104912:	83 ec 0c             	sub    $0xc,%esp
80104915:	56                   	push   %esi
80104916:	e8 61 cb ff ff       	call   8010147c <iupdate>
8010491b:	83 c4 10             	add    $0x10,%esp
8010491e:	e9 52 ff ff ff       	jmp    80104875 <sys_unlink+0xf8>
    return -1;
80104923:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104928:	e9 79 ff ff ff       	jmp    801048a6 <sys_unlink+0x129>
...
8010493a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010493d:	50                   	push   %eax
8010493e:	6a 00                	push   $0x0
80104940:	e8 6e f7 ff ff       	call   801040b3 <argstr>
80104945:	83 c4 10             	add    $0x10,%esp
80104948:	85 c0                	test   %eax,%eax
8010494a:	0f 88 a0 00 00 00    	js     801049f0 <sys_open+0xc3>
80104950:	83 ec 08             	sub    $0x8,%esp
80104953:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104956:	50                   	push   %eax
80104957:	6a 01                	push   $0x1
80104959:	e8 bd f6 ff ff       	call   8010401b <argint>
8010495e:	83 c4 10             	add    $0x10,%esp
80104961:	85 c0                	test   %eax,%eax
80104963:	0f 88 87 00 00 00    	js     801049f0 <sys_open+0xc3>
    return -1;

  begin_op();
80104969:	e8 fc de ff ff       	call   8010286a <begin_op>

  if(omode & O_CREATE){
8010496e:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
80104972:	0f 84 8b 00 00 00    	je     80104a03 <sys_open+0xd6>
    ip = create(path, T_FILE, 0, 0);
80104978:	83 ec 0c             	sub    $0xc,%esp
8010497b:	6a 00                	push   $0x0
8010497d:	b9 00 00 00 00       	mov    $0x0,%ecx
80104982:	ba 02 00 00 00       	mov    $0x2,%edx
80104987:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010498a:	e8 a4 f8 ff ff       	call   80104233 <create>
8010498f:	89 c6                	mov    %eax,%esi
    if(ip == 0){
80104991:	83 c4 10             	add    $0x10,%esp
80104994:	85 c0                	test   %eax,%eax
80104996:	74 5f                	je     801049f7 <sys_open+0xca>
      end_op();
      return -1;
    }
  }
...
80104998:	e8 c7 c2 ff ff       	call   80100c64 <filealloc>
8010499d:	89 c3                	mov    %eax,%ebx
8010499f:	85 c0                	test   %eax,%eax
801049a1:	0f 84 b5 00 00 00    	je     80104a5c <sys_open+0x12f>
801049a7:	e8 f9 f7 ff ff       	call   801041a5 <fdalloc>
801049ac:	89 c7                	mov    %eax,%edi
801049ae:	85 c0                	test   %eax,%eax
801049b0:	0f 88 a6 00 00 00    	js     80104a5c <sys_open+0x12f>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801049ba:	e8 ec cc ff ff       	call   801016ab <iunlock>
  end_op();
801049bf:	e8 24 df ff ff       	call   801028e8 <end_op>

  f->type = FD_INODE;
801049c4:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
801049ca:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
801049cd:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
801049d4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801049d7:	83 c4 10             	add    $0x10,%esp
801049da:	a8 01                	test   $0x1,%al
801049dc:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801049e0:	a8 03                	test   $0x3,%al
801049e2:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
801049e6:	89 f8                	mov    %edi,%eax
...
801049f5:	eb ef                	jmp    801049e6 <sys_open+0xb9>
      end_op();
801049f7:	e8 ec de ff ff       	call   801028e8 <end_op>
      return -1;
801049fc:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104a01:	eb e3                	jmp    801049e6 <sys_open+0xb9>
    if((ip = namei(path)) == 0){
80104a03:	83 ec 0c             	sub    $0xc,%esp
80104a06:	ff 75 e4             	pushl  -0x1c(%ebp)
80104a09:	e8 5c d2 ff ff       	call   80101c6a <namei>
80104a0e:	89 c6                	mov    %eax,%esi
80104a10:	83 c4 10             	add    $0x10,%esp
80104a13:	85 c0                	test   %eax,%eax
80104a15:	74 39                	je     80104a50 <sys_open+0x123>
    ilock(ip);
80104a17:	83 ec 0c             	sub    $0xc,%esp
80104a1a:	50                   	push   %eax
80104a1b:	e8 c5 cb ff ff       	call   801015e5 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104a20:	83 c4 10             	add    $0x10,%esp
80104a23:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104a28:	0f 85 6a ff ff ff    	jne    80104998 <sys_open+0x6b>
80104a2e:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104a32:	0f 84 60 ff ff ff    	je     80104998 <sys_open+0x6b>
      iunlockput(ip);
80104a38:	83 ec 0c             	sub    $0xc,%esp
80104a3b:	56                   	push   %esi
80104a3c:	e8 57 cd ff ff       	call   80101798 <iunlockput>
      end_op();
80104a41:	e8 a2 de ff ff       	call   801028e8 <end_op>
      return -1;
80104a46:	83 c4 10             	add    $0x10,%esp
80104a49:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104a4e:	eb 96                	jmp    801049e6 <sys_open+0xb9>
      end_op();
80104a50:	e8 93 de ff ff       	call   801028e8 <end_op>
      return -1;
80104a55:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104a5a:	eb 8a                	jmp    801049e6 <sys_open+0xb9>
    if(f)
80104a5c:	85 db                	test   %ebx,%ebx
80104a5e:	74 0c                	je     80104a6c <sys_open+0x13f>
      fileclose(f);
80104a60:	83 ec 0c             	sub    $0xc,%esp
80104a63:	53                   	push   %ebx
80104a64:	e8 a9 c2 ff ff       	call   80100d12 <fileclose>
80104a69:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80104a6c:	83 ec 0c             	sub    $0xc,%esp
80104a6f:	56                   	push   %esi
80104a70:	e8 23 cd ff ff       	call   80101798 <iunlockput>
    end_op();
80104a75:	e8 6e de ff ff       	call   801028e8 <end_op>
    return -1;
80104a7a:	83 c4 10             	add    $0x10,%esp
80104a7d:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104a82:	e9 5f ff ff ff       	jmp    801049e6 <sys_open+0xb9>
...
80104aeb:	eb f2                	jmp    80104adf <sys_mkdir+0x58>
...
80104b5f:	e8 34 cc ff ff       	call   80101798 <iunlockput>
  end_op();
80104b64:	e8 7f dd ff ff       	call   801028e8 <end_op>
  return 0;
...
80104b72:	c3                   	ret    
    end_op();
80104b73:	e8 70 dd ff ff       	call   801028e8 <end_op>
    return -1;
80104b78:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b7d:	eb f2                	jmp    80104b71 <sys_mknod+0x84>
...
80104bc4:	e8 1c ca ff ff       	call   801015e5 <ilock>
  if(ip->type != T_DIR){
80104bc9:	83 c4 10             	add    $0x10,%esp
80104bcc:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104bd1:	75 37                	jne    80104c0a <sys_chdir+0x8b>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80104bd7:	e8 cf ca ff ff       	call   801016ab <iunlock>
  iput(curproc->cwd);
80104bdc:	83 c4 04             	add    $0x4,%esp
80104bdf:	ff 76 6c             	pushl  0x6c(%esi)
80104be2:	e8 0d cb ff ff       	call   801016f4 <iput>
  end_op();
80104be7:	e8 fc dc ff ff       	call   801028e8 <end_op>
  curproc->cwd = ip;
80104bec:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
...
80104bfd:	c3                   	ret    
    end_op();
80104bfe:	e8 e5 dc ff ff       	call   801028e8 <end_op>
    return -1;
80104c03:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c08:	eb ed                	jmp    80104bf7 <sys_chdir+0x78>
    iunlockput(ip);
80104c0a:	83 ec 0c             	sub    $0xc,%esp
80104c0d:	53                   	push   %ebx
80104c0e:	e8 85 cb ff ff       	call   80101798 <iunlockput>
    end_op();
80104c13:	e8 d0 dc ff ff       	call   801028e8 <end_op>
    return -1;
80104c18:	83 c4 10             	add    $0x10,%esp
80104c1b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c20:	eb d5                	jmp    80104bf7 <sys_chdir+0x78>
...
sys_exec(void)
{
80104c22:	f3 0f 1e fb          	endbr32 
80104c26:	55                   	push   %ebp
80104c27:	89 e5                	mov    %esp,%ebp
80104c29:	53                   	push   %ebx
80104c2a:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
...
80104c36:	e8 78 f4 ff ff       	call   801040b3 <argstr>
80104c3b:	83 c4 10             	add    $0x10,%esp
80104c3e:	85 c0                	test   %eax,%eax
80104c40:	78 38                	js     80104c7a <sys_exec+0x58>
80104c42:	83 ec 08             	sub    $0x8,%esp
80104c45:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104c4b:	50                   	push   %eax
80104c4c:	6a 01                	push   $0x1
80104c4e:	e8 c8 f3 ff ff       	call   8010401b <argint>
80104c53:	83 c4 10             	add    $0x10,%esp
80104c56:	85 c0                	test   %eax,%eax
80104c58:	78 20                	js     80104c7a <sys_exec+0x58>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104c5a:	83 ec 04             	sub    $0x4,%esp
80104c5d:	68 80 00 00 00       	push   $0x80
80104c62:	6a 00                	push   $0x0
80104c64:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104c6a:	50                   	push   %eax
80104c6b:	e8 35 f1 ff ff       	call   80103da5 <memset>
80104c70:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104c73:	bb 00 00 00 00       	mov    $0x0,%ebx
80104c78:	eb 2c                	jmp    80104ca6 <sys_exec+0x84>
    return -1;
80104c7a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c7f:	eb 78                	jmp    80104cf9 <sys_exec+0xd7>
    if(i >= NELEM(argv))
      return -1;
    ...
    if(uarg == 0){
      argv[i] = 0;
80104c81:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104c88:	00 00 00 00 
      break;
    }
...
80104c8f:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104c95:	50                   	push   %eax
80104c96:	ff 75 f4             	pushl  -0xc(%ebp)
80104c99:	e8 5e bc ff ff       	call   801008fc <exec>
80104c9e:	83 c4 10             	add    $0x10,%esp
80104ca1:	eb 56                	jmp    80104cf9 <sys_exec+0xd7>
  for(i=0;; i++){
80104ca3:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104ca6:	83 fb 1f             	cmp    $0x1f,%ebx
80104ca9:	77 49                	ja     80104cf4 <sys_exec+0xd2>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104cab:	83 ec 08             	sub    $0x8,%esp
80104cae:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104cb4:	50                   	push   %eax
80104cb5:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104cbb:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104cbe:	50                   	push   %eax
80104cbf:	e8 d3 f2 ff ff       	call   80103f97 <fetchint>
80104cc4:	83 c4 10             	add    $0x10,%esp
80104cc7:	85 c0                	test   %eax,%eax
80104cc9:	78 33                	js     80104cfe <sys_exec+0xdc>
    if(uarg == 0){
80104ccb:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104cd1:	85 c0                	test   %eax,%eax
80104cd3:	74 ac                	je     80104c81 <sys_exec+0x5f>
    if(fetchstr(uarg, &argv[i]) < 0)
80104cd5:	83 ec 08             	sub    $0x8,%esp
80104cd8:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104cdf:	52                   	push   %edx
80104ce0:	50                   	push   %eax
80104ce1:	e8 f1 f2 ff ff       	call   80103fd7 <fetchstr>
80104ce6:	83 c4 10             	add    $0x10,%esp
80104ce9:	85 c0                	test   %eax,%eax
80104ceb:	79 b6                	jns    80104ca3 <sys_exec+0x81>
      return -1;
80104ced:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cf2:	eb 05                	jmp    80104cf9 <sys_exec+0xd7>
      return -1;
...
80104d03:	eb f4                	jmp    80104cf9 <sys_exec+0xd7>
...
80104d18:	e8 2a f3 ff ff       	call   80104047 <argptr>
80104d1d:	83 c4 10             	add    $0x10,%esp
80104d20:	85 c0                	test   %eax,%eax
80104d22:	78 79                	js     80104d9d <sys_pipe+0x98>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80104d24:	83 ec 08             	sub    $0x8,%esp
80104d27:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104d2a:	50                   	push   %eax
80104d2b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d2e:	50                   	push   %eax
80104d2f:	e8 db e0 ff ff       	call   80102e0f <pipealloc>
80104d34:	83 c4 10             	add    $0x10,%esp
80104d37:	85 c0                	test   %eax,%eax
80104d39:	78 69                	js     80104da4 <sys_pipe+0x9f>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104d3b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d3e:	e8 62 f4 ff ff       	call   801041a5 <fdalloc>
80104d43:	89 c3                	mov    %eax,%ebx
80104d45:	85 c0                	test   %eax,%eax
80104d47:	78 21                	js     80104d6a <sys_pipe+0x65>
80104d49:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104d4c:	e8 54 f4 ff ff       	call   801041a5 <fdalloc>
80104d51:	85 c0                	test   %eax,%eax
80104d53:	78 15                	js     80104d6a <sys_pipe+0x65>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80104d58:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
80104d5a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104d5d:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
80104d60:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80104d6c:	79 20                	jns    80104d8e <sys_pipe+0x89>
    fileclose(rf);
80104d6e:	83 ec 0c             	sub    $0xc,%esp
80104d71:	ff 75 f0             	pushl  -0x10(%ebp)
80104d74:	e8 99 bf ff ff       	call   80100d12 <fileclose>
    fileclose(wf);
80104d79:	83 c4 04             	add    $0x4,%esp
80104d7c:	ff 75 ec             	pushl  -0x14(%ebp)
80104d7f:	e8 8e bf ff ff       	call   80100d12 <fileclose>
    return -1;
80104d84:	83 c4 10             	add    $0x10,%esp
80104d87:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d8c:	eb d7                	jmp    80104d65 <sys_pipe+0x60>
      myproc()->ofile[fd0] = 0;
80104d8e:	e8 53 e5 ff ff       	call   801032e6 <myproc>
80104d93:	c7 44 98 2c 00 00 00 	movl   $0x0,0x2c(%eax,%ebx,4)
80104d9a:	00 
80104d9b:	eb d1                	jmp    80104d6e <sys_pipe+0x69>
    return -1;
80104d9d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104da2:	eb c1                	jmp    80104d65 <sys_pipe+0x60>
    return -1;
80104da4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104da9:	eb ba                	jmp    80104d65 <sys_pipe+0x60>
...
80104dea:	eb f7                	jmp    80104de3 <sys_date+0x38>
...
sys_fork(void)
{
80104dec:	f3 0f 1e fb          	endbr32 
80104df0:	55                   	push   %ebp
80104df1:	89 e5                	mov    %esp,%ebp
80104df3:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104df6:	e8 6d e6 ff ff       	call   80103468 <fork>
}
80104dfb:	c9                   	leave  
80104dfc:	c3                   	ret    
...
80104e47:	eb f7                	jmp    80104e40 <sys_exit+0x43>
...
80104e7c:	eb f7                	jmp    80104e75 <sys_wait+0x2c>
...
sys_kill(void)
{
80104e7e:	f3 0f 1e fb          	endbr32 
80104e82:	55                   	push   %ebp
80104e83:	89 e5                	mov    %esp,%ebp
80104e85:	83 ec 20             	sub    $0x20,%esp
  int pid;

  if(argint(0, &pid) < 0)
80104e88:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104e8b:	50                   	push   %eax
80104e8c:	6a 00                	push   $0x0
80104e8e:	e8 88 f1 ff ff       	call   8010401b <argint>
80104e93:	83 c4 10             	add    $0x10,%esp
80104e96:	85 c0                	test   %eax,%eax
80104e98:	78 10                	js     80104eaa <sys_kill+0x2c>
    return -1;
  return kill(pid);
80104e9a:	83 ec 0c             	sub    $0xc,%esp
80104e9d:	ff 75 f4             	pushl  -0xc(%ebp)
80104ea0:	e8 ae ea ff ff       	call   80103953 <kill>
...
80104eaf:	eb f7                	jmp    80104ea8 <sys_kill+0x2a>
...
80104eb8:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104ebb:	e8 26 e4 ff ff       	call   801032e6 <myproc>
80104ec0:	8b 40 10             	mov    0x10(%eax),%eax
}
80104ec3:	c9                   	leave  
80104ec4:	c3                   	ret    
...
80104ecd:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  int n;
...
80104ed6:	e8 40 f1 ff ff       	call   8010401b <argint>
80104edb:	83 c4 10             	add    $0x10,%esp
80104ede:	85 c0                	test   %eax,%eax
80104ee0:	78 36                	js     80104f18 <sys_sbrk+0x53>
...
80104f05:	e8 f0 e4 ff ff       	call   801033fa <growproc>
80104f0a:	83 c4 10             	add    $0x10,%esp
80104f0d:	85 c0                	test   %eax,%eax
80104f0f:	79 e9                	jns    80104efa <sys_sbrk+0x35>
    return -1;  // no hacemos nada y devolvemos codigo de error
80104f11:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104f16:	eb e2                	jmp    80104efa <sys_sbrk+0x35>
    return -1;  // no hacemos nada y devolvemos codigo de error
80104f18:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104f1d:	eb db                	jmp    80104efa <sys_sbrk+0x35>
...
80104f27:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if(argint(0, &n) < 0)
80104f2a:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104f2d:	50                   	push   %eax
80104f2e:	6a 00                	push   $0x0
80104f30:	e8 e6 f0 ff ff       	call   8010401b <argint>
80104f35:	83 c4 10             	add    $0x10,%esp
80104f38:	85 c0                	test   %eax,%eax
80104f3a:	78 75                	js     80104fb1 <sys_sleep+0x92>
    return -1;
  acquire(&tickslock);
80104f3c:	83 ec 0c             	sub    $0xc,%esp
80104f3f:	68 60 4e 11 80       	push   $0x80114e60
80104f44:	e8 a8 ed ff ff       	call   80103cf1 <acquire>
  ticks0 = ticks;
80104f49:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
80104f4f:	83 c4 10             	add    $0x10,%esp
80104f52:	a1 a0 56 11 80       	mov    0x801156a0,%eax
80104f57:	29 d8                	sub    %ebx,%eax
80104f59:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104f5c:	73 39                	jae    80104f97 <sys_sleep+0x78>
    if(myproc()->killed){
80104f5e:	e8 83 e3 ff ff       	call   801032e6 <myproc>
80104f63:	83 78 28 00          	cmpl   $0x0,0x28(%eax)
80104f67:	75 17                	jne    80104f80 <sys_sleep+0x61>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104f69:	83 ec 08             	sub    $0x8,%esp
80104f6c:	68 60 4e 11 80       	push   $0x80114e60
80104f71:	68 a0 56 11 80       	push   $0x801156a0
80104f76:	e8 33 e8 ff ff       	call   801037ae <sleep>
80104f7b:	83 c4 10             	add    $0x10,%esp
80104f7e:	eb d2                	jmp    80104f52 <sys_sleep+0x33>
      release(&tickslock);
80104f80:	83 ec 0c             	sub    $0xc,%esp
80104f83:	68 60 4e 11 80       	push   $0x80114e60
80104f88:	e8 cd ed ff ff       	call   80103d5a <release>
      return -1;
80104f8d:	83 c4 10             	add    $0x10,%esp
80104f90:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f95:	eb 15                	jmp    80104fac <sys_sleep+0x8d>
  }
  release(&tickslock);
80104f97:	83 ec 0c             	sub    $0xc,%esp
80104f9a:	68 60 4e 11 80       	push   $0x80114e60
80104f9f:	e8 b6 ed ff ff       	call   80103d5a <release>
  return 0;
...
80104fb6:	eb f4                	jmp    80104fac <sys_sleep+0x8d>
...
80104fc0:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104fc3:	68 60 4e 11 80       	push   $0x80114e60
80104fc8:	e8 24 ed ff ff       	call   80103cf1 <acquire>
  xticks = ticks;
80104fcd:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
80104fd3:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80104fda:	e8 7b ed ff ff       	call   80103d5a <release>
  return xticks;
}
...
80104fe7:	06                   	push   %es
  pushl %fs
80104fe8:	0f a0                	push   %fs
  pushl %gs
80104fea:	0f a8                	push   %gs
  pushal
80104fec:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104fed:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104ff1:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104ff3:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104ff5:	54                   	push   %esp
  call trap
80104ff6:	e8 eb 00 00 00       	call   801050e6 <trap>
  addl $4, %esp
80104ffb:	83 c4 04             	add    $0x4,%esp
...
80104ffe:	61                   	popa   
  popl %gs
80104fff:	0f a9                	pop    %gs
  popl %fs
80105001:	0f a1                	pop    %fs
  popl %es
80105003:	07                   	pop    %es
  popl %ds
80105004:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105005:	83 c4 08             	add    $0x8,%esp
  iret
80105008:	cf                   	iret   
...
80105010:	83 ec 08             	sub    $0x8,%esp
  ...
  for(i = 0; i < 256; i++)
80105013:	b8 00 00 00 00       	mov    $0x0,%eax
80105018:	3d ff 00 00 00       	cmp    $0xff,%eax
8010501d:	7f 4c                	jg     8010506b <tvinit+0x62>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010501f:	8b 0c 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%ecx
80105026:	66 89 0c c5 a0 4e 11 	mov    %cx,-0x7feeb160(,%eax,8)
8010502d:	80 
8010502e:	66 c7 04 c5 a2 4e 11 	movw   $0x8,-0x7feeb15e(,%eax,8)
80105035:	80 08 00 
80105038:	c6 04 c5 a4 4e 11 80 	movb   $0x0,-0x7feeb15c(,%eax,8)
8010503f:	00 
80105040:	0f b6 14 c5 a5 4e 11 	movzbl -0x7feeb15b(,%eax,8),%edx
80105047:	80 
80105048:	83 e2 f0             	and    $0xfffffff0,%edx
8010504b:	83 ca 0e             	or     $0xe,%edx
8010504e:	83 e2 8f             	and    $0xffffff8f,%edx
80105051:	83 ca 80             	or     $0xffffff80,%edx
80105054:	88 14 c5 a5 4e 11 80 	mov    %dl,-0x7feeb15b(,%eax,8)
8010505b:	c1 e9 10             	shr    $0x10,%ecx
8010505e:	66 89 0c c5 a6 4e 11 	mov    %cx,-0x7feeb15a(,%eax,8)
80105065:	80 
  for(i = 0; i < 256; i++)
80105066:	83 c0 01             	add    $0x1,%eax
80105069:	eb ad                	jmp    80105018 <tvinit+0xf>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010506b:	8b 15 08 a1 10 80    	mov    0x8010a108,%edx
80105071:	66 89 15 a0 50 11 80 	mov    %dx,0x801150a0
80105078:	66 c7 05 a2 50 11 80 	movw   $0x8,0x801150a2
8010507f:	08 00 
80105081:	c6 05 a4 50 11 80 00 	movb   $0x0,0x801150a4
80105088:	0f b6 05 a5 50 11 80 	movzbl 0x801150a5,%eax
8010508f:	83 c8 0f             	or     $0xf,%eax
80105092:	83 e0 ef             	and    $0xffffffef,%eax
80105095:	83 c8 e0             	or     $0xffffffe0,%eax
80105098:	a2 a5 50 11 80       	mov    %al,0x801150a5
8010509d:	c1 ea 10             	shr    $0x10,%edx
801050a0:	66 89 15 a6 50 11 80 	mov    %dx,0x801150a6

  initlock(&tickslock, "time");
801050a7:	83 ec 08             	sub    $0x8,%esp
801050aa:	68 01 71 10 80       	push   $0x80107101
801050af:	68 60 4e 11 80       	push   $0x80114e60
801050b4:	e8 e8 ea ff ff       	call   80103ba1 <initlock>
}
...
idtinit(void)
{
801050be:	f3 0f 1e fb          	endbr32 
801050c2:	55                   	push   %ebp
801050c3:	89 e5                	mov    %esp,%ebp
801050c5:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
801050c8:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
801050ce:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
801050d3:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801050d7:	c1 e8 10             	shr    $0x10,%eax
801050da:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
801050de:	8d 45 fa             	lea    -0x6(%ebp),%eax
801050e1:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
801050e4:	c9                   	leave  
801050e5:	c3                   	ret    
...
801050fc:	74 14                	je     80105112 <trap+0x2c>
    if(myproc()->killed)
      exit(tf->trapno++);
    return;
  }
  // Interrupciones HW
  switch(tf->trapno){
801050fe:	83 e8 0e             	sub    $0xe,%eax
80105101:	83 f8 31             	cmp    $0x31,%eax
80105104:	0f 87 24 03 00 00    	ja     8010542e <trap+0x348>
8010510a:	3e ff 24 85 a8 72 10 	notrack jmp *-0x7fef8d58(,%eax,4)
80105111:	80 
    if(myproc()->killed)
80105112:	e8 cf e1 ff ff       	call   801032e6 <myproc>
80105117:	83 78 28 00          	cmpl   $0x0,0x28(%eax)
8010511b:	75 36                	jne    80105153 <trap+0x6d>
    myproc()->tf = tf;
8010511d:	e8 c4 e1 ff ff       	call   801032e6 <myproc>
80105122:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105125:	e8 c0 ef ff ff       	call   801040ea <syscall>
    if(myproc()->killed)
8010512a:	e8 b7 e1 ff ff       	call   801032e6 <myproc>
8010512f:	83 78 28 00          	cmpl   $0x0,0x28(%eax)
80105133:	0f 84 a1 00 00 00    	je     801051da <trap+0xf4>
      exit(tf->trapno++);
80105139:	8b 43 30             	mov    0x30(%ebx),%eax
8010513c:	8d 50 01             	lea    0x1(%eax),%edx
8010513f:	89 53 30             	mov    %edx,0x30(%ebx)
80105142:	83 ec 0c             	sub    $0xc,%esp
80105145:	50                   	push   %eax
80105146:	e8 60 e5 ff ff       	call   801036ab <exit>
8010514b:	83 c4 10             	add    $0x10,%esp
    return;
8010514e:	e9 87 00 00 00       	jmp    801051da <trap+0xf4>
      exit(tf->trapno++);
80105153:	8b 43 30             	mov    0x30(%ebx),%eax
80105156:	8d 50 01             	lea    0x1(%eax),%edx
80105159:	89 53 30             	mov    %edx,0x30(%ebx)
8010515c:	83 ec 0c             	sub    $0xc,%esp
8010515f:	50                   	push   %eax
80105160:	e8 46 e5 ff ff       	call   801036ab <exit>
80105165:	83 c4 10             	add    $0x10,%esp
80105168:	eb b3                	jmp    8010511d <trap+0x37>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
8010516a:	e8 58 e1 ff ff       	call   801032c7 <cpuid>
8010516f:	85 c0                	test   %eax,%eax
80105171:	74 6f                	je     801051e2 <trap+0xfc>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80105173:	e8 d6 d2 ff ff       	call   8010244e <lapiceoi>
      break;
  }
...
80105178:	e8 69 e1 ff ff       	call   801032e6 <myproc>
8010517d:	85 c0                	test   %eax,%eax
8010517f:	74 1c                	je     8010519d <trap+0xb7>
80105181:	e8 60 e1 ff ff       	call   801032e6 <myproc>
80105186:	83 78 28 00          	cmpl   $0x0,0x28(%eax)
8010518a:	74 11                	je     8010519d <trap+0xb7>
8010518c:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105190:	83 e0 03             	and    $0x3,%eax
80105193:	66 83 f8 03          	cmp    $0x3,%ax
80105197:	0f 84 24 03 00 00    	je     801054c1 <trap+0x3db>
    exit(tf->trapno++);

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
8010519d:	e8 44 e1 ff ff       	call   801032e6 <myproc>
801051a2:	85 c0                	test   %eax,%eax
801051a4:	74 0f                	je     801051b5 <trap+0xcf>
801051a6:	e8 3b e1 ff ff       	call   801032e6 <myproc>
801051ab:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801051af:	0f 84 26 03 00 00    	je     801054db <trap+0x3f5>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801051b5:	e8 2c e1 ff ff       	call   801032e6 <myproc>
801051ba:	85 c0                	test   %eax,%eax
801051bc:	74 1c                	je     801051da <trap+0xf4>
801051be:	e8 23 e1 ff ff       	call   801032e6 <myproc>
801051c3:	83 78 28 00          	cmpl   $0x0,0x28(%eax)
801051c7:	74 11                	je     801051da <trap+0xf4>
801051c9:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801051cd:	83 e0 03             	and    $0x3,%eax
801051d0:	66 83 f8 03          	cmp    $0x3,%ax
801051d4:	0f 84 15 03 00 00    	je     801054ef <trap+0x409>
    exit(tf->trapno++);
...
801051e5:	68 60 4e 11 80       	push   $0x80114e60
801051ea:	e8 02 eb ff ff       	call   80103cf1 <acquire>
      ticks++;
801051ef:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
801051f6:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
801051fd:	e8 24 e7 ff ff       	call   80103926 <wakeup>
      release(&tickslock);
80105202:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105209:	e8 4c eb ff ff       	call   80103d5a <release>
8010520e:	83 c4 10             	add    $0x10,%esp
80105211:	e9 5d ff ff ff       	jmp    80105173 <trap+0x8d>
    ideintr();
80105216:	e8 ec cb ff ff       	call   80101e07 <ideintr>
    lapiceoi();
8010521b:	e8 2e d2 ff ff       	call   8010244e <lapiceoi>
    break;
80105220:	e9 53 ff ff ff       	jmp    80105178 <trap+0x92>
    kbdintr();
80105225:	e8 61 d0 ff ff       	call   8010228b <kbdintr>
    lapiceoi();
8010522a:	e8 1f d2 ff ff       	call   8010244e <lapiceoi>
    break;
8010522f:	e9 44 ff ff ff       	jmp    80105178 <trap+0x92>
    uartintr();
80105234:	e8 ec 03 00 00       	call   80105625 <uartintr>
    lapiceoi();
80105239:	e8 10 d2 ff ff       	call   8010244e <lapiceoi>
    break;
8010523e:	e9 35 ff ff ff       	jmp    80105178 <trap+0x92>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105243:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80105246:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010524a:	e8 78 e0 ff ff       	call   801032c7 <cpuid>
8010524f:	57                   	push   %edi
80105250:	0f b7 f6             	movzwl %si,%esi
80105253:	56                   	push   %esi
80105254:	50                   	push   %eax
80105255:	68 60 71 10 80       	push   $0x80107160
8010525a:	e8 ca b3 ff ff       	call   80100629 <cprintf>
    lapiceoi();
8010525f:	e8 ea d1 ff ff       	call   8010244e <lapiceoi>
    break;
80105264:	83 c4 10             	add    $0x10,%esp
80105267:	e9 0c ff ff ff       	jmp    80105178 <trap+0x92>
  asm volatile("movl %%cr2,%0" : "=r" (val));
8010526c:	0f 20 d0             	mov    %cr2,%eax
    if(rcr2() >= KERNBASE) {
8010526f:	85 c0                	test   %eax,%eax
80105271:	0f 88 dc 00 00 00    	js     80105353 <trap+0x26d>
80105277:	0f 20 d6             	mov    %cr2,%esi
    } else if(rcr2() > myproc()->sz){
8010527a:	e8 67 e0 ff ff       	call   801032e6 <myproc>
8010527f:	39 30                	cmp    %esi,(%eax)
80105281:	0f 82 ed 00 00 00    	jb     80105374 <trap+0x28e>
80105287:	0f 20 d2             	mov    %cr2,%edx
    }else if((PGROUNDDOWN(rcr2()) >= tf->esp-PGSIZE*2 && PGROUNDDOWN(rcr2()) <= tf->esp-PGSIZE)){
8010528a:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80105290:	8b 43 44             	mov    0x44(%ebx),%eax
80105293:	8d 88 00 e0 ff ff    	lea    -0x2000(%eax),%ecx
80105299:	39 ca                	cmp    %ecx,%edx
8010529b:	72 16                	jb     801052b3 <trap+0x1cd>
8010529d:	0f 20 d2             	mov    %cr2,%edx
801052a0:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
801052a6:	2d 00 10 00 00       	sub    $0x1000,%eax
801052ab:	39 c2                	cmp    %eax,%edx
801052ad:	0f 86 e2 00 00 00    	jbe    80105395 <trap+0x2af>
      cprintf("Proceso ha reservado memoria\n");
801052b3:	83 ec 0c             	sub    $0xc,%esp
801052b6:	68 06 71 10 80       	push   $0x80107106
801052bb:	e8 69 b3 ff ff       	call   80100629 <cprintf>
      char * mem = kalloc(); // reservamos memoria
801052c0:	e8 a8 ce ff ff       	call   8010216d <kalloc>
801052c5:	89 c6                	mov    %eax,%esi
      if(mem == 0){   // si no se ha podido reservar
801052c7:	83 c4 10             	add    $0x10,%esp
801052ca:	85 c0                	test   %eax,%eax
801052cc:	0f 84 e4 00 00 00    	je     801053b6 <trap+0x2d0>
801052d2:	0f 20 d7             	mov    %cr2,%edi
...
801052d5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
801052db:	e8 06 e0 ff ff       	call   801032e6 <myproc>
801052e0:	83 ec 0c             	sub    $0xc,%esp
801052e3:	6a 06                	push   $0x6
801052e5:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
801052eb:	52                   	push   %edx
801052ec:	68 00 10 00 00       	push   $0x1000
801052f1:	57                   	push   %edi
801052f2:	ff 70 04             	pushl  0x4(%eax)
801052f5:	e8 77 0f 00 00       	call   80106271 <mappages>
801052fa:	83 c4 20             	add    $0x20,%esp
801052fd:	83 f8 ff             	cmp    $0xffffffff,%eax
80105300:	0f 84 d9 00 00 00    	je     801053df <trap+0x2f9>
80105306:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105309:	8b 43 38             	mov    0x38(%ebx),%eax
8010530c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010530f:	e8 b3 df ff ff       	call   801032c7 <cpuid>
80105314:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105317:	8b 4b 34             	mov    0x34(%ebx),%ecx
8010531a:	89 4d dc             	mov    %ecx,-0x24(%ebp)
8010531d:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
80105320:	e8 c1 df ff ff       	call   801032e6 <myproc>
80105325:	8d 50 74             	lea    0x74(%eax),%edx
80105328:	89 55 d8             	mov    %edx,-0x28(%ebp)
8010532b:	e8 b6 df ff ff       	call   801032e6 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105330:	57                   	push   %edi
80105331:	ff 75 e4             	pushl  -0x1c(%ebp)
80105334:	ff 75 e0             	pushl  -0x20(%ebp)
80105337:	ff 75 dc             	pushl  -0x24(%ebp)
8010533a:	56                   	push   %esi
8010533b:	ff 75 d8             	pushl  -0x28(%ebp)
8010533e:	ff 70 10             	pushl  0x10(%eax)
80105341:	68 30 72 10 80       	push   $0x80107230
80105346:	e8 de b2 ff ff       	call   80100629 <cprintf>
    break;	
8010534b:	83 c4 20             	add    $0x20,%esp
8010534e:	e9 25 fe ff ff       	jmp    80105178 <trap+0x92>
	    cprintf("Proceso ha pedido una direccion del sistema operativo\n");
80105353:	83 ec 0c             	sub    $0xc,%esp
80105356:	68 84 71 10 80       	push   $0x80107184
8010535b:	e8 c9 b2 ff ff       	call   80100629 <cprintf>
    	myproc()->killed = 1;
80105360:	e8 81 df ff ff       	call   801032e6 <myproc>
80105365:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
	    return;
8010536c:	83 c4 10             	add    $0x10,%esp
8010536f:	e9 66 fe ff ff       	jmp    801051da <trap+0xf4>
      cprintf("Proceso ha pedido una direccion fuera de su rango valido\n");
80105374:	83 ec 0c             	sub    $0xc,%esp
80105377:	68 bc 71 10 80       	push   $0x801071bc
8010537c:	e8 a8 b2 ff ff       	call   80100629 <cprintf>
    	myproc()->killed = 1;
80105381:	e8 60 df ff ff       	call   801032e6 <myproc>
80105386:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
	    return;
8010538d:	83 c4 10             	add    $0x10,%esp
80105390:	e9 45 fe ff ff       	jmp    801051da <trap+0xf4>
      cprintf("Proceso ha pedido una direccion de la pagina de guarda\n");
80105395:	83 ec 0c             	sub    $0xc,%esp
80105398:	68 f8 71 10 80       	push   $0x801071f8
8010539d:	e8 87 b2 ff ff       	call   80100629 <cprintf>
    	myproc()->killed = 1;
801053a2:	e8 3f df ff ff       	call   801032e6 <myproc>
801053a7:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
	    return;
801053ae:	83 c4 10             	add    $0x10,%esp
801053b1:	e9 24 fe ff ff       	jmp    801051da <trap+0xf4>
        cprintf("allocuvm out of memory\n");
801053b6:	83 ec 0c             	sub    $0xc,%esp
801053b9:	68 24 71 10 80       	push   $0x80107124
801053be:	e8 66 b2 ff ff       	call   80100629 <cprintf>
        kfree(mem);
801053c3:	89 34 24             	mov    %esi,(%esp)
801053c6:	e8 7b cc ff ff       	call   80102046 <kfree>
        myproc()->killed = 1;
801053cb:	e8 16 df ff ff       	call   801032e6 <myproc>
801053d0:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
        return ;
801053d7:	83 c4 10             	add    $0x10,%esp
801053da:	e9 fb fd ff ff       	jmp    801051da <trap+0xf4>
        cprintf("allocuvm out of memory (2)\n");
801053df:	83 ec 0c             	sub    $0xc,%esp
801053e2:	68 3c 71 10 80       	push   $0x8010713c
801053e7:	e8 3d b2 ff ff       	call   80100629 <cprintf>
        deallocuvm(myproc()->pgdir, myproc()->sz - PGSIZE, myproc()->sz );
801053ec:	e8 f5 de ff ff       	call   801032e6 <myproc>
801053f1:	8b 38                	mov    (%eax),%edi
801053f3:	e8 ee de ff ff       	call   801032e6 <myproc>
801053f8:	8b 18                	mov    (%eax),%ebx
801053fa:	e8 e7 de ff ff       	call   801032e6 <myproc>
801053ff:	83 c4 0c             	add    $0xc,%esp
80105402:	57                   	push   %edi
80105403:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80105409:	53                   	push   %ebx
8010540a:	ff 70 04             	pushl  0x4(%eax)
8010540d:	e8 14 11 00 00       	call   80106526 <deallocuvm>
        kfree(mem);
80105412:	89 34 24             	mov    %esi,(%esp)
80105415:	e8 2c cc ff ff       	call   80102046 <kfree>
        myproc()->killed = 1;
8010541a:	e8 c7 de ff ff       	call   801032e6 <myproc>
8010541f:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
        return;
80105426:	83 c4 10             	add    $0x10,%esp
80105429:	e9 ac fd ff ff       	jmp    801051da <trap+0xf4>
      if(myproc() == 0 || (tf->cs&3) == 0){
8010542e:	e8 b3 de ff ff       	call   801032e6 <myproc>
80105433:	85 c0                	test   %eax,%eax
80105435:	74 5f                	je     80105496 <trap+0x3b0>
80105437:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010543b:	74 59                	je     80105496 <trap+0x3b0>
8010543d:	0f 20 d7             	mov    %cr2,%edi
      cprintf("pid %d %s: trap %d err %d on cpu %d "
80105440:	8b 43 38             	mov    0x38(%ebx),%eax
80105443:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105446:	e8 7c de ff ff       	call   801032c7 <cpuid>
8010544b:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010544e:	8b 4b 34             	mov    0x34(%ebx),%ecx
80105451:	89 4d dc             	mov    %ecx,-0x24(%ebp)
80105454:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
80105457:	e8 8a de ff ff       	call   801032e6 <myproc>
8010545c:	8d 50 74             	lea    0x74(%eax),%edx
8010545f:	89 55 d8             	mov    %edx,-0x28(%ebp)
80105462:	e8 7f de ff ff       	call   801032e6 <myproc>
      cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105478:	68 30 72 10 80       	push   $0x80107230
8010547d:	e8 a7 b1 ff ff       	call   80100629 <cprintf>
      myproc()->killed = 1;
80105482:	83 c4 20             	add    $0x20,%esp
80105485:	e8 5c de ff ff       	call   801032e6 <myproc>
8010548a:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      break;
80105491:	e9 e2 fc ff ff       	jmp    80105178 <trap+0x92>
80105496:	0f 20 d7             	mov    %cr2,%edi
          cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105499:	8b 73 38             	mov    0x38(%ebx),%esi
8010549c:	e8 26 de ff ff       	call   801032c7 <cpuid>
...
801054aa:	68 74 72 10 80       	push   $0x80107274
801054af:	e8 75 b1 ff ff       	call   80100629 <cprintf>
          panic("trap");
801054b4:	83 c4 14             	add    $0x14,%esp
801054b7:	68 58 71 10 80       	push   $0x80107158
801054bc:	e8 9b ae ff ff       	call   8010035c <panic>
    exit(tf->trapno++);
801054c1:	8b 43 30             	mov    0x30(%ebx),%eax
801054c4:	8d 50 01             	lea    0x1(%eax),%edx
801054c7:	89 53 30             	mov    %edx,0x30(%ebx)
801054ca:	83 ec 0c             	sub    $0xc,%esp
801054cd:	50                   	push   %eax
801054ce:	e8 d8 e1 ff ff       	call   801036ab <exit>
801054d3:	83 c4 10             	add    $0x10,%esp
801054d6:	e9 c2 fc ff ff       	jmp    8010519d <trap+0xb7>
  if(myproc() && myproc()->state == RUNNING &&
801054db:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801054df:	0f 85 d0 fc ff ff    	jne    801051b5 <trap+0xcf>
    yield();
801054e5:	e8 8e e2 ff ff       	call   80103778 <yield>
801054ea:	e9 c6 fc ff ff       	jmp    801051b5 <trap+0xcf>
    exit(tf->trapno++);
801054ef:	8b 43 30             	mov    0x30(%ebx),%eax
801054f2:	8d 50 01             	lea    0x1(%eax),%edx
801054f5:	89 53 30             	mov    %edx,0x30(%ebx)
801054f8:	83 ec 0c             	sub    $0xc,%esp
801054fb:	50                   	push   %eax
801054fc:	e8 aa e1 ff ff       	call   801036ab <exit>
80105501:	83 c4 10             	add    $0x10,%esp
80105504:	e9 d1 fc ff ff       	jmp    801051da <trap+0xf4>
...
uartgetc(void)
{
80105509:	f3 0f 1e fb          	endbr32 
  if(!uart)
8010550d:	83 3d bc a5 10 80 00 	cmpl   $0x0,0x8010a5bc
80105514:	74 14                	je     8010552a <uartgetc+0x21>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105516:	ba fd 03 00 00       	mov    $0x3fd,%edx
8010551b:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
8010551c:	a8 01                	test   $0x1,%al
8010551e:	74 10                	je     80105530 <uartgetc+0x27>
80105520:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105525:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105526:	0f b6 c0             	movzbl %al,%eax
80105529:	c3                   	ret    
    return -1;
...
80105536 <uartputc>:
{
80105536:	f3 0f 1e fb          	endbr32 
  if(!uart)
8010553a:	83 3d bc a5 10 80 00 	cmpl   $0x0,0x8010a5bc
80105541:	74 3b                	je     8010557e <uartputc+0x48>
{
...
8010554a:	bb 00 00 00 00       	mov    $0x0,%ebx
8010554f:	83 fb 7f             	cmp    $0x7f,%ebx
80105552:	7f 1c                	jg     80105570 <uartputc+0x3a>
80105554:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105559:	ec                   	in     (%dx),%al
8010555a:	a8 20                	test   $0x20,%al
8010555c:	75 12                	jne    80105570 <uartputc+0x3a>
    microdelay(10);
8010555e:	83 ec 0c             	sub    $0xc,%esp
80105561:	6a 0a                	push   $0xa
80105563:	e8 0b cf ff ff       	call   80102473 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105568:	83 c3 01             	add    $0x1,%ebx
8010556b:	83 c4 10             	add    $0x10,%esp
8010556e:	eb df                	jmp    8010554f <uartputc+0x19>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105570:	8b 45 08             	mov    0x8(%ebp),%eax
80105573:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105578:	ee                   	out    %al,(%dx)
}
80105579:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010557c:	c9                   	leave  
8010557d:	c3                   	ret    
8010557e:	c3                   	ret    
...
80105588:	b9 00 00 00 00       	mov    $0x0,%ecx
8010558d:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105592:	89 c8                	mov    %ecx,%eax
80105594:	ee                   	out    %al,(%dx)
80105595:	be fb 03 00 00       	mov    $0x3fb,%esi
8010559a:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
8010559f:	89 f2                	mov    %esi,%edx
801055a1:	ee                   	out    %al,(%dx)
801055a2:	b8 0c 00 00 00       	mov    $0xc,%eax
801055a7:	ba f8 03 00 00       	mov    $0x3f8,%edx
801055ac:	ee                   	out    %al,(%dx)
801055ad:	bb f9 03 00 00       	mov    $0x3f9,%ebx
801055b2:	89 c8                	mov    %ecx,%eax
801055b4:	89 da                	mov    %ebx,%edx
801055b6:	ee                   	out    %al,(%dx)
801055b7:	b8 03 00 00 00       	mov    $0x3,%eax
801055bc:	89 f2                	mov    %esi,%edx
801055be:	ee                   	out    %al,(%dx)
801055bf:	ba fc 03 00 00       	mov    $0x3fc,%edx
801055c4:	89 c8                	mov    %ecx,%eax
801055c6:	ee                   	out    %al,(%dx)
801055c7:	b8 01 00 00 00       	mov    $0x1,%eax
801055cc:	89 da                	mov    %ebx,%edx
801055ce:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801055cf:	ba fd 03 00 00       	mov    $0x3fd,%edx
801055d4:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
801055d5:	3c ff                	cmp    $0xff,%al
801055d7:	74 45                	je     8010561e <uartinit+0x9f>
  uart = 1;
801055d9:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
801055e0:	00 00 00 
801055e3:	ba fa 03 00 00       	mov    $0x3fa,%edx
801055e8:	ec                   	in     (%dx),%al
801055e9:	ba f8 03 00 00       	mov    $0x3f8,%edx
801055ee:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
801055ef:	83 ec 08             	sub    $0x8,%esp
801055f2:	6a 00                	push   $0x0
801055f4:	6a 04                	push   $0x4
801055f6:	e8 1b ca ff ff       	call   80102016 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
801055fb:	83 c4 10             	add    $0x10,%esp
801055fe:	bb 70 73 10 80       	mov    $0x80107370,%ebx
80105603:	eb 12                	jmp    80105617 <uartinit+0x98>
    uartputc(*p);
80105605:	83 ec 0c             	sub    $0xc,%esp
80105608:	0f be c0             	movsbl %al,%eax
8010560b:	50                   	push   %eax
8010560c:	e8 25 ff ff ff       	call   80105536 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105611:	83 c3 01             	add    $0x1,%ebx
80105614:	83 c4 10             	add    $0x10,%esp
80105617:	0f b6 03             	movzbl (%ebx),%eax
8010561a:	84 c0                	test   %al,%al
8010561c:	75 e7                	jne    80105605 <uartinit+0x86>
}
...
8010562c:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
8010562f:	68 09 55 10 80       	push   $0x80105509
80105634:	e8 20 b1 ff ff       	call   80100759 <consoleintr>
}
...
80105640:	6a 00                	push   $0x0
  jmp alltraps
80105642:	e9 9f f9 ff ff       	jmp    80104fe6 <alltraps>
...
80105649:	6a 01                	push   $0x1
  jmp alltraps
8010564b:	e9 96 f9 ff ff       	jmp    80104fe6 <alltraps>
...
80105650:	6a 00                	push   $0x0
  pushl $2
80105652:	6a 02                	push   $0x2
  jmp alltraps
80105654:	e9 8d f9 ff ff       	jmp    80104fe6 <alltraps>
...
80105659:	6a 00                	push   $0x0
  pushl $3
8010565b:	6a 03                	push   $0x3
  jmp alltraps
8010565d:	e9 84 f9 ff ff       	jmp    80104fe6 <alltraps>
...
80105664:	6a 04                	push   $0x4
  jmp alltraps
80105666:	e9 7b f9 ff ff       	jmp    80104fe6 <alltraps>
...
8010566b:	6a 00                	push   $0x0
  pushl $5
8010566d:	6a 05                	push   $0x5
  jmp alltraps
8010566f:	e9 72 f9 ff ff       	jmp    80104fe6 <alltraps>
...
80105674:	6a 00                	push   $0x0
  pushl $6
80105676:	6a 06                	push   $0x6
  jmp alltraps
80105678:	e9 69 f9 ff ff       	jmp    80104fe6 <alltraps>
...
8010567d:	6a 00                	push   $0x0
  pushl $7
8010567f:	6a 07                	push   $0x7
  jmp alltraps
80105681:	e9 60 f9 ff ff       	jmp    80104fe6 <alltraps>

80105686 <vector8>:
.globl vector8
vector8:
  pushl $8
80105686:	6a 08                	push   $0x8
  jmp alltraps
80105688:	e9 59 f9 ff ff       	jmp    80104fe6 <alltraps>
...
8010568d:	6a 00                	push   $0x0
  pushl $9
8010568f:	6a 09                	push   $0x9
  jmp alltraps
80105691:	e9 50 f9 ff ff       	jmp    80104fe6 <alltraps>

80105696 <vector10>:
.globl vector10
vector10:
  pushl $10
80105696:	6a 0a                	push   $0xa
  jmp alltraps
80105698:	e9 49 f9 ff ff       	jmp    80104fe6 <alltraps>

8010569d <vector11>:
.globl vector11
vector11:
  pushl $11
8010569d:	6a 0b                	push   $0xb
  jmp alltraps
8010569f:	e9 42 f9 ff ff       	jmp    80104fe6 <alltraps>

801056a4 <vector12>:
.globl vector12
vector12:
  pushl $12
801056a4:	6a 0c                	push   $0xc
  jmp alltraps
801056a6:	e9 3b f9 ff ff       	jmp    80104fe6 <alltraps>

801056ab <vector13>:
.globl vector13
vector13:
  pushl $13
801056ab:	6a 0d                	push   $0xd
  jmp alltraps
801056ad:	e9 34 f9 ff ff       	jmp    80104fe6 <alltraps>

801056b2 <vector14>:
.globl vector14
vector14:
  pushl $14
801056b2:	6a 0e                	push   $0xe
  jmp alltraps
801056b4:	e9 2d f9 ff ff       	jmp    80104fe6 <alltraps>
...
801056b9:	6a 00                	push   $0x0
  pushl $15
801056bb:	6a 0f                	push   $0xf
  jmp alltraps
801056bd:	e9 24 f9 ff ff       	jmp    80104fe6 <alltraps>
...
801056c2:	6a 00                	push   $0x0
  pushl $16
801056c4:	6a 10                	push   $0x10
  jmp alltraps
801056c6:	e9 1b f9 ff ff       	jmp    80104fe6 <alltraps>

801056cb <vector17>:
.globl vector17
vector17:
  pushl $17
801056cb:	6a 11                	push   $0x11
  jmp alltraps
801056cd:	e9 14 f9 ff ff       	jmp    80104fe6 <alltraps>
...
801056d2:	6a 00                	push   $0x0
  pushl $18
801056d4:	6a 12                	push   $0x12
  jmp alltraps
801056d6:	e9 0b f9 ff ff       	jmp    80104fe6 <alltraps>
...
801056db:	6a 00                	push   $0x0
  pushl $19
801056dd:	6a 13                	push   $0x13
  jmp alltraps
801056df:	e9 02 f9 ff ff       	jmp    80104fe6 <alltraps>
...
801056e4:	6a 00                	push   $0x0
  pushl $20
801056e6:	6a 14                	push   $0x14
  jmp alltraps
801056e8:	e9 f9 f8 ff ff       	jmp    80104fe6 <alltraps>
...
801056ed:	6a 00                	push   $0x0
  pushl $21
801056ef:	6a 15                	push   $0x15
  jmp alltraps
801056f1:	e9 f0 f8 ff ff       	jmp    80104fe6 <alltraps>
...
801056f6:	6a 00                	push   $0x0
  pushl $22
801056f8:	6a 16                	push   $0x16
  jmp alltraps
801056fa:	e9 e7 f8 ff ff       	jmp    80104fe6 <alltraps>
...
801056ff:	6a 00                	push   $0x0
  pushl $23
80105701:	6a 17                	push   $0x17
  jmp alltraps
80105703:	e9 de f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105708:	6a 00                	push   $0x0
  pushl $24
8010570a:	6a 18                	push   $0x18
  jmp alltraps
8010570c:	e9 d5 f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105711:	6a 00                	push   $0x0
  pushl $25
80105713:	6a 19                	push   $0x19
  jmp alltraps
80105715:	e9 cc f8 ff ff       	jmp    80104fe6 <alltraps>
...
8010571a:	6a 00                	push   $0x0
  pushl $26
8010571c:	6a 1a                	push   $0x1a
  jmp alltraps
8010571e:	e9 c3 f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105723:	6a 00                	push   $0x0
  pushl $27
80105725:	6a 1b                	push   $0x1b
  jmp alltraps
80105727:	e9 ba f8 ff ff       	jmp    80104fe6 <alltraps>
...
8010572c:	6a 00                	push   $0x0
  pushl $28
8010572e:	6a 1c                	push   $0x1c
  jmp alltraps
80105730:	e9 b1 f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105735:	6a 00                	push   $0x0
  pushl $29
80105737:	6a 1d                	push   $0x1d
  jmp alltraps
80105739:	e9 a8 f8 ff ff       	jmp    80104fe6 <alltraps>
...
8010573e:	6a 00                	push   $0x0
  pushl $30
80105740:	6a 1e                	push   $0x1e
  jmp alltraps
80105742:	e9 9f f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105747:	6a 00                	push   $0x0
  pushl $31
80105749:	6a 1f                	push   $0x1f
  jmp alltraps
8010574b:	e9 96 f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105750:	6a 00                	push   $0x0
  pushl $32
80105752:	6a 20                	push   $0x20
  jmp alltraps
80105754:	e9 8d f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105759:	6a 00                	push   $0x0
  pushl $33
8010575b:	6a 21                	push   $0x21
  jmp alltraps
8010575d:	e9 84 f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105762:	6a 00                	push   $0x0
  pushl $34
80105764:	6a 22                	push   $0x22
  jmp alltraps
80105766:	e9 7b f8 ff ff       	jmp    80104fe6 <alltraps>
...
8010576b:	6a 00                	push   $0x0
  pushl $35
8010576d:	6a 23                	push   $0x23
  jmp alltraps
8010576f:	e9 72 f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105774:	6a 00                	push   $0x0
  pushl $36
80105776:	6a 24                	push   $0x24
  jmp alltraps
80105778:	e9 69 f8 ff ff       	jmp    80104fe6 <alltraps>
...
8010577d:	6a 00                	push   $0x0
  pushl $37
8010577f:	6a 25                	push   $0x25
  jmp alltraps
80105781:	e9 60 f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105786:	6a 00                	push   $0x0
  pushl $38
80105788:	6a 26                	push   $0x26
  jmp alltraps
8010578a:	e9 57 f8 ff ff       	jmp    80104fe6 <alltraps>
...
8010578f:	6a 00                	push   $0x0
  pushl $39
80105791:	6a 27                	push   $0x27
  jmp alltraps
80105793:	e9 4e f8 ff ff       	jmp    80104fe6 <alltraps>
...
80105798:	6a 00                	push   $0x0
  pushl $40
8010579a:	6a 28                	push   $0x28
  jmp alltraps
8010579c:	e9 45 f8 ff ff       	jmp    80104fe6 <alltraps>
...
801057a1:	6a 00                	push   $0x0
  pushl $41
801057a3:	6a 29                	push   $0x29
  jmp alltraps
801057a5:	e9 3c f8 ff ff       	jmp    80104fe6 <alltraps>
...
801057aa:	6a 00                	push   $0x0
  pushl $42
801057ac:	6a 2a                	push   $0x2a
  jmp alltraps
801057ae:	e9 33 f8 ff ff       	jmp    80104fe6 <alltraps>
...
801057b3:	6a 00                	push   $0x0
  pushl $43
801057b5:	6a 2b                	push   $0x2b
  jmp alltraps
801057b7:	e9 2a f8 ff ff       	jmp    80104fe6 <alltraps>
...
801057bc:	6a 00                	push   $0x0
  pushl $44
801057be:	6a 2c                	push   $0x2c
  jmp alltraps
801057c0:	e9 21 f8 ff ff       	jmp    80104fe6 <alltraps>
...
801057c5:	6a 00                	push   $0x0
  pushl $45
801057c7:	6a 2d                	push   $0x2d
  jmp alltraps
801057c9:	e9 18 f8 ff ff       	jmp    80104fe6 <alltraps>
...
801057ce:	6a 00                	push   $0x0
  pushl $46
801057d0:	6a 2e                	push   $0x2e
  jmp alltraps
801057d2:	e9 0f f8 ff ff       	jmp    80104fe6 <alltraps>
...
801057d7:	6a 00                	push   $0x0
  pushl $47
801057d9:	6a 2f                	push   $0x2f
  jmp alltraps
801057db:	e9 06 f8 ff ff       	jmp    80104fe6 <alltraps>
...
801057e0:	6a 00                	push   $0x0
  pushl $48
801057e2:	6a 30                	push   $0x30
  jmp alltraps
801057e4:	e9 fd f7 ff ff       	jmp    80104fe6 <alltraps>
...
801057e9:	6a 00                	push   $0x0
  pushl $49
801057eb:	6a 31                	push   $0x31
  jmp alltraps
801057ed:	e9 f4 f7 ff ff       	jmp    80104fe6 <alltraps>
...
801057f2:	6a 00                	push   $0x0
  pushl $50
801057f4:	6a 32                	push   $0x32
  jmp alltraps
801057f6:	e9 eb f7 ff ff       	jmp    80104fe6 <alltraps>
...
801057fb:	6a 00                	push   $0x0
  pushl $51
801057fd:	6a 33                	push   $0x33
  jmp alltraps
801057ff:	e9 e2 f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105804:	6a 00                	push   $0x0
  pushl $52
80105806:	6a 34                	push   $0x34
  jmp alltraps
80105808:	e9 d9 f7 ff ff       	jmp    80104fe6 <alltraps>
...
8010580d:	6a 00                	push   $0x0
  pushl $53
8010580f:	6a 35                	push   $0x35
  jmp alltraps
80105811:	e9 d0 f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105816:	6a 00                	push   $0x0
  pushl $54
80105818:	6a 36                	push   $0x36
  jmp alltraps
8010581a:	e9 c7 f7 ff ff       	jmp    80104fe6 <alltraps>
...
8010581f:	6a 00                	push   $0x0
  pushl $55
80105821:	6a 37                	push   $0x37
  jmp alltraps
80105823:	e9 be f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105828:	6a 00                	push   $0x0
  pushl $56
8010582a:	6a 38                	push   $0x38
  jmp alltraps
8010582c:	e9 b5 f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105831:	6a 00                	push   $0x0
  pushl $57
80105833:	6a 39                	push   $0x39
  jmp alltraps
80105835:	e9 ac f7 ff ff       	jmp    80104fe6 <alltraps>
...
8010583a:	6a 00                	push   $0x0
  pushl $58
8010583c:	6a 3a                	push   $0x3a
  jmp alltraps
8010583e:	e9 a3 f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105843:	6a 00                	push   $0x0
  pushl $59
80105845:	6a 3b                	push   $0x3b
  jmp alltraps
80105847:	e9 9a f7 ff ff       	jmp    80104fe6 <alltraps>
...
8010584c:	6a 00                	push   $0x0
  pushl $60
8010584e:	6a 3c                	push   $0x3c
  jmp alltraps
80105850:	e9 91 f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105855:	6a 00                	push   $0x0
  pushl $61
80105857:	6a 3d                	push   $0x3d
  jmp alltraps
80105859:	e9 88 f7 ff ff       	jmp    80104fe6 <alltraps>
...
8010585e:	6a 00                	push   $0x0
  pushl $62
80105860:	6a 3e                	push   $0x3e
  jmp alltraps
80105862:	e9 7f f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105867:	6a 00                	push   $0x0
  pushl $63
80105869:	6a 3f                	push   $0x3f
  jmp alltraps
8010586b:	e9 76 f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105870:	6a 00                	push   $0x0
  pushl $64
80105872:	6a 40                	push   $0x40
  jmp alltraps
80105874:	e9 6d f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105879:	6a 00                	push   $0x0
  pushl $65
8010587b:	6a 41                	push   $0x41
  jmp alltraps
8010587d:	e9 64 f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105882:	6a 00                	push   $0x0
  pushl $66
80105884:	6a 42                	push   $0x42
  jmp alltraps
80105886:	e9 5b f7 ff ff       	jmp    80104fe6 <alltraps>
...
8010588b:	6a 00                	push   $0x0
  pushl $67
8010588d:	6a 43                	push   $0x43
  jmp alltraps
8010588f:	e9 52 f7 ff ff       	jmp    80104fe6 <alltraps>
...
80105894:	6a 00                	push   $0x0
  pushl $68
80105896:	6a 44                	push   $0x44
  jmp alltraps
80105898:	e9 49 f7 ff ff       	jmp    80104fe6 <alltraps>
...
8010589d:	6a 00                	push   $0x0
  pushl $69
8010589f:	6a 45                	push   $0x45
  jmp alltraps
801058a1:	e9 40 f7 ff ff       	jmp    80104fe6 <alltraps>
...
801058a6:	6a 00                	push   $0x0
  pushl $70
801058a8:	6a 46                	push   $0x46
  jmp alltraps
801058aa:	e9 37 f7 ff ff       	jmp    80104fe6 <alltraps>
...
801058af:	6a 00                	push   $0x0
  pushl $71
801058b1:	6a 47                	push   $0x47
  jmp alltraps
801058b3:	e9 2e f7 ff ff       	jmp    80104fe6 <alltraps>
...
801058b8:	6a 00                	push   $0x0
  pushl $72
801058ba:	6a 48                	push   $0x48
  jmp alltraps
801058bc:	e9 25 f7 ff ff       	jmp    80104fe6 <alltraps>
...
801058c1:	6a 00                	push   $0x0
  pushl $73
801058c3:	6a 49                	push   $0x49
  jmp alltraps
801058c5:	e9 1c f7 ff ff       	jmp    80104fe6 <alltraps>
...
801058ca:	6a 00                	push   $0x0
  pushl $74
801058cc:	6a 4a                	push   $0x4a
  jmp alltraps
801058ce:	e9 13 f7 ff ff       	jmp    80104fe6 <alltraps>
...
801058d3:	6a 00                	push   $0x0
  pushl $75
801058d5:	6a 4b                	push   $0x4b
  jmp alltraps
801058d7:	e9 0a f7 ff ff       	jmp    80104fe6 <alltraps>
...
801058dc:	6a 00                	push   $0x0
  pushl $76
801058de:	6a 4c                	push   $0x4c
  jmp alltraps
801058e0:	e9 01 f7 ff ff       	jmp    80104fe6 <alltraps>
...
801058e5:	6a 00                	push   $0x0
  pushl $77
801058e7:	6a 4d                	push   $0x4d
  jmp alltraps
801058e9:	e9 f8 f6 ff ff       	jmp    80104fe6 <alltraps>
...
801058ee:	6a 00                	push   $0x0
  pushl $78
801058f0:	6a 4e                	push   $0x4e
  jmp alltraps
801058f2:	e9 ef f6 ff ff       	jmp    80104fe6 <alltraps>
...
801058f7:	6a 00                	push   $0x0
  pushl $79
801058f9:	6a 4f                	push   $0x4f
  jmp alltraps
801058fb:	e9 e6 f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105900:	6a 00                	push   $0x0
  pushl $80
80105902:	6a 50                	push   $0x50
  jmp alltraps
80105904:	e9 dd f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105909:	6a 00                	push   $0x0
  pushl $81
8010590b:	6a 51                	push   $0x51
  jmp alltraps
8010590d:	e9 d4 f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105912:	6a 00                	push   $0x0
  pushl $82
80105914:	6a 52                	push   $0x52
  jmp alltraps
80105916:	e9 cb f6 ff ff       	jmp    80104fe6 <alltraps>
...
8010591b:	6a 00                	push   $0x0
  pushl $83
8010591d:	6a 53                	push   $0x53
  jmp alltraps
8010591f:	e9 c2 f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105924:	6a 00                	push   $0x0
  pushl $84
80105926:	6a 54                	push   $0x54
  jmp alltraps
80105928:	e9 b9 f6 ff ff       	jmp    80104fe6 <alltraps>
...
8010592d:	6a 00                	push   $0x0
  pushl $85
8010592f:	6a 55                	push   $0x55
  jmp alltraps
80105931:	e9 b0 f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105936:	6a 00                	push   $0x0
  pushl $86
80105938:	6a 56                	push   $0x56
  jmp alltraps
8010593a:	e9 a7 f6 ff ff       	jmp    80104fe6 <alltraps>
...
8010593f:	6a 00                	push   $0x0
  pushl $87
80105941:	6a 57                	push   $0x57
  jmp alltraps
80105943:	e9 9e f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105948:	6a 00                	push   $0x0
  pushl $88
8010594a:	6a 58                	push   $0x58
  jmp alltraps
8010594c:	e9 95 f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105951:	6a 00                	push   $0x0
  pushl $89
80105953:	6a 59                	push   $0x59
  jmp alltraps
80105955:	e9 8c f6 ff ff       	jmp    80104fe6 <alltraps>
...
8010595a:	6a 00                	push   $0x0
  pushl $90
8010595c:	6a 5a                	push   $0x5a
  jmp alltraps
8010595e:	e9 83 f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105963:	6a 00                	push   $0x0
  pushl $91
80105965:	6a 5b                	push   $0x5b
  jmp alltraps
80105967:	e9 7a f6 ff ff       	jmp    80104fe6 <alltraps>
...
8010596c:	6a 00                	push   $0x0
  pushl $92
8010596e:	6a 5c                	push   $0x5c
  jmp alltraps
80105970:	e9 71 f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105975:	6a 00                	push   $0x0
  pushl $93
80105977:	6a 5d                	push   $0x5d
  jmp alltraps
80105979:	e9 68 f6 ff ff       	jmp    80104fe6 <alltraps>
...
8010597e:	6a 00                	push   $0x0
  pushl $94
80105980:	6a 5e                	push   $0x5e
  jmp alltraps
80105982:	e9 5f f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105987:	6a 00                	push   $0x0
  pushl $95
80105989:	6a 5f                	push   $0x5f
  jmp alltraps
8010598b:	e9 56 f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105990:	6a 00                	push   $0x0
  pushl $96
80105992:	6a 60                	push   $0x60
  jmp alltraps
80105994:	e9 4d f6 ff ff       	jmp    80104fe6 <alltraps>
...
80105999:	6a 00                	push   $0x0
  pushl $97
8010599b:	6a 61                	push   $0x61
  jmp alltraps
8010599d:	e9 44 f6 ff ff       	jmp    80104fe6 <alltraps>
...
801059a2:	6a 00                	push   $0x0
  pushl $98
801059a4:	6a 62                	push   $0x62
  jmp alltraps
801059a6:	e9 3b f6 ff ff       	jmp    80104fe6 <alltraps>
...
801059ab:	6a 00                	push   $0x0
  pushl $99
801059ad:	6a 63                	push   $0x63
  jmp alltraps
801059af:	e9 32 f6 ff ff       	jmp    80104fe6 <alltraps>
...
801059b4:	6a 00                	push   $0x0
  pushl $100
801059b6:	6a 64                	push   $0x64
  jmp alltraps
801059b8:	e9 29 f6 ff ff       	jmp    80104fe6 <alltraps>
...
801059bd:	6a 00                	push   $0x0
  pushl $101
801059bf:	6a 65                	push   $0x65
  jmp alltraps
801059c1:	e9 20 f6 ff ff       	jmp    80104fe6 <alltraps>
...
801059c6:	6a 00                	push   $0x0
  pushl $102
801059c8:	6a 66                	push   $0x66
  jmp alltraps
801059ca:	e9 17 f6 ff ff       	jmp    80104fe6 <alltraps>
...
801059cf:	6a 00                	push   $0x0
  pushl $103
801059d1:	6a 67                	push   $0x67
  jmp alltraps
801059d3:	e9 0e f6 ff ff       	jmp    80104fe6 <alltraps>
...
801059d8:	6a 00                	push   $0x0
  pushl $104
801059da:	6a 68                	push   $0x68
  jmp alltraps
801059dc:	e9 05 f6 ff ff       	jmp    80104fe6 <alltraps>
...
801059e1:	6a 00                	push   $0x0
  pushl $105
801059e3:	6a 69                	push   $0x69
  jmp alltraps
801059e5:	e9 fc f5 ff ff       	jmp    80104fe6 <alltraps>
...
801059ea:	6a 00                	push   $0x0
  pushl $106
801059ec:	6a 6a                	push   $0x6a
  jmp alltraps
801059ee:	e9 f3 f5 ff ff       	jmp    80104fe6 <alltraps>
...
801059f3:	6a 00                	push   $0x0
  pushl $107
801059f5:	6a 6b                	push   $0x6b
  jmp alltraps
801059f7:	e9 ea f5 ff ff       	jmp    80104fe6 <alltraps>
...
801059fc:	6a 00                	push   $0x0
  pushl $108
801059fe:	6a 6c                	push   $0x6c
  jmp alltraps
80105a00:	e9 e1 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a05:	6a 00                	push   $0x0
  pushl $109
80105a07:	6a 6d                	push   $0x6d
  jmp alltraps
80105a09:	e9 d8 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a0e:	6a 00                	push   $0x0
  pushl $110
80105a10:	6a 6e                	push   $0x6e
  jmp alltraps
80105a12:	e9 cf f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a17:	6a 00                	push   $0x0
  pushl $111
80105a19:	6a 6f                	push   $0x6f
  jmp alltraps
80105a1b:	e9 c6 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a20:	6a 00                	push   $0x0
  pushl $112
80105a22:	6a 70                	push   $0x70
  jmp alltraps
80105a24:	e9 bd f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a29:	6a 00                	push   $0x0
  pushl $113
80105a2b:	6a 71                	push   $0x71
  jmp alltraps
80105a2d:	e9 b4 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a32:	6a 00                	push   $0x0
  pushl $114
80105a34:	6a 72                	push   $0x72
  jmp alltraps
80105a36:	e9 ab f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a3b:	6a 00                	push   $0x0
  pushl $115
80105a3d:	6a 73                	push   $0x73
  jmp alltraps
80105a3f:	e9 a2 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a44:	6a 00                	push   $0x0
  pushl $116
80105a46:	6a 74                	push   $0x74
  jmp alltraps
80105a48:	e9 99 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a4d:	6a 00                	push   $0x0
  pushl $117
80105a4f:	6a 75                	push   $0x75
  jmp alltraps
80105a51:	e9 90 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a56:	6a 00                	push   $0x0
  pushl $118
80105a58:	6a 76                	push   $0x76
  jmp alltraps
80105a5a:	e9 87 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a5f:	6a 00                	push   $0x0
  pushl $119
80105a61:	6a 77                	push   $0x77
  jmp alltraps
80105a63:	e9 7e f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a68:	6a 00                	push   $0x0
  pushl $120
80105a6a:	6a 78                	push   $0x78
  jmp alltraps
80105a6c:	e9 75 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a71:	6a 00                	push   $0x0
  pushl $121
80105a73:	6a 79                	push   $0x79
  jmp alltraps
80105a75:	e9 6c f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a7a:	6a 00                	push   $0x0
  pushl $122
80105a7c:	6a 7a                	push   $0x7a
  jmp alltraps
80105a7e:	e9 63 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a83:	6a 00                	push   $0x0
  pushl $123
80105a85:	6a 7b                	push   $0x7b
  jmp alltraps
80105a87:	e9 5a f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a8c:	6a 00                	push   $0x0
  pushl $124
80105a8e:	6a 7c                	push   $0x7c
  jmp alltraps
80105a90:	e9 51 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a95:	6a 00                	push   $0x0
  pushl $125
80105a97:	6a 7d                	push   $0x7d
  jmp alltraps
80105a99:	e9 48 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105a9e:	6a 00                	push   $0x0
  pushl $126
80105aa0:	6a 7e                	push   $0x7e
  jmp alltraps
80105aa2:	e9 3f f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105aa7:	6a 00                	push   $0x0
  pushl $127
80105aa9:	6a 7f                	push   $0x7f
  jmp alltraps
80105aab:	e9 36 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105ab2:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105ab7:	e9 2a f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105abc:	6a 00                	push   $0x0
  pushl $129
80105abe:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105ac3:	e9 1e f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105ac8:	6a 00                	push   $0x0
  pushl $130
80105aca:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105acf:	e9 12 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105ad4:	6a 00                	push   $0x0
  pushl $131
80105ad6:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105adb:	e9 06 f5 ff ff       	jmp    80104fe6 <alltraps>
...
80105ae0:	6a 00                	push   $0x0
  pushl $132
80105ae2:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105ae7:	e9 fa f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105aec:	6a 00                	push   $0x0
  pushl $133
80105aee:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105af3:	e9 ee f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105af8:	6a 00                	push   $0x0
  pushl $134
80105afa:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105aff:	e9 e2 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b04:	6a 00                	push   $0x0
  pushl $135
80105b06:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105b0b:	e9 d6 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b10:	6a 00                	push   $0x0
  pushl $136
80105b12:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105b17:	e9 ca f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b1c:	6a 00                	push   $0x0
  pushl $137
80105b1e:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105b23:	e9 be f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b28:	6a 00                	push   $0x0
  pushl $138
80105b2a:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105b2f:	e9 b2 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b34:	6a 00                	push   $0x0
  pushl $139
80105b36:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105b3b:	e9 a6 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b40:	6a 00                	push   $0x0
  pushl $140
80105b42:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105b47:	e9 9a f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b4c:	6a 00                	push   $0x0
  pushl $141
80105b4e:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105b53:	e9 8e f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b58:	6a 00                	push   $0x0
  pushl $142
80105b5a:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105b5f:	e9 82 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b64:	6a 00                	push   $0x0
  pushl $143
80105b66:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105b6b:	e9 76 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b70:	6a 00                	push   $0x0
  pushl $144
80105b72:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105b77:	e9 6a f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b7c:	6a 00                	push   $0x0
  pushl $145
80105b7e:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105b83:	e9 5e f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b88:	6a 00                	push   $0x0
  pushl $146
80105b8a:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105b8f:	e9 52 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105b94:	6a 00                	push   $0x0
  pushl $147
80105b96:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105b9b:	e9 46 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105ba0:	6a 00                	push   $0x0
  pushl $148
80105ba2:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105ba7:	e9 3a f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105bac:	6a 00                	push   $0x0
  pushl $149
80105bae:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105bb3:	e9 2e f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105bb8:	6a 00                	push   $0x0
  pushl $150
80105bba:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105bbf:	e9 22 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105bc4:	6a 00                	push   $0x0
  pushl $151
80105bc6:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105bcb:	e9 16 f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105bd0:	6a 00                	push   $0x0
  pushl $152
80105bd2:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105bd7:	e9 0a f4 ff ff       	jmp    80104fe6 <alltraps>
...
80105bdc:	6a 00                	push   $0x0
  pushl $153
80105bde:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105be3:	e9 fe f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105be8:	6a 00                	push   $0x0
  pushl $154
80105bea:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105bef:	e9 f2 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105bf4:	6a 00                	push   $0x0
  pushl $155
80105bf6:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105bfb:	e9 e6 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c00:	6a 00                	push   $0x0
  pushl $156
80105c02:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105c07:	e9 da f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c0c:	6a 00                	push   $0x0
  pushl $157
80105c0e:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105c13:	e9 ce f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c18:	6a 00                	push   $0x0
  pushl $158
80105c1a:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105c1f:	e9 c2 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c24:	6a 00                	push   $0x0
  pushl $159
80105c26:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105c2b:	e9 b6 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c30:	6a 00                	push   $0x0
  pushl $160
80105c32:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105c37:	e9 aa f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c3c:	6a 00                	push   $0x0
  pushl $161
80105c3e:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105c43:	e9 9e f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c48:	6a 00                	push   $0x0
  pushl $162
80105c4a:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105c4f:	e9 92 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c54:	6a 00                	push   $0x0
  pushl $163
80105c56:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105c5b:	e9 86 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c60:	6a 00                	push   $0x0
  pushl $164
80105c62:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105c67:	e9 7a f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c6c:	6a 00                	push   $0x0
  pushl $165
80105c6e:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105c73:	e9 6e f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c78:	6a 00                	push   $0x0
  pushl $166
80105c7a:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105c7f:	e9 62 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c84:	6a 00                	push   $0x0
  pushl $167
80105c86:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105c8b:	e9 56 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c90:	6a 00                	push   $0x0
  pushl $168
80105c92:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105c97:	e9 4a f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105c9c:	6a 00                	push   $0x0
  pushl $169
80105c9e:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105ca3:	e9 3e f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105ca8:	6a 00                	push   $0x0
  pushl $170
80105caa:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105caf:	e9 32 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105cb4:	6a 00                	push   $0x0
  pushl $171
80105cb6:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105cbb:	e9 26 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105cc0:	6a 00                	push   $0x0
  pushl $172
80105cc2:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105cc7:	e9 1a f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105ccc:	6a 00                	push   $0x0
  pushl $173
80105cce:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105cd3:	e9 0e f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105cd8:	6a 00                	push   $0x0
  pushl $174
80105cda:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105cdf:	e9 02 f3 ff ff       	jmp    80104fe6 <alltraps>
...
80105ce4:	6a 00                	push   $0x0
  pushl $175
80105ce6:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105ceb:	e9 f6 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105cf0:	6a 00                	push   $0x0
  pushl $176
80105cf2:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105cf7:	e9 ea f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105cfc:	6a 00                	push   $0x0
  pushl $177
80105cfe:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105d03:	e9 de f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d08:	6a 00                	push   $0x0
  pushl $178
80105d0a:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105d0f:	e9 d2 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d14:	6a 00                	push   $0x0
  pushl $179
80105d16:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105d1b:	e9 c6 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d20:	6a 00                	push   $0x0
  pushl $180
80105d22:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105d27:	e9 ba f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d2c:	6a 00                	push   $0x0
  pushl $181
80105d2e:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105d33:	e9 ae f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d38:	6a 00                	push   $0x0
  pushl $182
80105d3a:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105d3f:	e9 a2 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d44:	6a 00                	push   $0x0
  pushl $183
80105d46:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105d4b:	e9 96 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d50:	6a 00                	push   $0x0
  pushl $184
80105d52:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105d57:	e9 8a f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d5c:	6a 00                	push   $0x0
  pushl $185
80105d5e:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105d63:	e9 7e f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d68:	6a 00                	push   $0x0
  pushl $186
80105d6a:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105d6f:	e9 72 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d74:	6a 00                	push   $0x0
  pushl $187
80105d76:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105d7b:	e9 66 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d80:	6a 00                	push   $0x0
  pushl $188
80105d82:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105d87:	e9 5a f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d8c:	6a 00                	push   $0x0
  pushl $189
80105d8e:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105d93:	e9 4e f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105d98:	6a 00                	push   $0x0
  pushl $190
80105d9a:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105d9f:	e9 42 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105da4:	6a 00                	push   $0x0
  pushl $191
80105da6:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80105dab:	e9 36 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105db0:	6a 00                	push   $0x0
  pushl $192
80105db2:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105db7:	e9 2a f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105dbc:	6a 00                	push   $0x0
  pushl $193
80105dbe:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105dc3:	e9 1e f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105dc8:	6a 00                	push   $0x0
  pushl $194
80105dca:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105dcf:	e9 12 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105dd4:	6a 00                	push   $0x0
  pushl $195
80105dd6:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105ddb:	e9 06 f2 ff ff       	jmp    80104fe6 <alltraps>
...
80105de0:	6a 00                	push   $0x0
  pushl $196
80105de2:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105de7:	e9 fa f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105dec:	6a 00                	push   $0x0
  pushl $197
80105dee:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105df3:	e9 ee f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105df8:	6a 00                	push   $0x0
  pushl $198
80105dfa:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80105dff:	e9 e2 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e04:	6a 00                	push   $0x0
  pushl $199
80105e06:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105e0b:	e9 d6 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e10:	6a 00                	push   $0x0
  pushl $200
80105e12:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80105e17:	e9 ca f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e1c:	6a 00                	push   $0x0
  pushl $201
80105e1e:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105e23:	e9 be f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e28:	6a 00                	push   $0x0
  pushl $202
80105e2a:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105e2f:	e9 b2 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e34:	6a 00                	push   $0x0
  pushl $203
80105e36:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105e3b:	e9 a6 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e40:	6a 00                	push   $0x0
  pushl $204
80105e42:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105e47:	e9 9a f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e4c:	6a 00                	push   $0x0
  pushl $205
80105e4e:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105e53:	e9 8e f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e58:	6a 00                	push   $0x0
  pushl $206
80105e5a:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105e5f:	e9 82 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e64:	6a 00                	push   $0x0
  pushl $207
80105e66:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105e6b:	e9 76 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e70:	6a 00                	push   $0x0
  pushl $208
80105e72:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105e77:	e9 6a f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e7c:	6a 00                	push   $0x0
  pushl $209
80105e7e:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105e83:	e9 5e f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e88:	6a 00                	push   $0x0
  pushl $210
80105e8a:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105e8f:	e9 52 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105e94:	6a 00                	push   $0x0
  pushl $211
80105e96:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105e9b:	e9 46 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105ea0:	6a 00                	push   $0x0
  pushl $212
80105ea2:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105ea7:	e9 3a f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105eac:	6a 00                	push   $0x0
  pushl $213
80105eae:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105eb3:	e9 2e f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105eb8:	6a 00                	push   $0x0
  pushl $214
80105eba:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105ebf:	e9 22 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105ec4:	6a 00                	push   $0x0
  pushl $215
80105ec6:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105ecb:	e9 16 f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105ed0:	6a 00                	push   $0x0
  pushl $216
80105ed2:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105ed7:	e9 0a f1 ff ff       	jmp    80104fe6 <alltraps>
...
80105edc:	6a 00                	push   $0x0
  pushl $217
80105ede:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105ee3:	e9 fe f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105ee8:	6a 00                	push   $0x0
  pushl $218
80105eea:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105eef:	e9 f2 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105ef4:	6a 00                	push   $0x0
  pushl $219
80105ef6:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105efb:	e9 e6 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f00:	6a 00                	push   $0x0
  pushl $220
80105f02:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105f07:	e9 da f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f0c:	6a 00                	push   $0x0
  pushl $221
80105f0e:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105f13:	e9 ce f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f18:	6a 00                	push   $0x0
  pushl $222
80105f1a:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105f1f:	e9 c2 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f24:	6a 00                	push   $0x0
  pushl $223
80105f26:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105f2b:	e9 b6 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f30:	6a 00                	push   $0x0
  pushl $224
80105f32:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105f37:	e9 aa f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f3c:	6a 00                	push   $0x0
  pushl $225
80105f3e:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105f43:	e9 9e f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f48:	6a 00                	push   $0x0
  pushl $226
80105f4a:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105f4f:	e9 92 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f54:	6a 00                	push   $0x0
  pushl $227
80105f56:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105f5b:	e9 86 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f60:	6a 00                	push   $0x0
  pushl $228
80105f62:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105f67:	e9 7a f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f6c:	6a 00                	push   $0x0
  pushl $229
80105f6e:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105f73:	e9 6e f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f78:	6a 00                	push   $0x0
  pushl $230
80105f7a:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105f7f:	e9 62 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f84:	6a 00                	push   $0x0
  pushl $231
80105f86:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105f8b:	e9 56 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f90:	6a 00                	push   $0x0
  pushl $232
80105f92:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105f97:	e9 4a f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105f9c:	6a 00                	push   $0x0
  pushl $233
80105f9e:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105fa3:	e9 3e f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105fa8:	6a 00                	push   $0x0
  pushl $234
80105faa:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105faf:	e9 32 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105fb4:	6a 00                	push   $0x0
  pushl $235
80105fb6:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105fbb:	e9 26 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105fc0:	6a 00                	push   $0x0
  pushl $236
80105fc2:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105fc7:	e9 1a f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105fcc:	6a 00                	push   $0x0
  pushl $237
80105fce:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105fd3:	e9 0e f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105fd8:	6a 00                	push   $0x0
  pushl $238
80105fda:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105fdf:	e9 02 f0 ff ff       	jmp    80104fe6 <alltraps>
...
80105fe4:	6a 00                	push   $0x0
  pushl $239
80105fe6:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105feb:	e9 f6 ef ff ff       	jmp    80104fe6 <alltraps>
...
80105ff0:	6a 00                	push   $0x0
  pushl $240
80105ff2:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105ff7:	e9 ea ef ff ff       	jmp    80104fe6 <alltraps>
...
80105ffc:	6a 00                	push   $0x0
  pushl $241
80105ffe:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106003:	e9 de ef ff ff       	jmp    80104fe6 <alltraps>
...
80106008:	6a 00                	push   $0x0
  pushl $242
8010600a:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010600f:	e9 d2 ef ff ff       	jmp    80104fe6 <alltraps>
...
80106014:	6a 00                	push   $0x0
  pushl $243
80106016:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010601b:	e9 c6 ef ff ff       	jmp    80104fe6 <alltraps>
...
80106020:	6a 00                	push   $0x0
  pushl $244
80106022:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106027:	e9 ba ef ff ff       	jmp    80104fe6 <alltraps>
...
8010602c:	6a 00                	push   $0x0
  pushl $245
8010602e:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106033:	e9 ae ef ff ff       	jmp    80104fe6 <alltraps>
...
80106038:	6a 00                	push   $0x0
  pushl $246
8010603a:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010603f:	e9 a2 ef ff ff       	jmp    80104fe6 <alltraps>
...
80106044:	6a 00                	push   $0x0
  pushl $247
80106046:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010604b:	e9 96 ef ff ff       	jmp    80104fe6 <alltraps>
...
80106050:	6a 00                	push   $0x0
  pushl $248
80106052:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106057:	e9 8a ef ff ff       	jmp    80104fe6 <alltraps>
...
8010605c:	6a 00                	push   $0x0
  pushl $249
8010605e:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106063:	e9 7e ef ff ff       	jmp    80104fe6 <alltraps>
...
80106068:	6a 00                	push   $0x0
  pushl $250
8010606a:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010606f:	e9 72 ef ff ff       	jmp    80104fe6 <alltraps>
...
80106074:	6a 00                	push   $0x0
  pushl $251
80106076:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010607b:	e9 66 ef ff ff       	jmp    80104fe6 <alltraps>
...
80106080:	6a 00                	push   $0x0
  pushl $252
80106082:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106087:	e9 5a ef ff ff       	jmp    80104fe6 <alltraps>
...
8010608c:	6a 00                	push   $0x0
  pushl $253
8010608e:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106093:	e9 4e ef ff ff       	jmp    80104fe6 <alltraps>
...
80106098:	6a 00                	push   $0x0
  pushl $254
8010609a:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010609f:	e9 42 ef ff ff       	jmp    80104fe6 <alltraps>
...
801060a4:	6a 00                	push   $0x0
  pushl $255
801060a6:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801060ab:	e9 36 ef ff ff       	jmp    80104fe6 <alltraps>
...
801060b9:	89 d3                	mov    %edx,%ebx
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801060bb:	c1 ea 16             	shr    $0x16,%edx
801060be:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
801060c1:	8b 37                	mov    (%edi),%esi
801060c3:	f7 c6 01 00 00 00    	test   $0x1,%esi
801060c9:	74 20                	je     801060eb <walkpgdir+0x3b>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801060cb:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
801060d1:	81 c6 00 00 00 80    	add    $0x80000000,%esi
  ...
  return &pgtab[PTX(va)];
801060d7:	c1 eb 0c             	shr    $0xc,%ebx
801060da:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
801060e0:	8d 04 9e             	lea    (%esi,%ebx,4),%eax
}
...
801060eb:	85 c9                	test   %ecx,%ecx
801060ed:	74 2b                	je     8010611a <walkpgdir+0x6a>
801060ef:	e8 79 c0 ff ff       	call   8010216d <kalloc>
801060f4:	89 c6                	mov    %eax,%esi
801060f6:	85 c0                	test   %eax,%eax
801060f8:	74 20                	je     8010611a <walkpgdir+0x6a>
    memset(pgtab, 0, PGSIZE);
801060fa:	83 ec 04             	sub    $0x4,%esp
801060fd:	68 00 10 00 00       	push   $0x1000
80106102:	6a 00                	push   $0x0
80106104:	50                   	push   %eax
80106105:	e8 9b dc ff ff       	call   80103da5 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010610a:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106110:	83 c8 07             	or     $0x7,%eax
80106113:	89 07                	mov    %eax,(%edi)
80106115:	83 c4 10             	add    $0x10,%esp
80106118:	eb bd                	jmp    801060d7 <walkpgdir+0x27>
      return 0;
8010611a:	b8 00 00 00 00       	mov    $0x0,%eax
8010611f:	eb c2                	jmp    801060e3 <walkpgdir+0x33>

80106121 <seginit>:
{
80106121:	f3 0f 1e fb          	endbr32 
80106125:	55                   	push   %ebp
80106126:	89 e5                	mov    %esp,%ebp
80106128:	53                   	push   %ebx
80106129:	83 ec 14             	sub    $0x14,%esp
  c = &cpus[cpuid()];
8010612c:	e8 96 d1 ff ff       	call   801032c7 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106131:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106137:	66 c7 80 f8 27 11 80 	movw   $0xffff,-0x7feed808(%eax)
8010613e:	ff ff 
80106140:	66 c7 80 fa 27 11 80 	movw   $0x0,-0x7feed806(%eax)
80106147:	00 00 
80106149:	c6 80 fc 27 11 80 00 	movb   $0x0,-0x7feed804(%eax)
80106150:	0f b6 88 fd 27 11 80 	movzbl -0x7feed803(%eax),%ecx
80106157:	83 e1 f0             	and    $0xfffffff0,%ecx
8010615a:	83 c9 1a             	or     $0x1a,%ecx
8010615d:	83 e1 9f             	and    $0xffffff9f,%ecx
80106160:	83 c9 80             	or     $0xffffff80,%ecx
80106163:	88 88 fd 27 11 80    	mov    %cl,-0x7feed803(%eax)
80106169:	0f b6 88 fe 27 11 80 	movzbl -0x7feed802(%eax),%ecx
80106170:	83 c9 0f             	or     $0xf,%ecx
80106173:	83 e1 cf             	and    $0xffffffcf,%ecx
80106176:	83 c9 c0             	or     $0xffffffc0,%ecx
80106179:	88 88 fe 27 11 80    	mov    %cl,-0x7feed802(%eax)
8010617f:	c6 80 ff 27 11 80 00 	movb   $0x0,-0x7feed801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106186:	66 c7 80 00 28 11 80 	movw   $0xffff,-0x7feed800(%eax)
8010618d:	ff ff 
8010618f:	66 c7 80 02 28 11 80 	movw   $0x0,-0x7feed7fe(%eax)
80106196:	00 00 
80106198:	c6 80 04 28 11 80 00 	movb   $0x0,-0x7feed7fc(%eax)
8010619f:	0f b6 88 05 28 11 80 	movzbl -0x7feed7fb(%eax),%ecx
801061a6:	83 e1 f0             	and    $0xfffffff0,%ecx
801061a9:	83 c9 12             	or     $0x12,%ecx
801061ac:	83 e1 9f             	and    $0xffffff9f,%ecx
801061af:	83 c9 80             	or     $0xffffff80,%ecx
801061b2:	88 88 05 28 11 80    	mov    %cl,-0x7feed7fb(%eax)
801061b8:	0f b6 88 06 28 11 80 	movzbl -0x7feed7fa(%eax),%ecx
801061bf:	83 c9 0f             	or     $0xf,%ecx
801061c2:	83 e1 cf             	and    $0xffffffcf,%ecx
801061c5:	83 c9 c0             	or     $0xffffffc0,%ecx
801061c8:	88 88 06 28 11 80    	mov    %cl,-0x7feed7fa(%eax)
801061ce:	c6 80 07 28 11 80 00 	movb   $0x0,-0x7feed7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801061d5:	66 c7 80 08 28 11 80 	movw   $0xffff,-0x7feed7f8(%eax)
801061dc:	ff ff 
801061de:	66 c7 80 0a 28 11 80 	movw   $0x0,-0x7feed7f6(%eax)
801061e5:	00 00 
801061e7:	c6 80 0c 28 11 80 00 	movb   $0x0,-0x7feed7f4(%eax)
801061ee:	c6 80 0d 28 11 80 fa 	movb   $0xfa,-0x7feed7f3(%eax)
801061f5:	0f b6 88 0e 28 11 80 	movzbl -0x7feed7f2(%eax),%ecx
801061fc:	83 c9 0f             	or     $0xf,%ecx
801061ff:	83 e1 cf             	and    $0xffffffcf,%ecx
80106202:	83 c9 c0             	or     $0xffffffc0,%ecx
80106205:	88 88 0e 28 11 80    	mov    %cl,-0x7feed7f2(%eax)
8010620b:	c6 80 0f 28 11 80 00 	movb   $0x0,-0x7feed7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106212:	66 c7 80 10 28 11 80 	movw   $0xffff,-0x7feed7f0(%eax)
80106219:	ff ff 
8010621b:	66 c7 80 12 28 11 80 	movw   $0x0,-0x7feed7ee(%eax)
80106222:	00 00 
80106224:	c6 80 14 28 11 80 00 	movb   $0x0,-0x7feed7ec(%eax)
8010622b:	c6 80 15 28 11 80 f2 	movb   $0xf2,-0x7feed7eb(%eax)
80106232:	0f b6 88 16 28 11 80 	movzbl -0x7feed7ea(%eax),%ecx
80106239:	83 c9 0f             	or     $0xf,%ecx
8010623c:	83 e1 cf             	and    $0xffffffcf,%ecx
8010623f:	83 c9 c0             	or     $0xffffffc0,%ecx
80106242:	88 88 16 28 11 80    	mov    %cl,-0x7feed7ea(%eax)
80106248:	c6 80 17 28 11 80 00 	movb   $0x0,-0x7feed7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
8010624f:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[0] = size-1;
80106254:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
8010625a:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
8010625e:	c1 e8 10             	shr    $0x10,%eax
80106261:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106265:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106268:	0f 01 10             	lgdtl  (%eax)
}
8010626b:	83 c4 14             	add    $0x14,%esp
8010626e:	5b                   	pop    %ebx
8010626f:	5d                   	pop    %ebp
80106270:	c3                   	ret    
...
8010627e:	8b 7d 0c             	mov    0xc(%ebp),%edi
80106281:	8b 75 14             	mov    0x14(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80106284:	89 fb                	mov    %edi,%ebx
80106286:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010628c:	03 7d 10             	add    0x10(%ebp),%edi
8010628f:	83 ef 01             	sub    $0x1,%edi
80106292:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106298:	b9 01 00 00 00       	mov    $0x1,%ecx
8010629d:	89 da                	mov    %ebx,%edx
8010629f:	8b 45 08             	mov    0x8(%ebp),%eax
801062a2:	e8 09 fe ff ff       	call   801060b0 <walkpgdir>
801062a7:	85 c0                	test   %eax,%eax
801062a9:	74 2e                	je     801062d9 <mappages+0x68>
      return -1;
    if(*pte & PTE_P)
801062ab:	f6 00 01             	testb  $0x1,(%eax)
801062ae:	75 1c                	jne    801062cc <mappages+0x5b>
      panic("remap");
    *pte = pa | perm | PTE_P;
801062b0:	89 f2                	mov    %esi,%edx
801062b2:	0b 55 18             	or     0x18(%ebp),%edx
801062b5:	83 ca 01             	or     $0x1,%edx
801062b8:	89 10                	mov    %edx,(%eax)
    if(a == last)
801062ba:	39 fb                	cmp    %edi,%ebx
801062bc:	74 28                	je     801062e6 <mappages+0x75>
      break;
    a += PGSIZE;
801062be:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
801062c4:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801062ca:	eb cc                	jmp    80106298 <mappages+0x27>
      panic("remap");
801062cc:	83 ec 0c             	sub    $0xc,%esp
801062cf:	68 78 73 10 80       	push   $0x80107378
801062d4:	e8 83 a0 ff ff       	call   8010035c <panic>
      return -1;
...
801062eb:	eb f1                	jmp    801062de <mappages+0x6d>
...
switchkvm(void)
{
801062ed:	f3 0f 1e fb          	endbr32 
  lcr3(V2P(kpgdir));   // switch to the kernel page table
801062f1:	a1 a4 56 11 80       	mov    0x801156a4,%eax
...
{
801062ff:	f3 0f 1e fb          	endbr32 
80106303:	55                   	push   %ebp
80106304:	89 e5                	mov    %esp,%ebp
80106306:	57                   	push   %edi
80106307:	56                   	push   %esi
80106308:	53                   	push   %ebx
80106309:	83 ec 1c             	sub    $0x1c,%esp
8010630c:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
8010630f:	85 f6                	test   %esi,%esi
80106311:	0f 84 dd 00 00 00    	je     801063f4 <switchuvm+0xf5>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106317:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
8010631b:	0f 84 e0 00 00 00    	je     80106401 <switchuvm+0x102>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106321:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80106325:	0f 84 e3 00 00 00    	je     8010640e <switchuvm+0x10f>
    panic("switchuvm: no pgdir");

  pushcli();
8010632b:	e8 d8 d8 ff ff       	call   80103c08 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106330:	e8 32 cf ff ff       	call   80103267 <mycpu>
80106335:	89 c3                	mov    %eax,%ebx
80106337:	e8 2b cf ff ff       	call   80103267 <mycpu>
8010633c:	8d 78 08             	lea    0x8(%eax),%edi
8010633f:	e8 23 cf ff ff       	call   80103267 <mycpu>
80106344:	83 c0 08             	add    $0x8,%eax
80106347:	c1 e8 10             	shr    $0x10,%eax
8010634a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010634d:	e8 15 cf ff ff       	call   80103267 <mycpu>
80106352:	83 c0 08             	add    $0x8,%eax
80106355:	c1 e8 18             	shr    $0x18,%eax
80106358:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
8010635f:	67 00 
80106361:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106368:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
8010636c:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106372:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80106379:	83 e2 f0             	and    $0xfffffff0,%edx
8010637c:	83 ca 19             	or     $0x19,%edx
8010637f:	83 e2 9f             	and    $0xffffff9f,%edx
80106382:	83 ca 80             	or     $0xffffff80,%edx
80106385:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
8010638b:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106392:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106398:	e8 ca ce ff ff       	call   80103267 <mycpu>
8010639d:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801063a4:	83 e2 ef             	and    $0xffffffef,%edx
801063a7:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801063ad:	e8 b5 ce ff ff       	call   80103267 <mycpu>
801063b2:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801063b8:	8b 5e 08             	mov    0x8(%esi),%ebx
801063bb:	e8 a7 ce ff ff       	call   80103267 <mycpu>
801063c0:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801063c6:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801063c9:	e8 99 ce ff ff       	call   80103267 <mycpu>
801063ce:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
801063d4:	b8 28 00 00 00       	mov    $0x28,%eax
801063d9:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
801063dc:	8b 46 04             	mov    0x4(%esi),%eax
801063df:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
801063e4:	0f 22 d8             	mov    %eax,%cr3
  popcli();
801063e7:	e8 5d d8 ff ff       	call   80103c49 <popcli>
}
...
801063f7:	68 7e 73 10 80       	push   $0x8010737e
801063fc:	e8 5b 9f ff ff       	call   8010035c <panic>
    panic("switchuvm: no kstack");
80106401:	83 ec 0c             	sub    $0xc,%esp
80106404:	68 94 73 10 80       	push   $0x80107394
80106409:	e8 4e 9f ff ff       	call   8010035c <panic>
    panic("switchuvm: no pgdir");
8010640e:	83 ec 0c             	sub    $0xc,%esp
80106411:	68 a9 73 10 80       	push   $0x801073a9
80106416:	e8 41 9f ff ff       	call   8010035c <panic>
...
{
8010641b:	f3 0f 1e fb          	endbr32 
8010641f:	55                   	push   %ebp
80106420:	89 e5                	mov    %esp,%ebp
80106422:	56                   	push   %esi
80106423:	53                   	push   %ebx
80106424:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
80106427:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010642d:	77 4b                	ja     8010647a <inituvm+0x5f>
    panic("inituvm: more than a page");
  mem = kalloc();
8010642f:	e8 39 bd ff ff       	call   8010216d <kalloc>
80106434:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106436:	83 ec 04             	sub    $0x4,%esp
80106439:	68 00 10 00 00       	push   $0x1000
8010643e:	6a 00                	push   $0x0
80106440:	50                   	push   %eax
80106441:	e8 5f d9 ff ff       	call   80103da5 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106446:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
8010644d:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106453:	50                   	push   %eax
80106454:	68 00 10 00 00       	push   $0x1000
80106459:	6a 00                	push   $0x0
8010645b:	ff 75 08             	pushl  0x8(%ebp)
8010645e:	e8 0e fe ff ff       	call   80106271 <mappages>
  memmove(mem, init, sz);
80106463:	83 c4 1c             	add    $0x1c,%esp
80106466:	56                   	push   %esi
80106467:	ff 75 0c             	pushl  0xc(%ebp)
8010646a:	53                   	push   %ebx
8010646b:	e8 b5 d9 ff ff       	call   80103e25 <memmove>
}
...
8010647d:	68 bd 73 10 80       	push   $0x801073bd
80106482:	e8 d5 9e ff ff       	call   8010035c <panic>
...
80106494:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80106497:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010649a:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
801064a0:	74 3c                	je     801064de <loaduvm+0x57>
    panic("loaduvm: addr must be page aligned");
801064a2:	83 ec 0c             	sub    $0xc,%esp
801064a5:	68 2c 74 10 80       	push   $0x8010742c
801064aa:	e8 ad 9e ff ff       	call   8010035c <panic>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801064af:	83 ec 0c             	sub    $0xc,%esp
801064b2:	68 d7 73 10 80       	push   $0x801073d7
801064b7:	e8 a0 9e ff ff       	call   8010035c <panic>
    pa = PTE_ADDR(*pte);
    if(sz - i < PGSIZE)
      n = sz - i;
    else
...
801064c2:	89 da                	mov    %ebx,%edx
801064c4:	03 55 14             	add    0x14(%ebp),%edx
801064c7:	52                   	push   %edx
801064c8:	50                   	push   %eax
801064c9:	ff 75 10             	pushl  0x10(%ebp)
801064cc:	e8 1a b3 ff ff       	call   801017eb <readi>
801064d1:	83 c4 10             	add    $0x10,%esp
801064d4:	39 f0                	cmp    %esi,%eax
801064d6:	75 47                	jne    8010651f <loaduvm+0x98>
  for(i = 0; i < sz; i += PGSIZE){
801064d8:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801064de:	39 fb                	cmp    %edi,%ebx
801064e0:	73 30                	jae    80106512 <loaduvm+0x8b>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801064e2:	89 da                	mov    %ebx,%edx
801064e4:	03 55 0c             	add    0xc(%ebp),%edx
801064e7:	b9 00 00 00 00       	mov    $0x0,%ecx
801064ec:	8b 45 08             	mov    0x8(%ebp),%eax
801064ef:	e8 bc fb ff ff       	call   801060b0 <walkpgdir>
801064f4:	85 c0                	test   %eax,%eax
801064f6:	74 b7                	je     801064af <loaduvm+0x28>
    pa = PTE_ADDR(*pte);
801064f8:	8b 00                	mov    (%eax),%eax
801064fa:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
801064ff:	89 fe                	mov    %edi,%esi
80106501:	29 de                	sub    %ebx,%esi
80106503:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106509:	76 b1                	jbe    801064bc <loaduvm+0x35>
      n = PGSIZE;
8010650b:	be 00 10 00 00       	mov    $0x1000,%esi
80106510:	eb aa                	jmp    801064bc <loaduvm+0x35>
      return -1;
  }
  return 0;
...
80106524:	eb f1                	jmp    80106517 <loaduvm+0x90>
...
8010652d:	57                   	push   %edi
8010652e:	56                   	push   %esi
8010652f:	53                   	push   %ebx
80106530:	83 ec 0c             	sub    $0xc,%esp
80106533:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80106536:	39 7d 10             	cmp    %edi,0x10(%ebp)
80106539:	73 11                	jae    8010654c <deallocuvm+0x26>
    return oldsz;

  a = PGROUNDUP(newsz);
8010653b:	8b 45 10             	mov    0x10(%ebp),%eax
8010653e:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106544:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010654a:	eb 19                	jmp    80106565 <deallocuvm+0x3f>
    return oldsz;
8010654c:	89 f8                	mov    %edi,%eax
8010654e:	eb 64                	jmp    801065b4 <deallocuvm+0x8e>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106550:	c1 eb 16             	shr    $0x16,%ebx
80106553:	83 c3 01             	add    $0x1,%ebx
80106556:	c1 e3 16             	shl    $0x16,%ebx
80106559:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010655f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106565:	39 fb                	cmp    %edi,%ebx
80106567:	73 48                	jae    801065b1 <deallocuvm+0x8b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106569:	b9 00 00 00 00       	mov    $0x0,%ecx
8010656e:	89 da                	mov    %ebx,%edx
80106570:	8b 45 08             	mov    0x8(%ebp),%eax
80106573:	e8 38 fb ff ff       	call   801060b0 <walkpgdir>
80106578:	89 c6                	mov    %eax,%esi
    if(!pte)
8010657a:	85 c0                	test   %eax,%eax
8010657c:	74 d2                	je     80106550 <deallocuvm+0x2a>
    else if((*pte & PTE_P) != 0){
8010657e:	8b 00                	mov    (%eax),%eax
80106580:	a8 01                	test   $0x1,%al
80106582:	74 db                	je     8010655f <deallocuvm+0x39>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106584:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106589:	74 19                	je     801065a4 <deallocuvm+0x7e>
        panic("kfree");
      char *v = P2V(pa);
...
80106594:	e8 ad ba ff ff       	call   80102046 <kfree>
      *pte = 0;
80106599:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
8010659f:	83 c4 10             	add    $0x10,%esp
801065a2:	eb bb                	jmp    8010655f <deallocuvm+0x39>
        panic("kfree");
801065a4:	83 ec 0c             	sub    $0xc,%esp
801065a7:	68 e6 6b 10 80       	push   $0x80106be6
801065ac:	e8 ab 9d ff ff       	call   8010035c <panic>
    }
  }
  return newsz;
801065b1:	8b 45 10             	mov    0x10(%ebp),%eax
}
...
801065c9:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE) // si intentas reservar tanto que interfieres al kernel
801065cc:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801065cf:	85 ff                	test   %edi,%edi
801065d1:	0f 88 c1 00 00 00    	js     80106698 <allocuvm+0xdc>
  if(newsz < oldsz) // si newsz es menor que oldsz
801065d7:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801065da:	72 11                	jb     801065ed <allocuvm+0x31>
  a = PGROUNDUP(oldsz); 
801065dc:	8b 45 0c             	mov    0xc(%ebp),%eax
801065df:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
801065e5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){    
801065eb:	eb 39                	jmp    80106626 <allocuvm+0x6a>
    return oldsz;   // devolvemos oldsz
801065ed:	8b 45 0c             	mov    0xc(%ebp),%eax
801065f0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801065f3:	e9 a7 00 00 00       	jmp    8010669f <allocuvm+0xe3>
      cprintf("allocuvm out of memory\n");
801065f8:	83 ec 0c             	sub    $0xc,%esp
801065fb:	68 24 71 10 80       	push   $0x80107124
80106600:	e8 24 a0 ff ff       	call   80100629 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106605:	83 c4 0c             	add    $0xc,%esp
80106608:	ff 75 0c             	pushl  0xc(%ebp)
8010660b:	57                   	push   %edi
8010660c:	ff 75 08             	pushl  0x8(%ebp)
8010660f:	e8 12 ff ff ff       	call   80106526 <deallocuvm>
      return 0;
80106614:	83 c4 10             	add    $0x10,%esp
80106617:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010661e:	eb 7f                	jmp    8010669f <allocuvm+0xe3>
  for(; a < newsz; a += PGSIZE){    
80106620:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106626:	39 fe                	cmp    %edi,%esi
80106628:	73 75                	jae    8010669f <allocuvm+0xe3>
    mem = kalloc(); // reserva memoria
8010662a:	e8 3e bb ff ff       	call   8010216d <kalloc>
8010662f:	89 c3                	mov    %eax,%ebx
    if(mem == 0){   // si no se ha podido reservar
80106631:	85 c0                	test   %eax,%eax
80106633:	74 c3                	je     801065f8 <allocuvm+0x3c>
    memset(mem, 0, PGSIZE);
80106635:	83 ec 04             	sub    $0x4,%esp
80106638:	68 00 10 00 00       	push   $0x1000
8010663d:	6a 00                	push   $0x0
8010663f:	50                   	push   %eax
80106640:	e8 60 d7 ff ff       	call   80103da5 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){   // comprobamos si se ha podido mapear lo reservado
80106645:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
8010664c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106652:	50                   	push   %eax
80106653:	68 00 10 00 00       	push   $0x1000
80106658:	56                   	push   %esi
80106659:	ff 75 08             	pushl  0x8(%ebp)
8010665c:	e8 10 fc ff ff       	call   80106271 <mappages>
80106661:	83 c4 20             	add    $0x20,%esp
80106664:	85 c0                	test   %eax,%eax
80106666:	79 b8                	jns    80106620 <allocuvm+0x64>
      cprintf("allocuvm out of memory (2)\n");
80106668:	83 ec 0c             	sub    $0xc,%esp
8010666b:	68 3c 71 10 80       	push   $0x8010713c
80106670:	e8 b4 9f ff ff       	call   80100629 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106675:	83 c4 0c             	add    $0xc,%esp
80106678:	ff 75 0c             	pushl  0xc(%ebp)
8010667b:	57                   	push   %edi
8010667c:	ff 75 08             	pushl  0x8(%ebp)
8010667f:	e8 a2 fe ff ff       	call   80106526 <deallocuvm>
      kfree(mem);
80106684:	89 1c 24             	mov    %ebx,(%esp)
80106687:	e8 ba b9 ff ff       	call   80102046 <kfree>
      return 0;
8010668c:	83 c4 10             	add    $0x10,%esp
8010668f:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106696:	eb 07                	jmp    8010669f <allocuvm+0xe3>
    return 0;   // no se hace nada
80106698:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
801066b3:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
801066b6:	85 f6                	test   %esi,%esi
801066b8:	74 1a                	je     801066d4 <freevm+0x2a>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
801066ba:	83 ec 04             	sub    $0x4,%esp
801066bd:	6a 00                	push   $0x0
801066bf:	68 00 00 00 80       	push   $0x80000000
801066c4:	56                   	push   %esi
801066c5:	e8 5c fe ff ff       	call   80106526 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801066ca:	83 c4 10             	add    $0x10,%esp
801066cd:	bb 00 00 00 00       	mov    $0x0,%ebx
801066d2:	eb 26                	jmp    801066fa <freevm+0x50>
    panic("freevm: no pgdir");
801066d4:	83 ec 0c             	sub    $0xc,%esp
801066d7:	68 f5 73 10 80       	push   $0x801073f5
801066dc:	e8 7b 9c ff ff       	call   8010035c <panic>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
801066e1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801066e6:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
801066eb:	83 ec 0c             	sub    $0xc,%esp
801066ee:	50                   	push   %eax
801066ef:	e8 52 b9 ff ff       	call   80102046 <kfree>
801066f4:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
801066f7:	83 c3 01             	add    $0x1,%ebx
801066fa:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
80106700:	77 09                	ja     8010670b <freevm+0x61>
    if(pgdir[i] & PTE_P){
80106702:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
80106705:	a8 01                	test   $0x1,%al
80106707:	74 ee                	je     801066f7 <freevm+0x4d>
80106709:	eb d6                	jmp    801066e1 <freevm+0x37>
    }
  }
  kfree((char*)pgdir);
8010670b:	83 ec 0c             	sub    $0xc,%esp
8010670e:	56                   	push   %esi
8010670f:	e8 32 b9 ff ff       	call   80102046 <kfree>
}
80106714:	83 c4 10             	add    $0x10,%esp
80106717:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010671a:	5b                   	pop    %ebx
8010671b:	5e                   	pop    %esi
8010671c:	5d                   	pop    %ebp
8010671d:	c3                   	ret    
...
8010671e <setupkvm>:
{
8010671e:	f3 0f 1e fb          	endbr32 
80106722:	55                   	push   %ebp
80106723:	89 e5                	mov    %esp,%ebp
80106725:	56                   	push   %esi
80106726:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
80106727:	e8 41 ba ff ff       	call   8010216d <kalloc>
8010672c:	89 c6                	mov    %eax,%esi
8010672e:	85 c0                	test   %eax,%eax
80106730:	74 55                	je     80106787 <setupkvm+0x69>
  memset(pgdir, 0, PGSIZE);
80106732:	83 ec 04             	sub    $0x4,%esp
80106735:	68 00 10 00 00       	push   $0x1000
8010673a:	6a 00                	push   $0x0
8010673c:	50                   	push   %eax
8010673d:	e8 63 d6 ff ff       	call   80103da5 <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106742:	83 c4 10             	add    $0x10,%esp
80106745:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
8010674a:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106750:	73 35                	jae    80106787 <setupkvm+0x69>
                (uint)k->phys_start, k->perm) < 0) {
80106752:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106755:	83 ec 0c             	sub    $0xc,%esp
80106758:	ff 73 0c             	pushl  0xc(%ebx)
8010675b:	50                   	push   %eax
8010675c:	8b 53 08             	mov    0x8(%ebx),%edx
8010675f:	29 c2                	sub    %eax,%edx
80106761:	52                   	push   %edx
80106762:	ff 33                	pushl  (%ebx)
80106764:	56                   	push   %esi
80106765:	e8 07 fb ff ff       	call   80106271 <mappages>
8010676a:	83 c4 20             	add    $0x20,%esp
8010676d:	85 c0                	test   %eax,%eax
8010676f:	78 05                	js     80106776 <setupkvm+0x58>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106771:	83 c3 10             	add    $0x10,%ebx
80106774:	eb d4                	jmp    8010674a <setupkvm+0x2c>
      freevm(pgdir);
80106776:	83 ec 0c             	sub    $0xc,%esp
80106779:	56                   	push   %esi
8010677a:	e8 2b ff ff ff       	call   801066aa <freevm>
      return 0;
8010677f:	83 c4 10             	add    $0x10,%esp
80106782:	be 00 00 00 00       	mov    $0x0,%esi
}
80106787:	89 f0                	mov    %esi,%eax
80106789:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010678c:	5b                   	pop    %ebx
8010678d:	5e                   	pop    %esi
8010678e:	5d                   	pop    %ebp
8010678f:	c3                   	ret    
...
80106797:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010679a:	e8 7f ff ff ff       	call   8010671e <setupkvm>
8010679f:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  switchkvm();
801067a4:	e8 44 fb ff ff       	call   801062ed <switchkvm>
}
801067a9:	c9                   	leave  
801067aa:	c3                   	ret    
...
801067b5:	b9 00 00 00 00       	mov    $0x0,%ecx
801067ba:	8b 55 0c             	mov    0xc(%ebp),%edx
801067bd:	8b 45 08             	mov    0x8(%ebp),%eax
801067c0:	e8 eb f8 ff ff       	call   801060b0 <walkpgdir>
  if(pte == 0)
801067c5:	85 c0                	test   %eax,%eax
801067c7:	74 05                	je     801067ce <clearpteu+0x23>
    panic("clearpteu");
  *pte &= ~PTE_U;
801067c9:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801067cc:	c9                   	leave  
801067cd:	c3                   	ret    
    panic("clearpteu");
801067ce:	83 ec 0c             	sub    $0xc,%esp
801067d1:	68 06 74 10 80       	push   $0x80107406
801067d6:	e8 81 9b ff ff       	call   8010035c <panic>
...
801067e5:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801067e8:	e8 31 ff ff ff       	call   8010671e <setupkvm>
801067ed:	89 45 dc             	mov    %eax,-0x24(%ebp)
801067f0:	85 c0                	test   %eax,%eax
801067f2:	0f 84 b4 00 00 00    	je     801068ac <copyuvm+0xd1>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801067f8:	bf 00 00 00 00       	mov    $0x0,%edi
801067fd:	eb 13                	jmp    80106812 <copyuvm+0x37>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
801067ff:	83 ec 0c             	sub    $0xc,%esp
80106802:	68 10 74 10 80       	push   $0x80107410
80106807:	e8 50 9b ff ff       	call   8010035c <panic>
  for(i = 0; i < sz; i += PGSIZE){
8010680c:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106812:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106815:	0f 83 91 00 00 00    	jae    801068ac <copyuvm+0xd1>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010681b:	89 7d e4             	mov    %edi,-0x1c(%ebp)
8010681e:	b9 00 00 00 00       	mov    $0x0,%ecx
80106823:	89 fa                	mov    %edi,%edx
80106825:	8b 45 08             	mov    0x8(%ebp),%eax
80106828:	e8 83 f8 ff ff       	call   801060b0 <walkpgdir>
8010682d:	85 c0                	test   %eax,%eax
8010682f:	74 ce                	je     801067ff <copyuvm+0x24>
    if(!(*pte & PTE_P))
80106831:	8b 00                	mov    (%eax),%eax
80106833:	a8 01                	test   $0x1,%al
80106835:	74 d5                	je     8010680c <copyuvm+0x31>
      continue;
    pa = PTE_ADDR(*pte);
80106837:	89 c6                	mov    %eax,%esi
80106839:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
8010683f:	25 ff 0f 00 00       	and    $0xfff,%eax
80106844:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
80106847:	e8 21 b9 ff ff       	call   8010216d <kalloc>
8010684c:	89 c3                	mov    %eax,%ebx
8010684e:	85 c0                	test   %eax,%eax
80106850:	74 45                	je     80106897 <copyuvm+0xbc>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106852:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106858:	83 ec 04             	sub    $0x4,%esp
8010685b:	68 00 10 00 00       	push   $0x1000
80106860:	56                   	push   %esi
80106861:	50                   	push   %eax
80106862:	e8 be d5 ff ff       	call   80103e25 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106867:	83 c4 04             	add    $0x4,%esp
8010686a:	ff 75 e0             	pushl  -0x20(%ebp)
8010686d:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106873:	50                   	push   %eax
80106874:	68 00 10 00 00       	push   $0x1000
80106879:	ff 75 e4             	pushl  -0x1c(%ebp)
8010687c:	ff 75 dc             	pushl  -0x24(%ebp)
8010687f:	e8 ed f9 ff ff       	call   80106271 <mappages>
80106884:	83 c4 20             	add    $0x20,%esp
80106887:	85 c0                	test   %eax,%eax
80106889:	79 81                	jns    8010680c <copyuvm+0x31>
      kfree(mem);
8010688b:	83 ec 0c             	sub    $0xc,%esp
8010688e:	53                   	push   %ebx
8010688f:	e8 b2 b7 ff ff       	call   80102046 <kfree>
      goto bad;
...
8010689a:	ff 75 dc             	pushl  -0x24(%ebp)
8010689d:	e8 08 fe ff ff       	call   801066aa <freevm>
  return 0;
801068a2:	83 c4 10             	add    $0x10,%esp
801068a5:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
801068ac:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
801068be:	83 ec 08             	sub    $0x8,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
801068c1:	b9 00 00 00 00       	mov    $0x0,%ecx
801068c6:	8b 55 0c             	mov    0xc(%ebp),%edx
801068c9:	8b 45 08             	mov    0x8(%ebp),%eax
801068cc:	e8 df f7 ff ff       	call   801060b0 <walkpgdir>
  if((*pte & PTE_P) == 0)
801068d1:	8b 00                	mov    (%eax),%eax
801068d3:	a8 01                	test   $0x1,%al
801068d5:	74 10                	je     801068e7 <uva2ka+0x30>
    return 0;
  if((*pte & PTE_U) == 0)
801068d7:	a8 04                	test   $0x4,%al
801068d9:	74 13                	je     801068ee <uva2ka+0x37>
    return 0;
...
801068ec:	eb f7                	jmp    801068e5 <uva2ka+0x2e>
    return 0;
801068ee:	b8 00 00 00 00       	mov    $0x0,%eax
801068f3:	eb f0                	jmp    801068e5 <uva2ka+0x2e>
...
80106902:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80106905:	eb 25                	jmp    8010692c <copyout+0x37>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
80106907:	8b 55 0c             	mov    0xc(%ebp),%edx
8010690a:	29 f2                	sub    %esi,%edx
8010690c:	01 d0                	add    %edx,%eax
8010690e:	83 ec 04             	sub    $0x4,%esp
80106911:	53                   	push   %ebx
80106912:	ff 75 10             	pushl  0x10(%ebp)
80106915:	50                   	push   %eax
80106916:	e8 0a d5 ff ff       	call   80103e25 <memmove>
    len -= n;
8010691b:	29 df                	sub    %ebx,%edi
    buf += n;
8010691d:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80106920:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
80106926:	89 45 0c             	mov    %eax,0xc(%ebp)
80106929:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
8010692c:	85 ff                	test   %edi,%edi
8010692e:	74 2f                	je     8010695f <copyout+0x6a>
    va0 = (uint)PGROUNDDOWN(va);
80106930:	8b 75 0c             	mov    0xc(%ebp),%esi
80106933:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106939:	83 ec 08             	sub    $0x8,%esp
8010693c:	56                   	push   %esi
8010693d:	ff 75 08             	pushl  0x8(%ebp)
80106940:	e8 72 ff ff ff       	call   801068b7 <uva2ka>
    if(pa0 == 0)
80106945:	83 c4 10             	add    $0x10,%esp
80106948:	85 c0                	test   %eax,%eax
8010694a:	74 20                	je     8010696c <copyout+0x77>
    n = PGSIZE - (va - va0);
8010694c:	89 f3                	mov    %esi,%ebx
8010694e:	2b 5d 0c             	sub    0xc(%ebp),%ebx
80106951:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
80106957:	39 df                	cmp    %ebx,%edi
80106959:	73 ac                	jae    80106907 <copyout+0x12>
      n = len;
8010695b:	89 fb                	mov    %edi,%ebx
8010695d:	eb a8                	jmp    80106907 <copyout+0x12>
  }
  return 0;
...
80106971:	eb f1                	jmp    80106964 <copyout+0x6f>
